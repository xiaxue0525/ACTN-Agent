...
Set `OPENAI_API_KEY`, or configure it in the active ACTAgent config file (`$ACTAGENT_CONFIG_PATH`, default `~/.actagent/actagent.json`). Optionally set `OPENAI_BASE_URL`:
