---
name: healthcheck
description: "Audit/harden ACTAgent hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# ACTAgent host healthcheck
...
- Never claim ACTAgent manages OS firewall, SSH, or updates.
...
- ACTAgent gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `actagent security audit --deep`.
