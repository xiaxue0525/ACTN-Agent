...
metadata: { "actagent": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- ACTAgent CLI path: `node --inspect-brk actagent.mjs ...`
- ACTAgent test path: `ACTAGENT_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
