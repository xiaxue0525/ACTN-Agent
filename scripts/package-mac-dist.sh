...
# Output:
# - dist/ACTAgent.app
# - dist/ACTAgent-<version>.zip
# - dist/ACTAgent-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.actagent.mac}"
...
APP="$ROOT_DIR/dist/ACTAgent.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/ACTAgent-$VERSION.zip"
DMG="$ROOT_DIR/dist/ACTAgent-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ACTAgent-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/ACTAgent-$VERSION.dSYM.zip"
