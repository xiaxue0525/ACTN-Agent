...
// Summarizes ACTAgent performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node scripts/actagent-performance-source-summary.mjs --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes ACTAgent-native performance probe artifacts for CI reports.`);
}
