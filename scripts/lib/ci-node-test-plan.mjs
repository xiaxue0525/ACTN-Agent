...
function resolveAgentCoreShardName(file) {
  ...
  if (
    ...
    name.startsWith("actagent-tools") ||
...
function resolveInfraShardName(file) {
  ...
  if (
    ...
    name.startsWith("tmp-actagent-dir")
  ) {
  ...
  if (
    ...
    name.startsWith("actagent-exec-env") ||
  ...
  if (
    ...
    name.startsWith("actagenthub") ||
    name.startsWith("detect-package-manager") ||
    name.startsWith("git-") ||
    name.startsWith("actagent-root") ||
