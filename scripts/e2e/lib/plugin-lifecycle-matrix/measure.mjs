...
const pageSize = readPositiveIntEnv("ACTAGENT_PROC_PAGE_SIZE", 4096);
const clockTicks = readPositiveIntEnv("ACTAGENT_PROC_CLK_TCK", 100);
const pollMs = readPositiveIntEnv("ACTAGENT_PLUGIN_LIFECYCLE_METRIC_POLL_MS", 100);
const timeoutMs = readPositiveIntEnv("ACTAGENT_PLUGIN_LIFECYCLE_PHASE_TIMEOUT_MS", 300000);
const timeoutKillGraceMs = readPositiveIntEnv(
  "ACTAGENT_PLUGIN_LIFECYCLE_TIMEOUT_KILL_GRACE_MS",
  2000,
);
