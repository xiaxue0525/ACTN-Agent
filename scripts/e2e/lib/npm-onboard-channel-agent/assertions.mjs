...
function assertOnboardState() {
  ...
  if (!fs.existsSync(configPath)) {
    throw new Error("onboard did not write actagent.json");
  }
  ...
  if (authStoreText.includes("sk-actagent-npm-onboard-e2e")) {
...
function assertMockModelConfig() {
  ...
  if (provider?.agentRuntime?.id !== "actagent") {
  ...
  if (agent && agentRuntime !== "actagent") {
...
function assertAgentTurn() {
  ...
  assertAgentReplyContainsMarker(marker, "/tmp/actagent-agent.combined");
