// Session Log Mentions script supports ACTAgent repository automation.
...
export function readSessionLogMentionLimits(
  ...
  return {
    fileMaxBytes: readPositiveIntEnv(
      "ACTAGENT_SESSION_LOG_MENTION_FILE_MAX_BYTES",
      DEFAULT_FILE_MAX_BYTES,
      env,
    ),
    totalMaxBytes: readPositiveIntEnv(
      "ACTAGENT_SESSION_LOG_MENTION_TOTAL_MAX_BYTES",
