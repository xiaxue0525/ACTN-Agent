...
IMAGE_NAME="$(docker_e2e_resolve_image "actagent-session-runtime-context-e2e" ACTAGENT_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="actagent-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t actagent-session-runtime-context-log.XXXXXX)"
