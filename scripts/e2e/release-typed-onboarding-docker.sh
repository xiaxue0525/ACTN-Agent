...
IMAGE_NAME="$(docker_e2e_resolve_image "actagent-release-typed-onboarding-e2e" ACTAGENT_RELEASE_TYPED_ONBOARDING_E2E_IMAGE)"
SKIP_BUILD="${ACTAGENT_RELEASE_TYPED_ONBOARDING_E2E_SKIP_BUILD:-0}"
run_log=""
cleanup() {
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-typed-onboarding "${ACTAGENT_CURRENT_PACKAGE_TGZ:-}")"
...
ACTAGENT_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-typed-onboarding empty)"
