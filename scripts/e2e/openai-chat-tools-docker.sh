...
IMAGE_NAME="$(docker_e2e_resolve_image "actagent-openai-chat-tools-e2e" ACTAGENT_OPENAI_CHAT_TOOLS_E2E_IMAGE)"
SKIP_BUILD="${ACTAGENT_OPENAI_CHAT_TOOLS_E2E_SKIP_BUILD:-0}"
PORT="${ACTAGENT_OPENAI_CHAT_TOOLS_PORT:-19199}"
TOKEN="openai-chat-tools-e2e-$$"
PROFILE_FILE="${ACTAGENT_OPENAI_CHAT_TOOLS_PROFILE_FILE:-${ACTAGENT_TESTBOX_PROFILE_FILE:-$HOME/.actagent-testbox-live.profile}}"
...
ACTAGENT_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 openai-chat-tools empty)"
...
docker_e2e_run_logged_with_harness openai-chat-tools \
  ...
  -e "ACTAGENT_OPENAI_CHAT_TOOLS_MODEL=${ACTAGENT_OPENAI_CHAT_TOOLS_MODEL:-openai/gpt-5.4-mini}" \
  -e "ACTAGENT_OPENAI_CHAT_TOOLS_TIMEOUT_SECONDS=${ACTAGENT_OPENAI_CHAT_TOOLS_TIMEOUT_SECONDS:-180}" \
