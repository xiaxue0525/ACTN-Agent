...
IMAGE_NAME="$(docker_e2e_resolve_image "actagent-crestodian-planner-e2e" ACTAGENT_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="actagent-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t actagent-crestodian-planner-log.XXXXXX)"
...
ACTAGENT_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"
