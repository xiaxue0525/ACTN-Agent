...
IMAGE_NAME="$(docker_e2e_resolve_image "actagent-commitments-safety-e2e" ACTAGENT_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="actagent-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t actagent-commitments-safety-log.XXXXXX)"
