...
IMAGE_NAME="$(docker_e2e_resolve_image "actagent-release-media-memory-e2e" ACTAGENT_RELEASE_MEDIA_MEMORY_E2E_IMAGE)"
SKIP_BUILD="${ACTAGENT_RELEASE_MEDIA_MEMORY_E2E_SKIP_BUILD:-0}"
run_log=""
cleanup() {
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-media-memory "${ACTAGENT_CURRENT_PACKAGE_TGZ:-}")"
...
ACTAGENT_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-media-memory empty)"
