// Check No Extension Src Imports script supports ACTAgent repository automation.
...
function main() {
  ...
  if (offenders.length > 0) {
    ...
    console.error(
      "Publish a focused actagent/plugin-sdk/<subpath> surface or use the extension's own public barrel instead.",
    );
    process.exit(1);
  }
