// Check Codex App Server Protocol script supports ACTAgent repository automation.
...
async function main(): Promise<void> {
  ...
  console.log(
    `Codex app-server generated protocol matches ACTAgent bridge assumptions: ${source.codexRepo}`,
  );
}
