...
const pierreDiffsEmptySideEffectNamespace = "actagent-diffs-empty-side-effect";
...
export function createPierreDiffsSideEffectImportPlugin() {
  return {
    name: "actagent-diffs-pierre-side-effect-imports",
    setup(buildContext) {
  ...
  const result = await build({
    ...
    plugins: [
      ...
      ...(target.shikiAlias
        ? [
            {
              name: "actagent-diffs-curated-shiki",
              setup(buildContext) {
