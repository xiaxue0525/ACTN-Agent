// Control Ui I18N script supports ACTAgent repository automation.
...
import { completeSimple, type AssistantMessage, type Model } from "actagent/plugin-sdk/llm";
...
const ENV_PROVIDER = "ACTAGENT_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "ACTAGENT_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "ACTAGENT_CONTROL_UI_I18N_THINKING";
const ENV_BATCH_CHAR_BUDGET = "ACTAGENT_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "ACTAGENT_CONTROL_UI_I18N_PROMPT_TIMEOUT";
const ENV_AUTH_OPTIONAL = "ACTAGENT_CONTROL_UI_I18N_AUTH_OPTIONAL";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "ACTAgent", target: "ACTAgent" },
