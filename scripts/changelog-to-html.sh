...
if [[ -z "$version_content" ]]; then
  echo "<h2>ACTAgent $VERSION</h2>"
  echo "<p>Latest ACTAgent update.</p>"
  echo "<p><a href=\"https://github.com/actagent/actagent/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
