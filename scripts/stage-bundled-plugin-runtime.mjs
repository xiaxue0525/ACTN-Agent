...
function ensureACTAgentExtensionAlias(params) {
  ...
  const aliasDir = path.join(params.distExtensionsRoot, "node_modules", "actagent");
...
function shouldCopyRuntimeFile(relativePath) {
  return (
    ...
    isPathOrNestedPath(relativePath, "actagent.plugin.json") ||
...
export function stageBundledPluginRuntime(params = {}) {
  ...
  ensureACTAgentExtensionAlias({ repoRoot, distExtensionsRoot });
