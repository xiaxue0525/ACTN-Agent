// Test Device Pair Telegram script supports ACTAgent repository automation.
...
import { loadACTAgentPlugins } from "../../src/plugins/loader.js";
...
loadACTAgentPlugins({ config: cfg });
