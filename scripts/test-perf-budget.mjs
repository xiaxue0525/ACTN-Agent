...
function parseArgs(argv, env = process.env) {
  return parseFlagArgs(
    argv,
    {
      ...
      maxWallMs: readBudgetEnvNumber("ACTAGENT_TEST_PERF_MAX_WALL_MS", env),
      baselineWallMs: readBudgetEnvNumber("ACTAGENT_TEST_PERF_BASELINE_WALL_MS", env),
      maxRegressionPct: readBudgetEnvNumber("ACTAGENT_TEST_PERF_MAX_REGRESSION_PCT", env) ?? 10,
    },
    [
