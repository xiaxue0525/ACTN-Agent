...
const SCHEMAS = [
  {
    name: "actagent-state",
    schema: "src/state/actagent-state-schema.sql",
    outFile: "src/state/actagent-state-db.generated.d.ts",
    schemaOutFile: "src/state/actagent-state-schema.generated.ts",
    schemaExport: "ACTAGENT_STATE_SCHEMA_SQL",
  },
  {
    name: "actagent-agent",
    schema: "src/state/actagent-agent-schema.sql",
    outFile: "src/state/actagent-agent-db.generated.d.ts",
    schemaOutFile: "src/state/actagent-agent-schema.generated.ts",
    schemaExport: "ACTAGENT_AGENT_SCHEMA_SQL",
  },
];
