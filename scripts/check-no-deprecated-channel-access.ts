// Check No Deprecated Channel Access script supports ACTAgent repository automation.
...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    pattern: /from\s+["']actagent\/plugin-sdk\/group-access["']/u,
  },
  {
  ...
  },
  {
    ...
    pattern: /from\s+["']actagent\/plugin-sdk\/command-auth["']/u,
  },
  {
