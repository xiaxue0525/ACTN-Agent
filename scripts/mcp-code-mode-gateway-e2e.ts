// Mcp Code Mode Gateway E2E script supports ACTAgent repository automation.
...
export async function main() {
  const rootDir = await fs.mkdtemp(path.join(os.tmpdir(), "actagent-mcp-code-mode-"));
  const keep = process.env.ACTAGENT_MCP_CODE_MODE_GATEWAY_E2E_KEEP === "1";
