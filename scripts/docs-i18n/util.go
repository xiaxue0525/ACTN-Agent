...
const (
	...
	envDocsI18nProvider      = "ACTAGENT_DOCS_I18N_PROVIDER"
	envDocsI18nModel         = "ACTAGENT_DOCS_I18N_MODEL"
...
func validateNoTranslationTranscriptArtifacts(source, translated string) error {
	...
	for _, token := range []string{"<actagent_docs_i18n_input>", "</actagent_docs_i18n_input>"} {
