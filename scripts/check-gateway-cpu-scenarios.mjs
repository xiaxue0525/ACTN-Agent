  ...
  return {
    ...
    ...(qaState
      ? {
          ...
          ACTAGENT_HOME: qaState.home,
          ACTAGENT_STATE_DIR: qaState.stateDir,
          ACTAGENT_CONFIG_PATH: qaState.configPath,
        }
      : {}),
    ACTAGENT_BUILD_PRIVATE_QA: "1",
    ACTAGENT_ENABLE_PRIVATE_QA_CLI: "1",
    ACTAGENT_RUN_NODE_SKIP_DTS_BUILD: env.ACTAGENT_RUN_NODE_SKIP_DTS_BUILD ?? "1",
    ACTAGENT_TEST_DISABLE_UPDATE_CHECK: env.ACTAGENT_TEST_DISABLE_UPDATE_CHECK ?? "1",
  };
}
