...
function mergeIMessageAccountConfig(cfg: ACTAgentConfig, accountId: string): IMessageAccountConfig {
...
// caused duplicate inbound handling in actagent/actagent#65141.
...
function resolveIMessageAccountSourceOwner(params: {
  ...
  // bindings tied to the named account keep working (actagent/actagent#65141).
 ...
 * watchers (actagent/actagent#65141) without otherwise marking the duplicate
...
export function listEnabledIMessageAccounts(cfg: ACTAgentConfig): ResolvedIMessageAccount[] {
