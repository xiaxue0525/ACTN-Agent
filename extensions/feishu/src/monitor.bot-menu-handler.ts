...
import { isRecord, readStringValue as readString } from "actagent/plugin-sdk/string-coerce-runtime";
import type { ACTAgentBotConfig, HistoryEntry, PluginRuntime, RuntimeEnv } from "../runtime-api.js";
