 ...
 */
import { collectErrorGraphCandidates } from "actagent/plugin-sdk/error-runtime";
...
// Restricted sandboxes (nemoactagent, Docker-in-Docker, k3s with locked-down policy)
...
/** Known ciao process-level errors that ACTAgent handles specially. */
