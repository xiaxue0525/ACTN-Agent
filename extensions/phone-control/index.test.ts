...
const PHONE_CONTROL_STATE_PREFIX = "actagent-phone-control-test-";
...
function createApi(params: {
  ...
  openKeyedStore?: ACTAgentPluginApi["runtime"]["state"]["openKeyedStore"];
}): ACTAgentPluginApi {
...
}): ACTAgentPluginApi["runtime"]["state"]["openKeyedStore"] {
  return <T>() => {
...
describe("phone-control plugin", () => {
  ...
  it("does not block service startup on the initial expiry check", async () => {
    ...
    try {
      ...
      let service: ACTAgentPluginService | undefined;
