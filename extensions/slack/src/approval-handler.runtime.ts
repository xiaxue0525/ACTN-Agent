...
import { buildApprovalPresentationFromActionDescriptors } from "actagent/plugin-sdk/approval-reply-runtime";
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<ACTAgentConfig["channels"]>["slack"]>["execApprovals"]
>;
