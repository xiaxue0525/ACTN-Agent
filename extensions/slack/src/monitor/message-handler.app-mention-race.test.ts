...
vi.mock("actagent/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("actagent/plugin-sdk/channel-inbound")>(
    "actagent/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
