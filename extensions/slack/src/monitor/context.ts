...
import { resolveDefaultAgentId } from "actagent/plugin-sdk/agent-runtime";
import { formatAllowlistMatchMeta } from "actagent/plugin-sdk/allow-from";
import type {
  ACTAgentConfig,
  SlackReactionNotificationMode,
} from "actagent/plugin-sdk/config-contracts";
import type { SessionScope } from "actagent/plugin-sdk/config-contracts";
import type { DmPolicy, GroupPolicy } from "actagent/plugin-sdk/config-contracts";
import { resolveRuntimeConversationBindingRoute } from "actagent/plugin-sdk/conversation-runtime";
import { createDedupeCache } from "actagent/plugin-sdk/dedupe-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("actagent/plugin-sdk/config-contracts").SlackSlashCommandConfig>;
  textLimit: number;
