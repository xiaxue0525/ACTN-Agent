...
import { formatInboundEnvelope } from "actagent/plugin-sdk/channel-inbound";
import { runTasksWithConcurrency } from "actagent/plugin-sdk/concurrency-runtime";
import type { ContextVisibilityMode } from "actagent/plugin-sdk/config-contracts";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("actagent/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
