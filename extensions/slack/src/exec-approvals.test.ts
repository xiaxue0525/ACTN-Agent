...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<ACTAgentConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<ACTAgentConfig["channels"]>["slack"]>>,
): ACTAgentConfig {
  return {
    channels: {
      slack: {
