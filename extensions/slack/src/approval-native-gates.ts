...
import type { ChannelApprovalCapability } from "actagent/plugin-sdk/channel-contract";
import {
  channelRouteTargetsMatchExact,
  stringifyRouteThreadId,
} from "actagent/plugin-sdk/channel-route";
...
type ApprovalForwardingConfig = NonNullable<NonNullable<ACTAgentConfig["approvals"]>["plugin"]>;
...
function resolvePluginApprovalForwardingConfig(cfg: ACTAgentConfig) {
