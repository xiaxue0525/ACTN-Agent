...
import { optionalFiniteNumberSchema, stringEnum } from "actagent/plugin-sdk/channel-actions";
...
import type { AnyAgentTool, ACTAgentPluginApi, ACTAgentPluginToolContext } from "../api.js";
...
function buildArtifactContext(
  context: ACTAgentPluginToolContext | undefined,
