...
vi.mock("actagent/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("actagent/plugin-sdk/media-understanding")>(
    "actagent/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
...
afterAll(() => {
  vi.doUnmock("actagent/plugin-sdk/media-understanding");
  vi.resetModules();
});
