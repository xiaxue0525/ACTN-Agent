// Deepinfra plugin entrypoint registers its ACTAgent integration.
import {
  type ProviderCatalogContext,
  type ConfiguredProviderCatalogEntry,
  readConfiguredProviderCatalogEntries,
} from "actagent/plugin-sdk/provider-catalog-shared";
import { defineSingleProviderPluginEntry } from "actagent/plugin-sdk/provider-entry";
import { PASSTHROUGH_GEMINI_REPLAY_HOOKS } from "actagent/plugin-sdk/provider-model-shared";
import {
  createOpenRouterWrapper,
  isProxyReasoningUnsupported,
} from "actagent/plugin-sdk/provider-stream";
