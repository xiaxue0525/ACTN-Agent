...
import { clearLiveCatalogCacheForTests } from "actagent/plugin-sdk/provider-catalog-shared";
import {
...
vi.mock("actagent/plugin-sdk/provider-http", async () => {
  const actual = await vi.importActual<typeof import("actagent/plugin-sdk/provider-http")>(
    "actagent/plugin-sdk/provider-http",
  );
  return {
    ...actual,
