...
import { isProviderApiKeyConfigured } from "actagent/plugin-sdk/provider-auth";
...
import { isRecord, normalizeOptionalString } from "actagent/plugin-sdk/string-coerce-runtime";
import type {
  GeneratedVideoAsset,
  VideoGenerationProvider,
  VideoGenerationRequest,
  VideoGenerationSourceAsset,
} from "actagent/plugin-sdk/video-generation";
...
const SUPPORTED_DURATIONS_HINT = Symbol.for("actagent.videoGeneration.supportedDurations");
