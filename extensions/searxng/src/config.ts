...
export function resolveSearxngCategories(config?: ACTAgentConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: ACTAgentConfig): string | undefined {
