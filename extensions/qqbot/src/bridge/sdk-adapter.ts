...
import { parseAccessGroupAllowFromEntry } from "actagent/plugin-sdk/access-groups";
import {
  createChannelIngressResolver,
  defineStableChannelIngressIdentity,
} from "actagent/plugin-sdk/channel-ingress-runtime";
import { resolveInboundMentionDecision } from "actagent/plugin-sdk/channel-mention-gating";
  ...
  return {
    async resolveInboundAccess(input) {
      ...
      const resolved = await createChannelIngressResolver({
        ...
        cfg: input.cfg as ACTAgentConfig,
      }).message({
