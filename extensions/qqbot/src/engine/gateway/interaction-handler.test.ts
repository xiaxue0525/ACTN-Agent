...
function makeRestrictedCfg(approvers: string[]): ACTAgentConfig {
  return {
    channels: {
      qqbot: {
        appId: "app",
...
function makeCommandAuthorizedFallbackCfg(): ACTAgentConfig {
  return {
    channels: {
      qqbot: {
        appId: "app",
...
describe("createInteractionHandler approval buttons", () => {
  ...
  ] satisfies Array<[string, ACTAgentConfig]>)(
