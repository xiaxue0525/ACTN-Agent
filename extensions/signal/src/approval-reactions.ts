...
import { matchesApprovalRequestFilters } from "actagent/plugin-sdk/approval-client-runtime";
import {
...
} from "actagent/plugin-sdk/approval-reaction-runtime";
...
type ApprovalForwardingConfig = NonNullable<NonNullable<ACTAgentConfig["approvals"]>["exec"]>;
