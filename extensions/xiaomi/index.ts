// Xiaomi plugin entrypoint registers its ACTAgent integration.
...
import {
  ...
  validateApiKeyInput,
} from "actagent/plugin-sdk/provider-auth-api-key";
import {
  applyModelCompatPatch,
  buildProviderReplayFamilyHooks,
} from "actagent/plugin-sdk/provider-model-shared";
import { PROVIDER_LABELS } from "actagent/plugin-sdk/provider-usage";
import {
  applyXiaomiConfig,
...
async function runXiaomiApiKeyAuth(
  ...
  params: {
    ...
    expectedKind: "payg" | "token-plan";
    defaultModel: string;
    applyConfig: (cfg: ACTAgentConfig) => ACTAgentConfig;
  },
