/**
 * Amazon Bedrock Converse streaming runtime. It maps ACTAgent messages/tools,
...
/** Stream a Bedrock Converse request from the generic ACTAgent stream options. */
 ...
 * Defaults to "short" and uses ACTAGENT_CACHE_RETENTION for backward compatibility.
 */
