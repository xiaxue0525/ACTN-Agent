 ...
 */
import { resolveAwsSdkEnvVarName } from "actagent/plugin-sdk/provider-auth-runtime";
import type { ModelProviderConfig } from "actagent/plugin-sdk/provider-model-shared";

/** Resolve the config auth marker that tells ACTAgent to use AWS SDK credentials. */
