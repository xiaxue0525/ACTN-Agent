...
} from "actagent/plugin-sdk/realtime-transcription";
...
async function resolveXaiRealtimeApiKey(
  ...
  throw new Error(
    "xAI credentials missing for realtime STT. Sign in with `actagent onboard --auth-choice xai-oauth`, or run `actagent onboard --auth-choice xai-api-key`, or set XAI_API_KEY.",
  );
}
