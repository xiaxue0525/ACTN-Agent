// Xai plugin entrypoint registers its ACTAgent integration.
import { defineSingleProviderPluginEntry } from "actagent/plugin-sdk/provider-entry";
import { OPENAI_COMPATIBLE_REPLAY_HOOKS } from "actagent/plugin-sdk/provider-model-shared";
import { defaultToolStreamExtraParams } from "actagent/plugin-sdk/provider-stream-shared";
import { jsonResult } from "actagent/plugin-sdk/provider-web-search";
import {
