...
function readLegacyGrokFallbackAuth(cfg?: ACTAgentConfig): XaiFallbackAuth | undefined {
...
function readLegacyGrokApiKeyResult(cfg?: ACTAgentConfig): ConfiguredRuntimeApiKeyResolution {
  const search = cfg?.tools?.web?.search;
  if (!search || typeof search !== "object") {
    return { status: "missing" };
  }
...
export function resolveFallbackXaiAuth(cfg?: ACTAgentConfig): XaiFallbackAuth | undefined {
...
export function resolveFallbackXaiApiKey(cfg?: ACTAgentConfig): string | undefined {
