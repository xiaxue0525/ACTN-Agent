...
import { createAsyncLock } from "actagent/plugin-sdk/async-lock-runtime";
import {
  extractErrorCode,
  formatErrorMessage,
...
import { resolveStateDir } from "actagent/plugin-sdk/memory-core-host-runtime-core";
import { getRuntimeConfig } from "actagent/plugin-sdk/runtime-config-snapshot";
import { pathExists, replaceFileAtomic } from "actagent/plugin-sdk/security-runtime";
import {
  loadSessionStore,
  resolveStorePath,
  updateSessionStore,
...
const DIARY_START_MARKER = "<!-- actagent:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- actagent:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "actagent:dreaming:backfill-entry";
