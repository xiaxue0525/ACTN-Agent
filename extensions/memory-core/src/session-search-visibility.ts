...
import type { ACTAgentConfig } from "actagent/plugin-sdk/memory-core-host-runtime-core";
import type { MemorySearchResult } from "actagent/plugin-sdk/memory-core-host-runtime-files";
import { resolveSessionAgentId } from "actagent/plugin-sdk/memory-host-core";
import {
...
function isGlobalSessionKeyForSharedScope(cfg: ACTAgentConfig, key: string): boolean {
