...
import {
  ...
  sessionPathForFile,
} from "actagent/plugin-sdk/memory-core-host-engine-qmd";
import type { MemorySearchResult } from "actagent/plugin-sdk/memory-core-host-runtime-files";
import {
...
import { appendRegularFile, privateFileStore } from "actagent/plugin-sdk/security-runtime";
...
type Logger = Pick<ACTAgentPluginApi["logger"], "info" | "warn" | "error">;
...
const LIGHT_SLEEP_EVENT_TEXT = "__actagent_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__actagent_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- actagent:dreaming:light:start -->",
    endMarker: "<!-- actagent:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- actagent:dreaming:rem:start -->",
    endMarker: "<!-- actagent:dreaming:rem:end -->",
  },
] as const;
