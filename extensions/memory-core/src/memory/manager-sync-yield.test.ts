...
import type { MemorySource } from "actagent/plugin-sdk/memory-core-host-engine-storage";
...
class SessionSyncYieldHarness extends MemoryManagerSyncOps {
  protected readonly cfg = {} as ACTAgentConfig;
  protected readonly agentId = "main";
  protected readonly workspaceDir = "/tmp/actagent-test-workspace";
...
describe("session sync responsiveness", () => {
  beforeEach(() => {
    vi.stubEnv("ACTAGENT_STATE_DIR", path.join(os.tmpdir(), "actagent-session-sync-yield"));
