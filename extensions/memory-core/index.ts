...
import { resolveMemoryBackendConfig } from "actagent/plugin-sdk/memory-core-host-runtime-files";
import {
  definePluginEntry,
  type AnyAgentTool,
...
type MemoryToolOptions = {
  ...
  getConfig?: () => ACTAgentConfig | undefined;
  agentId?: string;
...
function getToolConfig(options: MemoryToolOptions): ACTAgentConfig | undefined {
...
function resolveMemoryToolOptions(ctx: ACTAgentPluginToolContext): MemoryToolOptions {
