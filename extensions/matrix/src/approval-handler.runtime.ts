...
import { buildPluginApprovalResolvedReplyPayload } from "actagent/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
...
import { normalizeUniqueStringEntries } from "actagent/plugin-sdk/string-coerce-runtime";
import {
...
// ACTAgent Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.actagent.approval" as const;
