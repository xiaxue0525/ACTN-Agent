...
import { hasConfiguredSecretInput } from "actagent/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: ACTAgentConfig): Record<string, unknown> | null {
