// Matrix plugin entrypoint registers its ACTAgent integration.
import { format } from "node:util";
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "actagent/plugin-sdk/approval-handler-adapter-runtime";
import type { ChannelRuntimeSurface } from "actagent/plugin-sdk/channel-contract";
import { waitUntilAbort } from "actagent/plugin-sdk/channel-outbound";
import { registerChannelRuntimeContext } from "actagent/plugin-sdk/channel-runtime-context";
import { resolveOptionalIntegerOption } from "actagent/plugin-sdk/number-runtime";
import {
...
export type MonitorMatrixOpts = {
  ...
  setStatus?: (next: import("actagent/plugin-sdk/channel-contract").ChannelAccountSnapshot) => void;
};
