...
import { hasFinalInboundReplyDispatch } from "actagent/plugin-sdk/channel-inbound";
...
import { mergePairLoopGuardConfig } from "actagent/plugin-sdk/pair-loop-guard-runtime";
import { buildInboundHistoryFromEntries } from "actagent/plugin-sdk/reply-history";
import {
  buildTtsSupplementMediaPayload,
  getReplyPayloadTtsSupplement,
} from "actagent/plugin-sdk/reply-payload";
import type { GetReplyOptions } from "actagent/plugin-sdk/reply-runtime";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("actagent/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("actagent/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<
  typeof import("actagent/plugin-sdk/acp-binding-runtime")
> {
  acpBindingRuntimePromise ??= import("actagent/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("actagent/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("actagent/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_ACTAGENT_FINALIZED_PREVIEW_KEY]: true };
}
