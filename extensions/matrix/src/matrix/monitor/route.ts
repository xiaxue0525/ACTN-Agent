...
import { resolveConfiguredAcpBindingRecord } from "actagent/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "actagent/plugin-sdk/session-binding-runtime";
