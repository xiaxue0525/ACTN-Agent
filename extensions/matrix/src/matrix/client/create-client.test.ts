...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/actagent-matrix-create-client-test",
    storagePath: "/tmp/actagent-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/actagent-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/actagent-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/actagent-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "actagent-matrix-default-token-hash",
