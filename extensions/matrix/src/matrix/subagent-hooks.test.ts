...
import type { ACTAgentPluginApi as MatrixEntryPluginApi } from "actagent/plugin-sdk/channel-entry-contract";
import {
...
vi.mock("actagent/plugin-sdk/conversation-binding-runtime", () => ({
