...
import type { OutputRuntimeEnv } from "actagent/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "actagent/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "ACTAgent Gateway",
    },
    confirm: {
