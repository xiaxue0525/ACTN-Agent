...
export function buildComfyConfig(config: Record<string, unknown>): ACTAgentConfig {
  return {
    plugins: {
      entries: {
        comfy: { config },
...
export function buildLegacyComfyConfig(config: Record<string, unknown>): ACTAgentConfig {
  return {
    models: {
      providers: {
        comfy: config,
