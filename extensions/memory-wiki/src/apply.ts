...
import { readFiniteNumberParam } from "actagent/plugin-sdk/param-readers";
...
const GENERATED_START = "<!-- actagent:wiki:generated:start -->";
const GENERATED_END = "<!-- actagent:wiki:generated:end -->";
const HUMAN_START = "<!-- actagent:human:start -->";
const HUMAN_END = "<!-- actagent:human:end -->";
