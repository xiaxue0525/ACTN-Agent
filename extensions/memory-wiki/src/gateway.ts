...
import { resolveDefaultAgentId } from "actagent/plugin-sdk/memory-host-core";
import { readPositiveIntegerParam } from "actagent/plugin-sdk/param-readers";
import type { ACTAgentConfig, ACTAgentPluginApi } from "../api.js";
...
type GatewayMethodContext = Parameters<
  Parameters<ACTAgentPluginApi["registerGatewayMethod"]>[1]
>[0];
...
function resolveGatewayAgentId(
  ...
  appConfig: ACTAgentConfig | undefined,
): string | undefined {
  return (
