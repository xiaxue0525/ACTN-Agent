...
import { resolveDefaultAgentId, resolveSessionAgentId } from "actagent/plugin-sdk/memory-host-core";
import { getActiveMemorySearchManager } from "actagent/plugin-sdk/memory-host-search";
import {
  extractTranscriptIdentityFromSessionsMemoryHit,
  loadCombinedSessionStoreForGateway,
  resolveTranscriptStemToSessionKeys,
} from "actagent/plugin-sdk/session-transcript-hit";
import {
  createAgentToAgentPolicy,
  createSessionVisibilityGuard,
  resolveEffectiveSessionToolsVisibility,
} from "actagent/plugin-sdk/session-visibility";
import {
...
const AGENT_DIGEST_PATH = ".actagent-wiki/cache/agent-digest.json";
const CLAIMS_DIGEST_PATH = ".actagent-wiki/cache/claims.jsonl";
const RELATED_BLOCK_PATTERN =
  /<!-- actagent:wiki:related:start -->[\s\S]*?<!-- actagent:wiki:related:end -->/g;
