...
import { mapPluginConfigIssues } from "actagent/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type ACTAgentPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: ACTAgentPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".actagent", "wiki", "main");
}
