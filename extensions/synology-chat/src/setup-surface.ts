...
function getChannelConfig(cfg: ACTAgentConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: ACTAgentConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: ACTAgentConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: ACTAgentConfig, accountId: string): string[] {
