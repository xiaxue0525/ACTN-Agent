...
import { runCommandWithRuntime, theme } from "actagent/plugin-sdk/cli-runtime";
...
import { defaultRuntime } from "actagent/plugin-sdk/runtime";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalString,
} from "actagent/plugin-sdk/string-coerce-runtime";
import { shortenHomePath } from "actagent/plugin-sdk/text-utility-runtime";
...
/** Creates the default Canvas CLI dependency bundle backed by the ACTAgent gateway CLI. */
    ...
    a2ui
      ...
      .action(async (opts: CanvasNodesRpcOpts) => {
        await deps.runNodesCommand("canvas a2ui push", async () => {
          ...
          if (version === "v0.9") {
            throw new Error(
              "Detected A2UI v0.9 JSONL (createSurface). ACTAgent currently supports v0.8 only.",
            );
          }
