...
import { resolvePreferredACTAgentTmpDir } from "actagent/plugin-sdk/security-runtime";
import { asRecord, readStringValue } from "actagent/plugin-sdk/string-coerce-runtime";
...
function resolveTempPathParts(opts: { ext: string; tmpDir?: string; id?: string }) {
  const tmpDir = opts.tmpDir ?? resolvePreferredACTAgentTmpDir();
  if (!opts.tmpDir) {
