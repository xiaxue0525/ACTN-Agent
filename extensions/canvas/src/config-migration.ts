...
import { asOptionalRecord as readRecord } from "actagent/plugin-sdk/string-coerce-runtime";
...
export function migrateLegacyCanvasHostConfig(config: ACTAgentConfig): {
  ...
  const next = { ...config, plugins } as ACTAgentConfig & { canvasHost?: unknown };
