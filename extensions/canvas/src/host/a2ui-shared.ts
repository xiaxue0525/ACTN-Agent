 ...
 */
import { lowercasePreservingWhitespace } from "actagent/plugin-sdk/string-coerce-runtime";

/** Hosted path prefix for bundled A2UI assets. */
export const A2UI_PATH = "/__actagent__/a2ui";

/** Hosted path prefix for Canvas document/static assets. */
export const CANVAS_HOST_PATH = "/__actagent__/canvas";

/** Hosted WebSocket path for Canvas live reload. */
export const CANVAS_WS_PATH = "/__actagent__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.actagentCanvasA2UIAction.postMessage(...)
  // - Android: window.actagentCanvasA2UIAction.postMessage(...)
  const handlerNames = ["actagentCanvasA2UIAction"];
  ...
  globalThis.ACTAgent = globalThis.ACTAgent ?? {};
  globalThis.ACTAgent.postMessage = postToNode;
  globalThis.ACTAgent.sendUserAction = sendUserAction;
  globalThis.actagentPostMessage = postToNode;
  globalThis.actagentSendUserAction = sendUserAction;
