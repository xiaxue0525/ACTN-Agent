// Moonshot plugin entrypoint registers its ACTAgent integration.
...
import { MOONSHOT_THINKING_STREAM_HOOKS } from "actagent/plugin-sdk/provider-stream-family";
...
export default defineSingleProviderPluginEntry({
  ...
  provider: {
    ...
    // multi-turn replay. See actagent/actagent#62319.
