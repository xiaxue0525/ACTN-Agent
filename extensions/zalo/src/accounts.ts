...
function mergeZaloAccountConfig(cfg: ACTAgentConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: ACTAgentConfig): ResolvedZaloAccount[] {
