...
import { expectExplicitMusicGenerationCapabilities } from "actagent/plugin-sdk/provider-test-contracts";
...
vi.mock("actagent/plugin-sdk/provider-http", async (importOriginal) => {
  const original = await importOriginal<typeof import("actagent/plugin-sdk/provider-http")>();
  return {
    ...original,
