...
import type { ACTAgentPluginService } from "actagent/plugin-sdk/core";
import { listDevicePairing } from "actagent/plugin-sdk/device-bootstrap";
...
import { replaceFileAtomic } from "actagent/plugin-sdk/security-runtime";
...
export function createPairingNotifierService(api: ACTAgentPluginApi): ACTAgentPluginService {
...
export function registerPairingNotifierService(api: ACTAgentPluginApi): void {
