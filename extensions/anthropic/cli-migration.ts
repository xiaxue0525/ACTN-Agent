...
type AgentDefaultsModel = NonNullable<NonNullable<ACTAgentConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<ACTAgentConfig["agents"]>["defaults"]>["models"];
