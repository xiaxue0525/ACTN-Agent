...
} from "actagent/plugin-sdk/provider-stream-shared";
...
const ACTAGENT_DEFAULT_ANTHROPIC_BETAS = [
  "fine-grained-tool-streaming-2025-05-14",
  "interleaved-thinking-2025-05-14",
] as const;
const ACTAGENT_OAUTH_ANTHROPIC_BETAS = [
  "claude-code-20250219",
  "oauth-2025-04-20",
  ...ACTAGENT_DEFAULT_ANTHROPIC_BETAS,
] as const;
...
/** Wrap a stream function to merge ACTAgent and configured Anthropic beta headers. */
export function createAnthropicBetaHeadersWrapper(
  ...
  return (model, context, options) => {
    ...
    const actAgentBetas = isOauth
      ? (ACTAGENT_OAUTH_ANTHROPIC_BETAS as readonly string[])
      : (ACTAGENT_DEFAULT_ANTHROPIC_BETAS as readonly string[]);
    const allBetas = [...new Set([...actAgentBetas, ...effectiveBetas])];
