...
import type { ChannelDirectoryAdapter } from "actagent/plugin-sdk/channel-contract";
import { listDirectoryEntriesFromSources } from "actagent/plugin-sdk/directory-runtime";
