...
import { buildOauthProviderAuthResult } from "actagent/plugin-sdk/provider-auth-result";
import type { ProviderPlugin } from "actagent/plugin-sdk/provider-model-shared";
import { fetchGeminiUsage } from "actagent/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: ACTAgentPluginApi) {
