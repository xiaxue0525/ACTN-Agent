...
import type { PluginHookInboundClaimEvent } from "actagent/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "actagent/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // ACTAgent channels expose either local staged files or remote URLs. Keep
