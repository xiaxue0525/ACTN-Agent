...
import type { NativeHookRelayRegistrationHandle } from "actagent/plugin-sdk/agent-harness-runtime";
          ...
          hooks: [
            {
              type: "command",
              command:
                "actagent hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event pre_tool_use",
              timeout: 7,
              async: false,
              statusMessage: "ACTAgent native hook relay",
            },
          ],
        },
      ],
          ...
          hooks: [
            {
              type: "command",
              command:
                "actagent hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event post_tool_use",
              timeout: 7,
              async: false,
              statusMessage: "ACTAgent native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "actagent hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event permission_request",
              timeout: 7,
              async: false,
              statusMessage: "ACTAgent native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "actagent hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event before_agent_finalize",
              timeout: 7,
              async: false,
              statusMessage: "ACTAgent native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "actagent hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event pre_tool_use --pre-tool-use-unavailable noop",
              timeout: 5,
              async: false,
              statusMessage: "ACTAgent native hook relay",
            },
...
function createRelay(options?: {
  ...
  return {
    ...
    commandForEvent: (event) =>
      `actagent hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event ${event}${
