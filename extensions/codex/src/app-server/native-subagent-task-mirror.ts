/**
 * Mirrors Codex native subagent thread lifecycle events into ACTAgent task
 * runtime rows so parent sessions can observe child progress.
 */
import type { AgentHarnessTaskRuntime } from "actagent/plugin-sdk/agent-harness-task-runtime";
...
/** Converts a Codex child thread id into the ACTAgent task-runtime run id. */
