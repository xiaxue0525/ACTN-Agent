 ...
 * into ACTAgent task runtime records for parent sessions.
 */
import { createHash } from "node:crypto";
import fs from "node:fs/promises";
import path from "node:path";
import { embeddedAgentLog, formatErrorMessage } from "actagent/plugin-sdk/agent-harness-runtime";
import {
...
} from "actagent/plugin-sdk/agent-harness-task-runtime";
import { asFiniteNumber, normalizeOptionalString } from "actagent/plugin-sdk/string-coerce-runtime";
