/**
 * Projects ACTAgent context-engine assemblies into Codex prompt text while
...
import { redactSensitiveFieldValue, redactToolPayloadText } from "actagent/plugin-sdk/logging-core";
...
const CONTEXT_HEADER = "ACTAgent assembled context for this turn:";
...
/** Projects assembled ACTAgent context-engine messages into Codex prompt inputs. */
