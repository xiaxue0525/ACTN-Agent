// Codex tests cover actagent owned tool runtime contract plugin behavior.
import type { AnyAgentTool } from "actagent/plugin-sdk/agent-harness";
import { wrapToolWithBeforeToolCallHook } from "actagent/plugin-sdk/agent-harness-runtime";
import {
...
describe("ACTAgent-owned tool runtime contract — Codex app-server adapter", () => {
  afterEach(() => {
    resetACTAgentOwnedToolHooks();
  });
