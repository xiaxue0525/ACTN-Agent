/**
 * Resolves Codex filesystem sandbox policy payloads into ACTAgent path/glob
...
function readFsSandboxCwd(execServer: ACTAgentExecServer, sandbox: JsonObject): string {
