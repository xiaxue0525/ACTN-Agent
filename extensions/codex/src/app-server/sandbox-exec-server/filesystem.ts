 ...
 * with ACTAgent sandbox policy checks before every bridge operation.
 */
import { posix as pathPosix } from "node:path";
import type { SandboxFsStat } from "actagent/plugin-sdk/sandbox";
...
import type { DirectoryEntry, ACTAgentExecServer, ResolvedFsSandboxPolicy } from "./types.js";
