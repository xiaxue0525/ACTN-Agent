/**
 * Native Codex app-server compaction bridge for bound ACTAgent sessions.
 */
import {
  embeddedAgentLog,
...
export async function maybeCompactCodexAppServerSession(
  ...
  warnIfIgnoringACTAgentCompactionOverrides(params);
...
function warnIfIgnoringACTAgentCompactionOverrides(
  params: CompactEmbeddedAgentSessionParams,
): void {
