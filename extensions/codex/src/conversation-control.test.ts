...
import { clearRuntimeAuthProfileStoreSnapshots } from "actagent/plugin-sdk/agent-runtime";
...
describe("codex conversation controls", () => {
  beforeEach(async () => {
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "actagent-codex-control-"));
