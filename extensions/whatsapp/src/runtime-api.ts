...
export { getChatChannelMeta, type ChannelPlugin } from "actagent/plugin-sdk/core";
...
export { normalizeE164 } from "actagent/plugin-sdk/account-resolution";
export type { DmPolicy, GroupPolicy } from "actagent/plugin-sdk/config-contracts";
import type { ACTAgentConfig as RuntimeACTAgentConfig } from "actagent/plugin-sdk/config-contracts";

export { type ChannelMessageActionName } from "actagent/plugin-sdk/channel-contract";
...
export type ACTAgentConfig = RuntimeACTAgentConfig;
