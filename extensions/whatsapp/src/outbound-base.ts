...
import { sendTextMediaPayload } from "actagent/plugin-sdk/reply-payload";
import {
...
function resolveQuoteLookupAccountId(cfg?: ACTAgentConfig, accountId?: string | null): string {
