...
import { sleep } from "actagent/plugin-sdk/text-utility-runtime";
...
vi.mock("actagent/plugin-sdk/text-utility-runtime", async () => {
  const actual = await vi.importActual<typeof import("actagent/plugin-sdk/text-utility-runtime")>(
    "actagent/plugin-sdk/text-utility-runtime",
  );
  return {
    ...actual,
    sleep: vi.fn(async () => {}),
