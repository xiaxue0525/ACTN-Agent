...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "actagent/plugin-sdk/config-contracts";
import { resolveOAuthDir } from "actagent/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: ACTAgentConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ACTAgentConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: ACTAgentConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ACTAgentConfig): ResolvedWhatsAppAccount[] {
