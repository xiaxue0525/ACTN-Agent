...
import { safeParseJsonWithSchema, safeParseWithSchema } from "actagent/plugin-sdk/extension-shared";
import { mergePairLoopGuardConfig } from "actagent/plugin-sdk/pair-loop-guard-runtime";
import { isSecretRef } from "actagent/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: ACTAgentConfig): ResolvedGoogleChatAccount[] {
