...
function resolveGoogleChatAccountImpl(params: { cfg: ACTAgentConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: ACTAgentConfig) => {
...
function createGoogleChatCfg(): ACTAgentConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
