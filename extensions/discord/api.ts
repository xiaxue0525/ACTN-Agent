...
// Deprecated compatibility surface for existing @actagent/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "actagent/plugin-sdk/runtime-group-policy";
