...
import { buildOutboundMediaLoadOptions } from "actagent/plugin-sdk/media-runtime";
import { extensionForMime } from "actagent/plugin-sdk/media-runtime";
import {
...
import type { ChunkMode } from "actagent/plugin-sdk/reply-chunking";
import { resolveTextChunksWithFallback } from "actagent/plugin-sdk/reply-payload";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: ACTAgentConfig },
): Promise<{ channelId: string; dm?: boolean }> {
