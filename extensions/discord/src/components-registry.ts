...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("actagent.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("actagent.discord.modalEntries");
