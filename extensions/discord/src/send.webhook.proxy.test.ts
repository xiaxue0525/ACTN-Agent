...
vi.mock("actagent/plugin-sdk/fetch-runtime", async () => {
  const actual = await vi.importActual<typeof import("actagent/plugin-sdk/fetch-runtime")>(
    "actagent/plugin-sdk/fetch-runtime",
  );
  return {
    ...actual,
