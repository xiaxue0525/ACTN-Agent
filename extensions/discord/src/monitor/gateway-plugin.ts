...
import type { DiscordAccountConfig } from "actagent/plugin-sdk/config-contracts";
import { createNodeProxyAgent } from "actagent/plugin-sdk/fetch-runtime";
import {
  captureWsEvent,
  resolveEffectiveDebugProxyUrl,
  resolveDebugProxySettings,
} from "actagent/plugin-sdk/proxy-capture";
import { danger, warn } from "actagent/plugin-sdk/runtime-env";
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("actagent/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class ACTAgentGatewayPlugin extends discordGateway.GatewayPlugin {
  ...
  return new ACTAgentGatewayPlugin();
}
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // ACTAgent registers its own async interaction listener.
