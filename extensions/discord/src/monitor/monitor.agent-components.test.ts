...
import { peekSystemEvents, resetSystemEventsForTest } from "actagent/plugin-sdk/test-fixtures";
...
describe("agent components", () => {
  ...
  const createCfg = (): ACTAgentConfig => ({}) as ACTAgentConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`actagent pairing approve discord ${code}`);
