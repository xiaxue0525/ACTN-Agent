...
import { createConnectedChannelStatusPatch } from "actagent/plugin-sdk/gateway-runtime";
import {
  resolveNativeCommandsEnabled,
  resolveNativeSkillsEnabled,
} from "actagent/plugin-sdk/native-command-config-runtime";
...
import { isVerbose, logVerbose, shouldLogVerbose, warn } from "actagent/plugin-sdk/runtime-env";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("actagent/plugin-sdk/reply-history").HistoryEntry[]
    >();
