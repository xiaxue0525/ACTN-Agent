...
import { resolveCommandAuthorizedFromAuthorizers } from "actagent/plugin-sdk/command-auth-native";
...
export function resolveDiscordCommandOwnerAllowFrom(cfg: ACTAgentConfig): string[] | undefined {
