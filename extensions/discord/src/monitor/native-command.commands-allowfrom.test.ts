...
import * as pluginCommandsModule from "actagent/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "actagent/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: ACTAgentConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: ACTAgentConfig) => void;
