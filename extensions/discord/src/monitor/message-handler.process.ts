...
import { resolveAckReaction, resolveHumanDelayConfig } from "actagent/plugin-sdk/agent-runtime";
import {
...
import { getAgentScopedMediaLocalRoots } from "actagent/plugin-sdk/media-runtime";
import { resolveChunkMode } from "actagent/plugin-sdk/reply-chunking";
...
import type { ReplyDispatchKind, ReplyPayload } from "actagent/plugin-sdk/reply-runtime";
...
let replyRuntimePromise: Promise<typeof import("actagent/plugin-sdk/reply-runtime")> | undefined;

async function loadReplyRuntime() {
  replyRuntimePromise ??= import("actagent/plugin-sdk/reply-runtime");
