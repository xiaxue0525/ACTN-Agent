...
let conversationRuntimePromise:
  | Promise<typeof import("actagent/plugin-sdk/conversation-binding-runtime")>
  | undefined;

async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("actagent/plugin-sdk/conversation-binding-runtime");
