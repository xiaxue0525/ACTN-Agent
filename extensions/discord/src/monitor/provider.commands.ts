...
import { danger, warn, type RuntimeEnv } from "actagent/plugin-sdk/runtime-env";
import {
...
export type GetPluginCommandSpecs =
  typeof import("actagent/plugin-sdk/plugin-runtime").getPluginCommandSpecs;

let pluginRuntimePromise: Promise<typeof import("actagent/plugin-sdk/plugin-runtime")> | undefined;

async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("actagent/plugin-sdk/plugin-runtime");
