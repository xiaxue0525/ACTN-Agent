...
import { createSubsystemLogger, formatDurationSeconds } from "actagent/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("actagent/plugin-sdk/runtime-env").createSubsystemLogger
>;
