...
function createCfg(): ACTAgentConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: ACTAgentConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: ACTAgentConfig, accountId = "default") {
