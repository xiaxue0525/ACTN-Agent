...
import { loadWebMediaRaw } from "actagent/plugin-sdk/web-media";
import { afterAll, afterEach, beforeAll, beforeEach, describe, expect, it, vi } from "vitest";
import { RateLimitError } from "./internal/discord.js";
import { makeDiscordRest } from "./send.test-harness.js";

vi.mock("actagent/plugin-sdk/web-media", async () => {
...
afterAll(() => {
  vi.doUnmock("actagent/plugin-sdk/web-media");
});
...
describe("uploadStickerDiscord", () => {
  ...
  it("uploads sticker assets", async () => {
    ...
    expect(stickerBody.name).toBe("actagent_wave");
    expect(stickerBody.description).toBe("ACTAgent waving");
