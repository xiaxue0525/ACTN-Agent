...
import type { ACTAgentConfig, TtsConfig } from "actagent/plugin-sdk/config-contracts";
import { parseTtsDirectives } from "actagent/plugin-sdk/speech";
...
function resolveVoiceTtsConfig(params: { cfg: ACTAgentConfig; override?: TtsConfig }): {
  cfg: ACTAgentConfig;
