...
import { collectProviderDangerousNameMatchingScopes } from "actagent/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: ACTAgentConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: ACTAgentConfig,
  doctorFixCommand: string,
): { config: ACTAgentConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: ACTAgentConfig): string[] {
