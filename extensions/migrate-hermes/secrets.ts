...
import { updateAuthProfileStoreWithLock } from "actagent/plugin-sdk/provider-auth";
import {
...
async function buildOpenCodeSecretCandidates(
  ...
  // ACTAgent's Copilot token profile cannot preserve OpenCode enterprise routing yet.
