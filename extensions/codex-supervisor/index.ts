 ...
 * ACTAgent agents.
 */
import { buildJsonPluginConfigSchema, definePluginEntry } from "actagent/plugin-sdk/plugin-entry";
import {
...
export default definePluginEntry({
  ...
  description: "Supervise Codex app-server sessions from ACTAgent.",
