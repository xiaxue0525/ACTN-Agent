/**
 * ACTAgent agent-tool definitions for Codex Supervisor endpoint and session
 * controls.
 */
import { jsonResult, readStringParam, type AnyAgentTool } from "actagent/plugin-sdk/core";
...
/** Dependencies needed to build ACTAgent agent tools. */
...
/**
 * Creates the ACTAgent tools that expose Codex endpoint health and session
 * controls.
 */
export function createCodexSupervisorTools({
  ...
  return [
    ...
    },
    {
      ...
      description: "List Codex sessions visible to the ACTAgent supervisor.",
