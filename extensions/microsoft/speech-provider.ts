...
import { isVoiceCompatibleAudio } from "actagent/plugin-sdk/media-runtime";
import { assertOkOrThrowProviderError } from "actagent/plugin-sdk/provider-http";
import {
  captureHttpExchange,
...
import type {
  ...
  SpeechVoiceOption,
} from "actagent/plugin-sdk/speech";
import { asBoolean, asFiniteNumber, asObject, trimToUndefined } from "actagent/plugin-sdk/speech";
import {
  fetchWithSsrFGuard,
