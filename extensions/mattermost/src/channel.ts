...
import { createLoggedPairingApprovalNotifier } from "actagent/plugin-sdk/channel-pairing";
import { createRestrictSendersChannelSecurity } from "actagent/plugin-sdk/channel-policy";
import {
...
import { buildPassiveProbedChannelStatusSummary } from "actagent/plugin-sdk/extension-shared";
import {
...
import { resolvePayloadMediaUrls, sendTextMediaPayload } from "actagent/plugin-sdk/reply-payload";
...
export const mattermostPlugin: ChannelPlugin<ResolvedMattermostAccount> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      ...
      message: "ACTAgent: your access has been approved.",
