...
import { createSetupInputPresenceValidator } from "actagent/plugin-sdk/setup-runtime";
import {
...
export function resolveMattermostAccountWithSecrets(cfg: ACTAgentConfig, accountId: string) {
