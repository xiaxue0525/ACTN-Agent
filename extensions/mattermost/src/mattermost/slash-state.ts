 ...
 */
const ACCOUNT_STATES_KEY = Symbol.for("actagent.mattermost.slash-account-states");
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("./runtime-api.js").ACTAgentConfig;
 ...
 */
export function registerSlashCommandRoute(api: ACTAgentPluginApi) {
