...
function mergeZalouserAccountConfig(cfg: ACTAgentConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: ACTAgentConfig; accountId?: string | null }) {
