...
function ensureZalouserPluginEnabled(cfg: ACTAgentConfig): ACTAgentConfig {
      ...
      await prompter.note(
        [
          ...
          t("wizard.zalouser.peersLookupTip", {
            command: formatCliCommand("actagent directory peers list --channel zalouser"),
          }),
        ].join("\n"),
        ...
        await prompter.note(
          [
            ...
            t("wizard.zalouser.groupsLookupTip", {
              command: formatCliCommand("actagent directory groups list --channel zalouser"),
            }),
