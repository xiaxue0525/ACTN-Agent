...
import { stringEnum } from "actagent/plugin-sdk/channel-actions";
import type { AnyAgentTool, ACTAgentPluginToolContext } from "actagent/plugin-sdk/core";
...
type ZalouserToolContext = Pick<ACTAgentPluginToolContext, "deliveryContext">;
