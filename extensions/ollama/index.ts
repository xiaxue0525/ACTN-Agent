// Ollama plugin entrypoint registers its ACTAgent integration.
...
import { buildApiKeyCredential } from "actagent/plugin-sdk/provider-auth";
...
export default definePluginEntry({
  ...
  register(api: ACTAgentPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: ACTAgentConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY or run "actagent onboard --auth-choice ollama-cloud". ' +
        "See: https://docs.actagent.ai/providers/ollama",
    });
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "actagent configure". ' +
        "See: https://docs.actagent.ai/providers/ollama",
    });
  },
});
