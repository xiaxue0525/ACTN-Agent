...
import { resolveEnvApiKey } from "actagent/plugin-sdk/provider-auth-runtime";
import {
...
function resolveConfiguredOllamaWebSearchApiKey(config?: ACTAgentConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: ACTAgentConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: ACTAgentConfig): string {
