...
import type { AuthConfig } from "actagent/plugin-sdk/config-contracts";
import {
...
import type { ModelApi, ModelProviderConfig } from "actagent/plugin-sdk/provider-model-shared";
import {
