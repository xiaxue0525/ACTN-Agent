// Talk Voice plugin entrypoint registers its ACTAgent integration.
...
import type { SpeechVoiceOption } from "actagent/plugin-sdk/speech";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalLowercaseString,
} from "actagent/plugin-sdk/string-coerce-runtime";
import { resolveActiveTalkProviderConfig } from "actagent/plugin-sdk/talk-config-runtime";
  ...
  register(api: ACTAgentPluginApi) {
    api.registerCommand({
      ...
      handler: async (ctx) => {
        ...
        const cfg = api.runtime.config.current() as ACTAgentConfig;
