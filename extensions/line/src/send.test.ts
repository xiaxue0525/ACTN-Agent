...
vi.mock("actagent/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("actagent/plugin-sdk/channel-activity-runtime", () => ({
...
describe("LINE send helpers", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("actagent/plugin-sdk/channel-activity-runtime");
