...
vi.mock("actagent/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("actagent/plugin-sdk/channel-pairing", () => ({
...
vi.mock("actagent/plugin-sdk/command-auth-native", () => ({
...
vi.mock("actagent/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("actagent/plugin-sdk/reply-history", () => ({
...
vi.mock("actagent/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("actagent/plugin-sdk/channel-inbound");
    vi.doUnmock("actagent/plugin-sdk/channel-pairing");
    vi.doUnmock("actagent/plugin-sdk/command-auth-native");
    vi.doUnmock("actagent/plugin-sdk/runtime-group-policy");
    vi.doUnmock("actagent/plugin-sdk/runtime-env");
    vi.doUnmock("actagent/plugin-sdk/reply-history");
    vi.doUnmock("actagent/plugin-sdk/routing");
    vi.doUnmock("actagent/plugin-sdk/conversation-runtime");
