...
import type { ChannelSetupAdapter, ACTAgentConfig } from "actagent/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "actagent/plugin-sdk/setup";
...
export function isLineConfigured(cfg: ACTAgentConfig, accountId: string): boolean {
