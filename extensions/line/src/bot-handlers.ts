...
import { buildMentionRegexes, matchesMentionPatterns } from "actagent/plugin-sdk/channel-inbound";
import { resolveStableChannelMessageIngress } from "actagent/plugin-sdk/channel-ingress-runtime";
import { createChannelPairingChallengeIssuer } from "actagent/plugin-sdk/channel-pairing";
import { shouldComputeCommandAuthorized } from "actagent/plugin-sdk/command-auth-native";
import type { GroupPolicy, ACTAgentConfig } from "actagent/plugin-sdk/config-contracts";
import {
  readChannelAllowFromStore,
  resolvePairingIdLabel,
  upsertChannelPairingRequest,
} from "actagent/plugin-sdk/conversation-runtime";
import { createClaimableDedupe, type ClaimableDedupe } from "actagent/plugin-sdk/persistent-dedupe";
import {
