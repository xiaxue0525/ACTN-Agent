// Line plugin entrypoint registers its ACTAgent integration.
import {
  defineBundledChannelEntry,
  type ACTAgentPluginCommandDefinition,
  type ACTAgentPluginApi,
} from "actagent/plugin-sdk/channel-entry-contract";

type RegisteredLineCardCommand = ACTAgentPluginCommandDefinition;

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: ACTAgentPluginApi): Promise<RegisteredLineCardCommand> {
