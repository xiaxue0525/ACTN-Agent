...
} from "actagent/plugin-sdk/channel-config-primitives";
import { requireChannelOpenAllowFrom } from "actagent/plugin-sdk/extension-shared";
import { buildSecretInputSchema } from "actagent/plugin-sdk/secret-input";
import { z } from "zod";
...
export const SmsChannelConfigSchema = buildChannelConfigSchema(SmsConfigSchema, {
  uiHints: {
    ...
    textChunkLimit: {
      ...
      help: "Maximum characters per outbound SMS chunk before ACTAgent splits long replies.",
    },
  },
});
