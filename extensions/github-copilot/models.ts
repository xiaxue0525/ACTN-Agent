...
import { buildCopilotIdeHeaders, COPILOT_INTEGRATION_ID } from "actagent/plugin-sdk/provider-auth";
...
import { normalizeModelCompat } from "actagent/plugin-sdk/provider-model-shared";
import {
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in actagent.json — no
