// Github Copilot plugin entrypoint registers its ACTAgent integration.
...
import { getCachedLiveCatalogValue } from "actagent/plugin-sdk/provider-catalog-shared";
...
function applyCopilotDefaultModel(cfg: ACTAgentConfig): ACTAgentConfig {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: ACTAgentConfig): GithubCopilotPluginConfig {
