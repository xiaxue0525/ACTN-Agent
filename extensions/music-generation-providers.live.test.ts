...
const providerFilter = parseCsvFilter(process.env.ACTAGENT_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.ACTAGENT_LIVE_MUSIC_GENERATION_MODELS);
