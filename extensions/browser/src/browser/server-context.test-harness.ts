...
/** Mocks a launched ACTAgent Chrome process with the supplied pid. */
export function mockLaunchedChrome(
  launchACTAgentChrome: { mockResolvedValue: (value: RunningChrome) => unknown },
  pid: number,
) {
  const proc = new EventEmitter() as unknown as ChildProcessWithoutNullStreams;
  launchACTAgentChrome.mockResolvedValue({
    pid,
