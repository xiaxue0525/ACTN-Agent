...
// ACTAgent operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that ACTAgent itself navigated to a blocked URL.
...
/** Quarantine and close a tab that ACTAgent navigated to a blocked URL. */
...
export async function createPageViaPlaywright(
  ...
  if (targetUrl !== "about:blank") {
    ...
    // ACTAgent owns this newly-created tab: if the post-navigation safety
