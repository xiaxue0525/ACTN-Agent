...
const mocks = vi.hoisted(() => ({
  runtimeConfig: {} as ACTAgentConfig,
  runtimeSourceConfig: null as ACTAgentConfig | null,
...
vi.mock("../browser/chrome.js", () => ({
  ...
  launchACTAgentChrome: vi.fn(async () => {
    throw new Error("launch should not be needed for status");
  }),
  resolveACTAgentUserDataDir: vi.fn(() => "/tmp/actagent-browser"),
