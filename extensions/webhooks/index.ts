// Webhooks plugin entrypoint registers its ACTAgent integration.
...
function registerWebhookRoutes(api: ACTAgentPluginApi): void {
...
export default definePluginEntry({
  ...
  name: "Webhooks",
  description:
    "Authenticated inbound webhooks that bind external automation to ACTAgent TaskFlows.",
