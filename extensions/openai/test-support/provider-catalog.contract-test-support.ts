...
import type { ProviderPlugin } from "actagent/plugin-sdk/provider-test-contracts";
...
vi.mock("actagent/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("actagent/plugin-sdk/provider-catalog-runtime")
  >("actagent/plugin-sdk/provider-catalog-runtime");
