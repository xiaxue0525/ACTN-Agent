...
import { extractNonEmptyAssistantText, isLiveTestEnabled } from "actagent/plugin-sdk/test-env";
...
const LIVE_MODEL_ID =
  process.env.ACTAGENT_LIVE_OPENCODE_DEEPSEEK_MODEL?.trim() || "deepseek-v4-flash-free";
