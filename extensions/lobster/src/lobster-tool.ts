...
} from "actagent/plugin-sdk/param-readers";
...
type BoundTaskFlow = ReturnType<
  NonNullable<ACTAgentPluginApi["runtime"]>["tasks"]["managedFlows"]["bindSession"]
>;
...
export function createLobsterTool(api: ACTAgentPluginApi, options?: LobsterToolOptions) {
