...
import { readProviderJsonArrayFieldResponse } from "actagent/plugin-sdk/provider-http";
import type { ModelDefinitionConfig } from "actagent/plugin-sdk/provider-model-shared";
import { SELF_HOSTED_DEFAULT_COST } from "actagent/plugin-sdk/provider-setup";
...
/** Discovers LLM models from LM Studio and maps them to ACTAgent model definitions. */
