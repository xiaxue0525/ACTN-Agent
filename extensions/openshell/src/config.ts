...
import { buildPluginConfigSchema, type ACTAgentPluginConfigSchema } from "actagent/plugin-sdk/core";
import {
  formatPluginConfigIssue,
  mapPluginConfigIssues,
} from "actagent/plugin-sdk/extension-shared";
import { MAX_TIMER_TIMEOUT_SECONDS } from "actagent/plugin-sdk/number-runtime";
import { z } from "zod";
...
export function createOpenShellPluginConfigSchema(): ACTAgentPluginConfigSchema {
