...
vi.mock("actagent/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("actagent/plugin-sdk/hook-runtime")>(
    "actagent/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
