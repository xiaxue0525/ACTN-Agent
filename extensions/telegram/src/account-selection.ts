...
} from "actagent/plugin-sdk/account-core";
import {
  DEFAULT_ACCOUNT_ID,
  normalizeAccountId,
...
function listConfiguredAccountIds(cfg: ACTAgentConfig): string[] {
...
function listBoundAccountIds(cfg: ACTAgentConfig, channelId: string): string[] {
  const ids = new Set<string>();
...
function resolveDefaultAgentBoundAccountId(cfg: ACTAgentConfig, channelId: string): string | null {
...
function hasImplicitDefaultTelegramAccount(cfg: ACTAgentConfig): boolean {
...
export function listTelegramAccountIds(cfg: ACTAgentConfig): string[] {
...
export function resolveDefaultTelegramAccountSelection(cfg: ACTAgentConfig): {
  accountId: string;
  accountIds: string[];
...
export function resolveDefaultTelegramAccountId(cfg: ACTAgentConfig): string {
