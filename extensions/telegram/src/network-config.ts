...
import { isTruthyEnvValue, isWSL2Sync } from "actagent/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "actagent/plugin-sdk/string-coerce-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "ACTAGENT_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "ACTAGENT_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "ACTAGENT_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable ACTAGENT_TELEGRAM_DNS_RESULT_ORDER
