...
import { resolveApprovalApprovers } from "actagent/plugin-sdk/approval-auth-runtime";
import {
...
import { resolveApprovalRequestChannelAccountId } from "actagent/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "actagent/plugin-sdk/approval-runtime";
import type { ACTAgentConfig } from "actagent/plugin-sdk/config-contracts";
import type { TelegramExecApprovalConfig } from "actagent/plugin-sdk/config-contracts";
...
function resolveTelegramOwnerApprovers(cfg: ACTAgentConfig): Array<string | number> {
