...
import type { MessagePresentation } from "actagent/plugin-sdk/interactive-runtime";
...
function resolveActionTopicNameCacheScope(cfg: ACTAgentConfig, accountId?: string | null): string {
