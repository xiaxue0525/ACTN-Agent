...
import { createChannelPluginBase, type ChannelPlugin } from "actagent/plugin-sdk/channel-core";
import { getChatChannelMeta } from "actagent/plugin-sdk/channel-plugin-common";
 ...
 */
function isBlockedByMultiBotGuard(cfg: ACTAgentConfig, accountId: string): boolean {
