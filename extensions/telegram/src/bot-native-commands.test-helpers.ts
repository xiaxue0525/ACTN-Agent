...
vi.mock("actagent/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("actagent/plugin-sdk/reply-dispatch-runtime", () => ({
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    getRuntimeConfig: vi.fn(() => params?.cfg ?? ({} as ACTAgentConfig)),
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as ACTAgentConfig),
