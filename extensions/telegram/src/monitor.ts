...
import { resolveAgentMaxConcurrent } from "actagent/plugin-sdk/model-session-runtime";
...
export function createTelegramRunnerOptions(cfg: ACTAgentConfig): RunOptions<unknown> {
  return {
    sink: {
