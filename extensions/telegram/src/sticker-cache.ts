...
import { resolveApiKeyForProvider } from "actagent/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "actagent/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { resolveAutoImageModel } from "actagent/plugin-sdk/media-runtime";
import {
