...
import { resolveAccountWithDefaultFallback } from "actagent/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "actagent/plugin-sdk/channel-core";
import type { ACTAgentConfig } from "actagent/plugin-sdk/config-contracts";
import type { TelegramAccountConfig } from "actagent/plugin-sdk/config-contracts";
import { resolveDefaultSecretProviderAlias } from "actagent/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "actagent/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "actagent/plugin-sdk/secret-input";
import { coerceSecretRef } from "actagent/plugin-sdk/secret-input-runtime";
import { FsSafeError } from "actagent/plugin-sdk/security-runtime";
...
function inspectTokenValue(params: { cfg: ACTAgentConfig; value: unknown }): {
  token: string;
...
function hasConfiguredTelegramAccounts(cfg: ACTAgentConfig): boolean {
