...
import { resolveNormalizedAccountEntry } from "actagent/plugin-sdk/account-core";
import type { BaseTokenResolution } from "actagent/plugin-sdk/channel-contract";
...
function resolveEnvSecretRefValue(params: {
  cfg?: Pick<ACTAgentConfig, "secrets">;
  provider: string;
  id: string;
...
export function resolveTelegramToken(
  ...
  // See: https://github.com/actagent/actagent/issues/53876
