...
import { qaChannelPlugin, setQaChannelRuntime, type ACTAgentConfig } from "./runtime-api.js";
...
function createQaLabConfig(baseUrl: string): ACTAgentConfig {
    ...
    void (async () => {
      ...
      try {
        ...
        if (req.method === "GET" && url.pathname === "/api/capture/startup-status") {
          ...
          const gatewayUrl = controlUiUrl || "http://127.0.0.1:19199/";
