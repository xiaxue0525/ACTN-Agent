...
// Candidate scanning only sees actagent.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an actagent.json-like object.
 */
...
/**
 * Finds configured actagent.json values whose surfaces currently reject SecretRef objects.
 */
