...
function hasConfiguredPluginEntries(config: ACTAgentConfig): boolean {
...
function hasConfiguredChannelEntries(config: ACTAgentConfig): boolean {
...
function hasConfiguredPluginIntegrationSecretProviders(config: ACTAgentConfig): boolean {
...
function shouldLoadPluginMetadataForSecrets(config: ACTAgentConfig): boolean {
  return (
