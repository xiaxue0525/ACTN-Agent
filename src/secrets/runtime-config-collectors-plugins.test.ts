...
function makeContext(sourceConfig: ACTAgentConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: ACTAgentConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: ACTAgentConfig): void {
