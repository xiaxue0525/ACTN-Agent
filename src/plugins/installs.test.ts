  ...
  it.each([
    {
      ...
      input: {
        name: "@actagent/demo",
        version: "1.2.3",
        resolvedSpec: "@actagent/demo@1.2.3",
...
describe("resolveNpmInstallRecordSpec", () => {
  it("uses an exact resolved registry spec when managed installs request pinning", () => {
    expect(
      resolveNpmInstallRecordSpec({
        requestedSpec: "@actagent/codex",
        resolution: {
          name: "@actagent/codex",
          version: "2026.5.30-beta.1",
          resolvedSpec: "@actagent/codex@2026.5.30-beta.1",
        },
        pinResolvedRegistrySpec: true,
      }),
    ).toBe("@actagent/codex@2026.5.30-beta.1");
  });
    ...
    expect(
      resolveNpmInstallRecordSpec({
        ...
        resolution: {
          name: "@actagent/codex",
          version: "2026.5.30-beta.1",
          resolvedSpec: "@actagent/codex@beta",
        },
        pinResolvedRegistrySpec: true,
      }),
    ).toBe("@actagent/codex");
