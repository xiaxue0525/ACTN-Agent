...
/** Returns true when a command name is owned by built-in ACTAgent command handling. */
...
export function listPluginInvocationKeys(command: ACTAgentPluginCommandDefinition): string[] {
