...
import { setCurrentManifestModelIdNormalizationRecords } from "@actagent/model-catalog-core/provider-model-id-normalization";
...
let currentPluginMetadataConfigIdentityCache = new WeakSet<ACTAgentConfig>();
...
export function setCurrentPluginMetadataSnapshot(
  ...
  options: {
    config?: ACTAgentConfig;
    compatibleConfigs?: readonly ACTAgentConfig[];
