...
function resolve(config: ACTAgentConfig): string[] {
...
describe("resolveEffectivePluginIds", () => {
  ...
  ] satisfies Array<{ name: string; plugins: NonNullable<ACTAgentConfig["plugins"]> }>)(
