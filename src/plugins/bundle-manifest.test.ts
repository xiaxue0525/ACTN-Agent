/** Tests bundle manifest parsing for Codex, Claude, Cursor, and ACTAgent formats. */
...
function makeTempDir() {
  return makeTrackedTempDir("actagent-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat actagent.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "actagent.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });
