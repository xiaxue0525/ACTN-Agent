/** Stable ACTAgentHub install error codes used by plugin install policy and diagnostics. */
export const ACTAGENTHUB_INSTALL_ERROR_CODE = {
...
/** Union of stable ACTAgentHub install error code values. */
export type ACTAgentHubInstallErrorCode =
  (typeof ACTAGENTHUB_INSTALL_ERROR_CODE)[keyof typeof ACTAGENTHUB_INSTALL_ERROR_CODE];
