...
function normalizeModelProviderConfigsForWrite(cfg: ACTAgentConfig): ACTAgentConfig {
...
function normalizeConfigModelRefsForWrite(cfg: ACTAgentConfig): ACTAgentConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: sanitizeConfigPatchValue(patchModels) as NonNullable<
          NonNullable<ACTAgentConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  });
