...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: ACTAgentConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: ACTAgentConfig, value: unknown) => void;
  getConfiguredCredentialFallback?: (
    config?: ACTAgentConfig,
  ) => WebSearchProviderConfiguredCredentialFallback | undefined;
  applySelectionConfig?: (config: ACTAgentConfig) => ACTAgentConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => ACTAgentConfig | Promise<ACTAgentConfig>;
