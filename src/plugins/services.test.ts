...
import type { ACTAgentPluginService, ACTAgentPluginServiceContext } from "./types.js";
...
function createRegistry(
  services: ACTAgentPluginService[],
...
function expectServiceLogger(ctx: ACTAgentPluginServiceContext) {
...
function expectServiceContexts(
  contexts: ACTAgentPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: ACTAgentPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: ACTAgentPluginServiceContext[] = [];
    ...
    const officialInstallContexts: ACTAgentPluginServiceContext[] = [];
    ...
    const untrustedContexts: ACTAgentPluginServiceContext[] = [];
    ...
    const spoofedContexts: ACTAgentPluginServiceContext[] = [];
