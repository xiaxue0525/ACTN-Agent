...
import { buildModelCatalogMergeKey } from "@actagent/model-catalog-core/model-catalog-refs";
...
function normalizePluginsConfigForInstalledIndex(
  config: ACTAgentConfig["plugins"] | undefined,
...
function listPotentialEnabledChannelIds(config: ACTAgentConfig, env: NodeJS.ProcessEnv): string[] {
...
function resolveGatewayStartupDreamingPluginIds(config: ACTAgentConfig): Set<string> {
...
function collectConfiguredWebSearchProviderIds(config: ACTAgentConfig): ReadonlySet<string> {
...
function collectConfiguredVoiceProviderIds(config: ACTAgentConfig): ConfiguredVoiceProviderIds {
...
function collectValidationHeartbeatTargetChannelIds(config: ACTAgentConfig): string[] {
...
function collectValidationChannelConfigIds(config: ACTAgentConfig): string[] {
...
function collectConfiguredProviderIds(config: ACTAgentConfig): string[] {
...
function collectValidationConfiguredProviderIds(config: ACTAgentConfig): string[] {
...
function collectValidationConfiguredShorthandModelIds(config: ACTAgentConfig): string[] {
  return sortUniquePluginIds(
