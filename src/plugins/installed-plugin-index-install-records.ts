...
function normalizeInstallRecord(
  ...
  setInstallStringField(normalized, "actagenthubUrl", record.actagenthubUrl);
  setInstallStringField(normalized, "actagenthubPackage", record.actagenthubPackage);
  setInstallStringField(normalized, "actagenthubFamily", record.actagenthubFamily);
  setInstallStringField(normalized, "actagenthubChannel", record.actagenthubChannel);
  ...
  setInstallStringField(normalized, "actagentpackSha256", record.actagentpackSha256);
  setInstallNumberField(normalized, "actagentpackSpecVersion", record.actagentpackSpecVersion);
  setInstallStringField(normalized, "actagentpackManifestSha256", record.actagentpackManifestSha256);
  setInstallNumberField(normalized, "actagentpackSize", record.actagentpackSize);
