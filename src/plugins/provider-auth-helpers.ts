...
const resolveAuthAgentDir = (agentDir?: string, config?: ACTAgentConfig) =>
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: ACTAgentConfig): SecretRef {
