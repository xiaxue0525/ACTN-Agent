...
vi.mock("../discovery.js", () => ({
  discoverACTAgentPlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverACTAgentPlugins>
  ) => registryJitiMocks.discoverACTAgentPlugins(...args),
}));
...
export function resetRegistryJitiMocks(): void {
  ...
  registryJitiMocks.discoverACTAgentPlugins.mockReset();
  registryJitiMocks.loadPluginManifestRegistry.mockReset();
  registryJitiMocks.loadPluginRegistrySnapshot.mockReset();
  registryJitiMocks.discoverACTAgentPlugins.mockReturnValue({
    candidates: [],
    diagnostics: [],
  });
