...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/actagent-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/actagent-weixin@2.3.7",
    installPath:
      "/tmp/actagent-test-home/.actagent/npm/node_modules/@tencent-weixin/actagent-weixin",
...
async function loadWithMocks(params: {
  ...
  vi.doMock("./discovery.js", () => ({ discoverACTAgentPlugins: discoverSpy }));
...
function createChannelCandidate(params: {
  ...
  return {
    ...
    source: "/tmp/actagent-test-plugin/index.js",
    rootDir: "/tmp/actagent-test-plugin",
    origin: params.origin ?? "global",
    packageName: "@vendor/actagent-test-plugin",
    packageManifest: {
