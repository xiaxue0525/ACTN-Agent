...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by ACTAgent from plugin manifests, install records, and config policy. Use `actagent plugins registry --refresh`, `actagent plugins install/update/uninstall`, or `actagent plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored actagent.install metadata. This describes catalog/package
