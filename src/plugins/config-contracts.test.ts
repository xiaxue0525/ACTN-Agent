...
const mocks = vi.hoisted(() => {
  ...
  return {
    discoverACTAgentPlugins: vi.fn(() => ({ candidates: [], diagnostics: [] })),
...
vi.mock("./discovery.js", () => ({
  discoverACTAgentPlugins: mocks.discoverACTAgentPlugins,
}));
...
function createPluginRecord(
  ...
  return {
    ...
    hooks: [],
    source: `/tmp/${overrides.id}/actagent.plugin.json`,
...
describe("resolvePluginConfigContractsById", () => {
  beforeEach(() => {
    mocks.discoverACTAgentPlugins.mockReset();
    mocks.discoverACTAgentPlugins.mockReturnValue({ candidates: [], diagnostics: [] });
