...
import type { ACTAgentPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: ACTAgentPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): ACTAgentPluginConfigSchema {
  return {
