...
import { relinkACTAgentPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link.js";
...
export function removePluginFromConfig(
  ...
  pluginId: string,
  opts?: { channelIds?: string[] },
): { config: ACTAgentConfig; actions: Omit<UninstallActions, "directory"> } {
  ...
  const config: ACTAgentConfig = {
    ...
    channels: channels as ACTAgentConfig["channels"],
  };
