...
export type ACTAgentAgentToolResult<TResult = unknown> = AgentToolResult<TResult>;

export type AgentToolResultMiddlewareRuntime = "actagent" | "codex";
...
export type AgentToolResultMiddlewareEvent = {
  ...
  cwd?: string;
  isError?: boolean;
  result: ACTAgentAgentToolResult;
};
