...
describe("resolveMissingOfficialExternalChannelPluginRepairHint", () => {
  ...
  it("prefers the ACTAgentHub install hint for externalized WhatsApp", () => {
    mocks.resolveConfiguredChannelPresencePolicy.mockReturnValue([
      {
        channelId: "whatsapp",
        sources: ["explicit-config"],
    ...
    expect(
      ...
      channelId: "whatsapp",
      label: "WhatsApp",
      installSpec: "actagenthub:@actagent/whatsapp",
      installCommand: "actagent plugins install actagenthub:@actagent/whatsapp",
    });
  });
