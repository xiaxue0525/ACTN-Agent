...
import type { ACTAgentPluginCommandDefinition } from "./types.js";
...
function resolvePluginTextName(command: ACTAgentPluginCommandDefinition): string {
...
function serializePluginCommandSpec(
  cmd: ACTAgentPluginCommandDefinition,
  provider?: string,
): {
  name: string;
  description: string;
