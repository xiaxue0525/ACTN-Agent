...
export function applyProviderDefaultModel(cfg: ACTAgentConfig, modelRef: string): ACTAgentConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: ACTAgentConfig; modelId: string; modelRef: string; profileId: string } {
