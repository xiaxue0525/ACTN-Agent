/** Reads Codex/Claude/Cursor bundle manifests into ACTAgent plugin manifest metadata. */
...
export type BundlePluginManifest = {
  ...
  // Only include hook roots that ACTAgent can execute via HOOK.md + handler files.
  hooks: string[];
