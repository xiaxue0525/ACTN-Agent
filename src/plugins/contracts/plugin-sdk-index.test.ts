...
import type { ACTAgentBotConfig, ACTAgentConfig, ACTAgentSchemaType } from "../../plugin-sdk/index.js";
...
describe("plugin-sdk exports", () => {
  ...
  it("keeps deprecated root config type aliases aligned", () => {
    expectTypeOf<ACTAgentBotConfig>().toEqualTypeOf<ACTAgentConfig>();
    expectTypeOf<ACTAgentSchemaType>().toEqualTypeOf<ACTAgentConfig>();
  });
