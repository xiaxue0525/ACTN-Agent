...
import { normalizeACTAgentVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeACTAgentVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeACTAgentVersionBase(plugin.version) ??
    plugin.version
  );
}
