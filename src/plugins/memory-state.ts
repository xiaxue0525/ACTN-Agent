...
export type MemoryPluginRuntime = {
  ...
  closeMemorySearchManager?(params: { cfg: ACTAgentConfig; agentId: string }): Promise<void>;
...
export type MemoryPluginPublicArtifactsProvider = {
  listArtifacts(params: { cfg: ACTAgentConfig }): Promise<MemoryPluginPublicArtifact[]>;
};
