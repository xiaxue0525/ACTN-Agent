...
import type { ACTAgentPluginToolContext } from "../tool-types.js";
...
export type BoundTaskFlowRuntime = {
  ...
  cancel: (params: { flowId: string; cfg: ACTAgentConfig }) => Promise<BoundTaskFlowCancelResult>;
  runTask: (params: {
    flowId: string;
    runtime: TaskRuntime;
    sourceId?: string;
...
export type PluginRuntimeTaskFlow = {
  ...
  fromToolContext: (
    ctx: Pick<ACTAgentPluginToolContext, "sessionKey" | "deliveryContext">,
  ) => BoundTaskFlowRuntime;
};
