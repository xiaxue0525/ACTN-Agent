...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.actagent.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.actagent.js").ACTAgentConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.actagent.js").ACTAgentConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.actagent.js").ACTAgentConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.actagent.js").ACTAgentConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.actagent.js").ACTAgentConfig,
  ...
  media: {
    ...
    detectMime: typeof import("@actagent/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@actagent/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("actagent/plugin-sdk/llm").Model<import("actagent/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.actagent.js").ACTAgentConfig;
      workspaceDir?: string;
