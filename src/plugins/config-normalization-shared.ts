...
import { normalizeArrayBackedTrimmedStringList } from "@actagent/normalization-core/string-normalization";
...
export function hasExplicitPluginConfig(plugins?: ACTAgentConfig["plugins"]): boolean {
  if (!plugins) {
    return false;
  }
