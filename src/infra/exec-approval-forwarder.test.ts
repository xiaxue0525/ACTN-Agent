...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): ACTAgentConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): ACTAgentConfig {
  return {
