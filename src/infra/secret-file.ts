...
import { readSecretFileSync as readSecretFileSyncImpl } from "@actagent/fs-safe/secret";
...
} from "@actagent/fs-safe/secret";
export { writeSecretFileAtomic as writePrivateSecretFileAtomic } from "@actagent/fs-safe/secret";
