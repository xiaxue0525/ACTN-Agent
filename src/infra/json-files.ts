// Wraps fs-safe JSON reads and atomic writes with ACTAgent defaults.
import "./fs-safe-defaults.js";
import {
  JsonFileReadError,
  readJson as readJsonImpl,
  readJsonIfExists as readJsonIfExistsImpl,
} from "@actagent/fs-safe/json";
 ...
 * tryReadJsonImpl from @actagent/fs-safe. The fs-safe implementation retries
...
export { createAsyncLock } from "@actagent/fs-safe/advanced";
