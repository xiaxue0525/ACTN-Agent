// Wraps fs-safe atomic replacement and move helpers for ACTAgent install flows.
...
/**
 * Moves a path using fs-safe's copy fallback, with an ACTAgent hardlink guard
