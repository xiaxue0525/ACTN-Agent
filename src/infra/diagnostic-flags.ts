...
import { normalizeUniqueStringEntriesLower } from "@actagent/normalization-core/string-normalization";
import type { ACTAgentConfig } from "../config/types.actagent.js";

const DIAGNOSTICS_ENV = "ACTAGENT_DIAGNOSTICS";
...
/** Resolves enabled diagnostic flags from config plus `ACTAGENT_DIAGNOSTICS` overrides. */
