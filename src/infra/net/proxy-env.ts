...
// adding ACTAgent NO_PROXY CIDR/wildcard bypass checks.
 ...
 * - ACTAgent extension: IPv4 CIDR and octet-wildcard entries
 ...
 * in provider HTTP helpers; see actagent#64974 review thread on NO_PROXY
 * SSRF bypass.
 */
