...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "ACTAGENT_OAUTH_DIR",
  "ACTAGENT_PINNED_PYTHON",
  "ACTAGENT_PINNED_WRITE_PYTHON",
  "ACTAGENT_PLUGIN_INSTALL_OVERRIDES",
  ...
  "ACTAGENT_STATE_DIR",
  "ACTAGENT_TEST_TAILSCALE_BINARY",
  "PATH",
  "PI_CODING_AGENT_DIR",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "ACTAGENTHUB_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full ACTAgent runtime namespace
  // for shell/global config so new ACTAGENT_* controls are fail-closed by default.
  "ACTAGENT_",
  "ACTAGENT_ACTAGENTHUB_",
  "ACTAGENT_DISABLE_",
  "ACTAGENT_SKIP_",
  "ACTAGENT_UPDATE_",
];
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.actagent/.env (or ACTAGENT_STATE_DIR/.env),
