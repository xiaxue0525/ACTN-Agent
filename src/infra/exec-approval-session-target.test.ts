...
function resolveSlackPluginOriginTarget(params: { cfg: ACTAgentConfig; turnSourceTo: string }) {
...
describe("exec approval session target", () => {
  ...
  it("returns null for blank session keys, missing entries, and unresolved targets", () => {
    withTempDirSync({ prefix: "actagent-exec-approval-session-target-" }, (tmpDir) => {
