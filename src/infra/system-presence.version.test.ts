  ...
  return withEnvAsync(
    {
      ...
      ACTAGENT_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when ACTAGENT_VERSION is not set", async () => {
  ...
  it("prefers ACTAGENT_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over ACTAGENT_SERVICE_VERSION when ACTAGENT_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        ACTAGENT_VERSION: " ",
        ACTAGENT_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when ACTAGENT_VERSION and ACTAGENT_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        ACTAGENT_VERSION: " ",
        ACTAGENT_SERVICE_VERSION: "\t",
