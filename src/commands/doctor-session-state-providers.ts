...
import { normalizeStringEntriesLower } from "@actagent/normalization-core/string-normalization";
...
function resolveSessionAgentId(cfg: ACTAgentConfig, sessionKey: string): string {
