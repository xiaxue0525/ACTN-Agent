...
async function writeDefaultConfigFile(config: ACTAgentConfig): Promise<void> {
...
export async function setupCommand(
  ...
  runtime.log(`Next guided path: ${formatCliCommand("actagent onboard")}.`);
  runtime.log(
    `Next targeted changes: ${formatCliCommand("actagent configure")} for models, channels, Gateway, plugins, skills, and health checks.`,
  );
  runtime.log(`Add a chat channel later: ${formatCliCommand("actagent channels add")}.`);
}
