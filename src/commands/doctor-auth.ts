...
function hasConfiguredCodexOAuthProfile(cfg: ACTAgentConfig): boolean {
...
export function noteLegacyCodexProviderOverride(cfg: ACTAgentConfig): void {
...
function listAuthProfileHealthTargets(cfg: ACTAgentConfig): AuthProfileHealthTarget[] {
