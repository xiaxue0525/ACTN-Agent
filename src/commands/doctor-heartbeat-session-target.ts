...
function resolveHeartbeatConfig(cfg: ACTAgentConfig, agentId: string): HeartbeatConfig | undefined {
...
function listHeartbeatDoctorAgents(cfg: ACTAgentConfig) {
 ...
 */
export function describeHeartbeatSessionTargetIssues(cfg: ACTAgentConfig): string[] {
