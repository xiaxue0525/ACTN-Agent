/** Doctor contribution for low disk space around the ACTAgent state directory. */
 ...
 *
 * This catches a common operational failure mode where ACTAgent silently
...
export function noteDiskSpace(
  _cfg: ACTAgentConfig, // reserved for API consistency with other Doctor contributions
  deps?: {
