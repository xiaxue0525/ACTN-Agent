...
import { normalizeSortedUniqueStringEntries } from "@actagent/normalization-core/string-normalization";
...
function resolveDefaultAccountId(cfg: ACTAgentConfig, provider: ChannelId): string {
...
function listManifestChannelIds(config: ACTAgentConfig): Set<string> {
  return new Set(
