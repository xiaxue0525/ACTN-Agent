...
function noteFlowRecoveryHints() {
  ...
  note(
    [
      ...
      `Inspect: ${formatCliCommand("actagent tasks flow show <flow-id>")}`,
      `Cancel: ${formatCliCommand("actagent tasks flow cancel <flow-id>")}`,
    ]
...
export function noteWorkspaceStatus(cfg: ACTAgentConfig) {
