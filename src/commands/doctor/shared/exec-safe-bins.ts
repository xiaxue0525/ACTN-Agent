...
function collectExecSafeBinScopes(cfg: ACTAgentConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: ACTAgentConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: ACTAgentConfig): {
