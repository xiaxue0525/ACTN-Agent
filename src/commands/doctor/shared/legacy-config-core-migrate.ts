...
function pruneBindingsForMissingAgents(cfg: ACTAgentConfig, changes: string[]): ACTAgentConfig {
...
export function normalizeCompatibilityConfigValues(cfg: ACTAgentConfig): {
