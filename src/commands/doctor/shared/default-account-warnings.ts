...
export function collectMissingDefaultAccountBindingWarnings(cfg: ACTAgentConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: ACTAgentConfig): string[] {
  const warnings: string[] = [];
