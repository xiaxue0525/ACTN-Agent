...
export const UPDATE_IN_PROGRESS_ENV = "ACTAGENT_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "ACTAGENT_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `ACTAGENT_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `ACTAGENT_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */
