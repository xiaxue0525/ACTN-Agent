...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "ACTAGENT_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "ACTAGENT_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<ACTAgentConfig> | ACTAgentConfig;
  };
...
function listConfiguredChannelIds(config: ACTAgentConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: ACTAgentConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as ACTAgentConfig;
