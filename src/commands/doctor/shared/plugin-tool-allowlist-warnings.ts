...
function collectToolAllowlistSources(cfg: ACTAgentConfig): ToolAllowlistSource[] {
...
function collectConfiguredMcpServerNames(cfg: ACTAgentConfig): string[] {
...
function collectSandboxMcpAllowlistWarnings(cfg: ACTAgentConfig): string[] {
