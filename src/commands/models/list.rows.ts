/** Row builders used by `actagent models list` source orchestration. */
...
function toFallbackConfiguredListModel(entry: ConfiguredEntry, cfg: ACTAgentConfig): ListRowModel {
  return (
