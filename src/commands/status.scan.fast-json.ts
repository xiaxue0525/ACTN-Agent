// Fast `actagent status --json` scan policy.
...
type StatusJsonScanPolicy = {
  ...
  gatewayProbeTimeoutMs?: number | ((cfg: ACTAgentConfig) => number | undefined);
...
function hasExplicitStatusJsonChannelConfig(cfg: ACTAgentConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: ACTAgentConfig): boolean {
