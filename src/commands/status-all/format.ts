...
export function formatStatusServiceValue(params: {
  ...
  const installedPrefix = params.managedByACTAgent ? "installed · " : "";
...
export function resolveStatusDashboardUrl(params: {
  cfg: Pick<ACTAgentConfig, "gateway">;
}): string | null {
...
export function buildStatusOverviewSurfaceRows(params: {
  cfg: Pick<ACTAgentConfig, "update" | "gateway">;
  update: StatusUpdateLike;
  tailscaleMode: string;
...
export function buildStatusGatewaySurfaceValues(params: {
  ...
  return {
    ...
    gatewayServiceValue: formatStatusServiceValue({
      ...
      managedByACTAgent: params.gatewayService.managedByACTAgent,
    ...
    nodeServiceValue: formatStatusServiceValue({
      ...
      managedByACTAgent: params.nodeService.managedByACTAgent,
...
/** Builds the stable gateway object used by `actagent status --json`. */
