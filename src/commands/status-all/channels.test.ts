      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run actagent plugins install @actagent/feishu or actagent doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run actagent doctor --fix",
        },
      ],
      details: [],
    });
