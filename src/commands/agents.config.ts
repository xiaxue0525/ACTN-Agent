// Agent config mutation and summary builders used by `actagent agents` commands.
import {
...
function resolveAgentModel(cfg: ACTAgentConfig, agentId: string) {
...
export function buildAgentSummaries(cfg: ACTAgentConfig): AgentSummary[] {
