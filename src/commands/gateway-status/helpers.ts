...
import type { ACTAgentConfig, ConfigFileSnapshot } from "../../config/types.js";
...
export function resolveTargets(cfg: ACTAgentConfig, explicitUrl?: string): GatewayStatusTarget[] {
...
/** Extracts the config fields displayed by `actagent gateway status --deep`. */
...
export function buildNetworkHints(cfg: ACTAgentConfig) {
