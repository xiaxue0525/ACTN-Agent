...
export const InstallRecordShape = {
  ...
  actagenthubUrl: z.string().optional(),
  actagenthubPackage: z.string().optional(),
  actagenthubFamily: z.union([z.literal("code-plugin"), z.literal("bundle-plugin")]).optional(),
  actagenthubChannel: z
  ...
  actagentpackSha256: z.string().optional(),
  actagentpackSpecVersion: z.number().int().nonnegative().optional(),
  actagentpackManifestSha256: z.string().optional(),
  actagentpackSize: z.number().int().nonnegative().optional(),
