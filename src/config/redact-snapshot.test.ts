...
import type { ConfigFileSnapshot } from "./types.actagent.js";
...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/actagent.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/actagent/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/actagent/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/actagent/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/actagent/nickserv-password.txt");
