...
} from "@actagent/model-catalog-core/provider-model-id-normalization";
...
export function applyMessageDefaults(cfg: ACTAgentConfig): ACTAgentConfig {
...
export function applyTalkConfigNormalization(config: ACTAgentConfig): ACTAgentConfig {
...
export function applyAgentDefaults(cfg: ACTAgentConfig): ACTAgentConfig {
...
export function applyCronDefaults(cfg: ACTAgentConfig): ACTAgentConfig {
...
export function applyLoggingDefaults(cfg: ACTAgentConfig): ACTAgentConfig {
...
function hasAnthropicDefaultSignal(cfg: ACTAgentConfig, env: NodeJS.ProcessEnv): boolean {
...
export function applyCompactionDefaults(cfg: ACTAgentConfig): ACTAgentConfig {
