...
let runtimeConfigSnapshot: ACTAgentConfig | null = null;
let runtimeConfigSourceSnapshot: ACTAgentConfig | null = null;
...
function configSnapshotsMatch(left: ACTAgentConfig, right: ACTAgentConfig): boolean {
  if (left === right) {
    return true;
  }
  try {
...
export function hashRuntimeConfigValue(value: ACTAgentConfig): string {
...
export function getRuntimeConfigSourceSnapshot(): ACTAgentConfig | null {
...
export function resolveRuntimeConfigCacheKey(config: ACTAgentConfig): string {
...
export function selectApplicableRuntimeConfig(params: {
  inputConfig?: ACTAgentConfig;
  runtimeConfig?: ACTAgentConfig | null;
  runtimeSourceConfig?: ACTAgentConfig | null;
}): ACTAgentConfig | undefined {
...
export function loadPinnedRuntimeConfig(loadFresh: () => ACTAgentConfig): ACTAgentConfig {
...
export async function preflightRuntimeSnapshotWrite(params: {
  nextSourceConfig: ACTAgentConfig;
...
export async function finalizeRuntimeSnapshotWrite(params: {
  ...
  loadFreshConfig: () => ACTAgentConfig;
