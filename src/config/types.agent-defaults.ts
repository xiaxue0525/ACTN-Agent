...
export type AgentDefaultsConfig = {
  ...
  /** Embedded ACTAgent runner hardening and compatibility controls. */
  embeddedAgent?: {
    /**
     * How embedded ACTAgent should trust workspace-local `.actagent/settings.json`.
    ...
    /**
     * Embedded ACTAgent execution contract:
...
export type AgentCompactionConfig = {
  ...
  /** Embedded ACTAgent reserve tokens target before floor enforcement. */
  reserveTokens?: number;
  /** Embedded ACTAgent keepRecentTokens budget used for cut-point selection. */
  keepRecentTokens?: number;
  /** Minimum reserve tokens enforced for embedded ACTAgent compaction (0 disables the floor). */
