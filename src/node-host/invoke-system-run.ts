...
type ExecToolConfig = NonNullable<NonNullable<ACTAgentConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<ACTAgentConfig> {
