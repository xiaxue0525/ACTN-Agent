...
function ensureNodePathEnv(): string {
  ensureACTAgentCliOnPath({ pathEnv: process.env.PATH ?? "" });
...
function buildNodeHostLocalAuthConfig(config: ACTAgentConfig): ACTAgentConfig {
