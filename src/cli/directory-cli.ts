    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["actagent directory self --channel slack", "Show the connected account identity."],
          [
            'actagent directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["actagent directory groups list --channel discord", "List available groups/channels."],
          [
            "actagent directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.actagent.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
