...
type ParseACTAgentHubPluginSpecFn = (typeof import("../infra/actagenthub.js"))["parseACTAgentHubPluginSpec"];
...
export const loadConfig: Mock<LoadConfigFn> = vi.fn<LoadConfigFn>(() => ({}) as ACTAgentConfig);
...
export const replaceConfigFile: AsyncUnknownMock = vi.fn(
  async (params: { nextConfig: ACTAgentConfig }) => await writeConfigFile(params.nextConfig),
) as AsyncUnknownMock;
const resolveStateDir: Mock<() => string> = vi.fn(() => "/tmp/actagent-state");
...
export const installPluginFromACTAgentHub: AsyncUnknownMock = vi.fn();
export const parseACTAgentHubPluginSpec: Mock<ParseACTAgentHubPluginSpecFn> = vi.fn();
...
vi.mock("../config/config.js", () => ({
  ...
  writeConfigFile: ((config: ACTAgentConfig) =>
    invokeMock<
      [ACTAgentConfig],
...
vi.mock("../plugins/actagenthub.js", () => ({
  ...
  installPluginFromACTAgentHub: ((
    ...args: Parameters<(typeof import("../plugins/actagenthub.js"))["installPluginFromACTAgentHub"]>
  ) =>
    invokeMock<
      Parameters<(typeof import("../plugins/actagenthub.js"))["installPluginFromACTAgentHub"]>,
      ReturnType<(typeof import("../plugins/actagenthub.js"))["installPluginFromACTAgentHub"]>
    >(
      installPluginFromACTAgentHub,
      ...args,
    )) as (typeof import("../plugins/actagenthub.js"))["installPluginFromACTAgentHub"],
}));

vi.mock("../infra/actagenthub.js", () => ({
  parseACTAgentHubPluginSpec: ((
    ...args: Parameters<(typeof import("../infra/actagenthub.js"))["parseACTAgentHubPluginSpec"]>
  ) =>
    invokeMock<
      Parameters<(typeof import("../infra/actagenthub.js"))["parseACTAgentHubPluginSpec"]>,
      ReturnType<(typeof import("../infra/actagenthub.js"))["parseACTAgentHubPluginSpec"]>
    >(
      parseACTAgentHubPluginSpec,
      ...args,
    )) as (typeof import("../infra/actagenthub.js"))["parseACTAgentHubPluginSpec"],
}));
...
export function resetPluginsCliTestState() {
  ...
  installPluginFromACTAgentHub.mockReset();
  parseACTAgentHubPluginSpec.mockReset();
  ...
  replaceConfigFile.mockImplementation(
    (async (params: { nextConfig: ACTAgentConfig }) =>
      await writeConfigFile(params.nextConfig)) as (...args: unknown[]) => Promise<unknown>,
  );
  resolveStateDir.mockReturnValue("/tmp/actagent-state");
  resolveMarketplaceInstallShortcut.mockResolvedValue(null);
  installPluginFromMarketplace.mockResolvedValue({
    ok: false,
    error: "marketplace install failed",
  });
  enablePluginInConfig.mockImplementation(((cfg: ACTAgentConfig, pluginId: string) => ({
    config: cfg,
    enabled: true,
    pluginId,
  })) as (...args: unknown[]) => unknown);
  recordPluginInstall.mockImplementation(
    ((cfg: ACTAgentConfig) => cfg) as (...args: unknown[]) => unknown,
  );
  ...
  applyExclusiveSlotSelection.mockImplementation((({ config }: { config: ACTAgentConfig }) => ({
    config,
    warnings: [],
  })) as (...args: unknown[]) => unknown);
  ...
  installPluginFromACTAgentHub.mockResolvedValue({
    ok: false,
    error: "actagenthub install disabled in test",
  });
  parseACTAgentHubPluginSpec.mockReturnValue(null);
