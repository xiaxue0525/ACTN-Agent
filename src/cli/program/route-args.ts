...
/** Parse `actagent health` flags for the route-first status family. */
...
/** Parse `actagent status` flags without registering the full command tree. */
...
/** Parse `actagent gateway status` RPC-only flags accepted by the fast route. */
...
/** Parse `actagent sessions` filters for JSON/list route execution. */
...
/** Parse `actagent agents list` display switches for route-first execution. */
...
/** Parse `actagent config get <path>` while preserving root option handling. */
...
/** Parse `actagent config unset <path>` and its mutation guard flags. */
...
/** Parse `actagent models list` filters for the lightweight model catalog route. */
...
/** Parse `actagent models status` probe controls for the route-first status path. */
...
/** Parse `actagent channels list` display flags for the route-first list path. */
...
/** Parse `actagent channels status` probe flags without full CLI registration. */
...
/** Parse JSON-only `actagent plugins list` flags for plugin inventory output. */
...
/** Parse both `actagent tasks --json` and `actagent tasks list --json` aliases. */
...
/** Parse JSON-only `actagent tasks audit` filters for the route-first audit path. */
