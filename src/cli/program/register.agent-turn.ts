...
/** Register `actagent agent` for one Gateway-backed agent turn. */
...
${formatHelpExamples([
  ['actagent agent --to +15555550123 --message "status update"', "Start a new session."],
  ['actagent agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['actagent agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.actagent.ai/cli/agent")}`,
    )
