    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["actagent", "Start Crestodian."],
          ["actagent crestodian", "Start Crestodian explicitly."],
          ['actagent crestodian -m "status"', "Run one status request."],
          [
            'actagent crestodian -m "set default model openai/gpt-5.2" --yes',
