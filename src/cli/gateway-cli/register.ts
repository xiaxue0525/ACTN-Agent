      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["actagent gateway run", "Run the gateway in the foreground."],
            ["actagent gateway status", "Show service status plus connectivity/capability."],
            ["actagent gateway discover", "Find local and wide-area gateway beacons."],
            ["actagent gateway stability", "Show recent stability diagnostics."],
            ["actagent gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.actagent.ai/cli/gateway")}\n`,
      ),
  );
