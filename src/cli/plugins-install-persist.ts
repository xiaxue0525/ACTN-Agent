...
function addInstalledPluginToAllowlist(cfg: ACTAgentConfig, pluginId: string): ACTAgentConfig {
...
function removeInstalledPluginFromDenylist(cfg: ACTAgentConfig, pluginId: string): ACTAgentConfig {
  ...
  params.runtime.log(
    theme.warn(
      [
        ...
        "Run `actagent plugins doctor` for repair options.",
      ].join("\n"),
    ),
  );
}
