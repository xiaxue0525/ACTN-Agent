...
function resolveFetchConfig(config: ACTAgentConfig): Record<string, unknown> | undefined {
...
function resolveSearchConfig(config: ACTAgentConfig): Record<string, unknown> | undefined {
...
function getCapabilityWebSearchAutoDetectTargets(config: ACTAgentConfig): CommandSecretTargetScope {
...
function getCapabilityWebFetchAutoDetectTargets(config: ACTAgentConfig): CommandSecretTargetScope {
  return getCapabilityWebProviderAutoDetectTargets({
    config,
...
function isScopedChannelSecretTargetEntry(params: {
  ...
  return (
    ...
    params.entry.configFile === "actagent.json" &&
...
type CapabilityWebCommandSecretTargetParams = {
  ...
  autoDetectTargets: (config: ACTAgentConfig) => CommandSecretTargetScope;
  selectedProviderTargetIds: (
    config: ACTAgentConfig,
    providerId?: string | null,
  ) => SelectedProviderTargetIds;
