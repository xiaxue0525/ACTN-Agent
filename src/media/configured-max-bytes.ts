...
export function resolveConfiguredMediaMaxBytes(cfg?: ACTAgentConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: ACTAgentConfig | undefined, kind: MediaKind) {
