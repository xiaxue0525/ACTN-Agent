...
type AcpSessionsTable = ACTAgentStateKyselyDatabase["acp_sessions"];
type AcpSessionMetaDatabase = Pick<ACTAgentStateKyselyDatabase, "acp_sessions">;
...
}): { cfg: ACTAgentConfig; storePath: string } {
...
function selectAcpSessionRows(options: ACTAgentStateDatabaseOptions = {}): AcpSessionRow[] {
