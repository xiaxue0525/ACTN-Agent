...
import { normalizeText } from "@actagent/acp-core/normalize-text";
...
export { normalizeText } from "@actagent/acp-core/normalize-text";
...
export type ConfiguredAcpBindingSpec = {
  ...
  /** Owning ACTAgent agent id (used for session identity/storage). */
  agentId: string;
