/** Resolves ACP request metadata into ACTAgent Gateway session keys and reset behavior. */
import { readBool, readString } from "@actagent/acp-core/meta";
import type { AcpServerOptions } from "@actagent/acp-core/types";
...
/** Parses ACP request metadata into ACTAgent session routing hints. */
