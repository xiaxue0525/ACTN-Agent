...
import type {
  ...
  AcpRuntimeHandle,
  AcpRuntimeStatus,
} from "@actagent/acp-core/runtime/types";
...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: ACTAgentConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: ACTAgentConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: ACTAgentConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(cfg: ACTAgentConfig): Promise<void> {
