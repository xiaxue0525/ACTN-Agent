...
import type { AcpRuntime, AcpRuntimeCapabilities } from "@actagent/acp-core/runtime/types";
...
export type { AcpRuntime, ACTAgentConfig, SessionAcpMeta };
...
export const ORIGINAL_STATE_DIR = process.env.ACTAGENT_STATE_DIR;
