...
import type { AcpRuntime, AcpRuntimeHandle } from "@actagent/acp-core/runtime/types";
...
export async function runManagerInitializeSession(params: {
  ...
  enforceConcurrentSessionLimit: (params: { cfg: ACTAgentConfig; sessionKey: string }) => void;
