...
import { normalizeModelCatalogProviderRows } from "@actagent/model-catalog-core/model-catalog-normalize";
...
import type { ACTAgentProviderIndex } from "./provider-index/index.js";

// Provider-index planner converts ACTAgentHub-style preview catalog entries into
