// Bundled ACTAgent provider index advertises pre-install provider metadata for model picker discovery.
import type { ACTAgentProviderIndex } from "./types.js";

// ACTAgent-owned preview metadata for providers whose plugins may not be
...
export const ACTAGENT_PROVIDER_INDEX = {
  version: 1,
  providers: {
    moonshot: {
      id: "moonshot",
...
} satisfies ACTAgentProviderIndex;
