...
import { loadACTAgentProviderIndex, normalizeACTAgentProviderIndex } from "./index.js";

describe("ACTAgent provider index", () => {
  it("normalizes provider preview catalog rows through model catalog validation", () => {
    const index = normalizeACTAgentProviderIndex({
      version: 1,
      providers: {
        Moonshot: {
          id: "moonshot",
