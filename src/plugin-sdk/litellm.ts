...
import type { ModelDefinitionConfig, ACTAgentConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: ACTAgentConfig) => ACTAgentConfig;
  applyLitellmProviderConfig: (cfg: ACTAgentConfig) => ACTAgentConfig;
...
/** Apply LiteLLM defaults to the full ACTAgent config. */
