...
type FacadeModule = {
  applyOpenrouterConfig: (cfg: ACTAgentConfig) => ACTAgentConfig;
  applyOpenrouterProviderConfig: (cfg: ACTAgentConfig) => ACTAgentConfig;
...
/** Apply OpenRouter defaults to the full ACTAgent config. */
