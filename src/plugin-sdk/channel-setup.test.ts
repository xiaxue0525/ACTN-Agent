...
import { runSetupWizardFinalize } from "actagent/plugin-sdk/plugin-test-runtime";
...
describe("createOptionalChannelSetupSurface", () => {
  it("returns a matched adapter and wizard for optional plugins", async () => {
    ...
    expect(
      ...
      "Example setup requires @actagent/example to be installed. Docs: https://docs.actagent.ai/channels/example",
    );
    ...
    ).rejects.toThrow("@actagent/example");
  });
});
