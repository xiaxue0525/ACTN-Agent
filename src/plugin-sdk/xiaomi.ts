...
type FacadeModule = {
  applyXiaomiConfig: (cfg: ACTAgentConfig) => ACTAgentConfig;
  applyXiaomiProviderConfig: (cfg: ACTAgentConfig) => ACTAgentConfig;
...
/** Apply Xiaomi provider defaults to the full ACTAgent config. */
