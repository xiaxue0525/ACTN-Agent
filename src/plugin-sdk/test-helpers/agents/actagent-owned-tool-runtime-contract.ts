// ACTAgent-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installACTAgentOwnedToolHooks(params?: {
 ...
 * Pair with `installACTAgentOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetACTAgentOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
