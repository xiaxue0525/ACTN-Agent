...
/** Normalized model metadata used by ACTAgent provider catalogs. */
...
export const LMSTUDIO_DEFAULT_MODEL_ID: FacadeModule["LMSTUDIO_DEFAULT_MODEL_ID"] =
  "qwen/qwen3.5-9b";
/** Stable provider id used in ACTAgent config and provider catalogs. */
...
/** Map one raw LM Studio model entry into ACTAgent model metadata. */
...
/** Discover ACTAgent model definitions from an LM Studio server. */
