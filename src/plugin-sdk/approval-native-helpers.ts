...
type ChannelApprovalForwardingEvaluatorParams = {
  channel: string;
  isTransportEnabled: (params: { cfg: ACTAgentConfig; accountId?: string | null }) => boolean;
...
type NativeApprovalChannelRouteGateParams<TTarget extends NativeApprovalTarget> = {
  ...
  isTransportEnabled: (params: { cfg: ACTAgentConfig; accountId?: string | null }) => boolean;
  listAccountIds: (cfg: ACTAgentConfig) => readonly string[];
  resolveDefaultAccountId: (cfg: ACTAgentConfig) => string;
  normalizeForwardTarget: (target: NativeApprovalForwardTarget) => TTarget | null;
...
export function shouldSuppressLocalNativeExecApprovalPrompt(params: {
  ...
  isNativeDeliveryEnabled?: (params: { cfg: ACTAgentConfig; accountId?: string | null }) => boolean;
