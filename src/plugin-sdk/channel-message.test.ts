...
describe("defineChannelMessageAdapter", () => {
  const loadPluginSdkSubpaths = async () =>
    await Promise.all([
      import("actagent/plugin-sdk/channel-outbound"),
      import("actagent/plugin-sdk/channel-message"),
      import("actagent/plugin-sdk/channel-message-runtime"),
      import("actagent/plugin-sdk/channel-reply-pipeline"),
      import("actagent/plugin-sdk/compat"),
    ] as const);
