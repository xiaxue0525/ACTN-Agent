...
export function resolveSessionToolsVisibility(cfg: ACTAgentConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: ACTAgentConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: ACTAgentConfig): AgentToAgentPolicy {
