...
import type { ACTAgentPluginApi } from "../plugins/types.js";
...
export type { ACTAgentConfig } from "../config/config.js";
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: ACTAgentConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
