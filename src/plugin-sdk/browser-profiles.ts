...
export const DEFAULT_ACTAGENT_BROWSER_ENABLED = true;
...
export const DEFAULT_ACTAGENT_BROWSER_COLOR = "#FF4500";
/** Default ACTAgent-managed browser profile name. */
export const DEFAULT_ACTAGENT_BROWSER_PROFILE_NAME = "actagent";
/** Default browser profile selected when config omits a profile name. */
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "actagent";
...
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredACTAgentTmpDir(), "uploads");
