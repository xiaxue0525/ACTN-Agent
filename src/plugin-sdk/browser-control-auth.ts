// Browser control auth helpers resolve plugin browser credentials from ACTAgent config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: ACTAgentConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
