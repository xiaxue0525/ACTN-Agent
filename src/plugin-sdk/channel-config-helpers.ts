...
type ChannelConfigAccessorParams<Config extends ACTAgentConfig = ACTAgentConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends ACTAgentConfig = ACTAgentConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends ACTAgentConfig = ACTAgentConfig>(
...
function setTopLevelChannelEnabledInConfigSection<Config extends ACTAgentConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends ACTAgentConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends ACTAgentConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
