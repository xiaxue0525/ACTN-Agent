...
/** Runtime adapter that lets the package agent-core use ACTAgent LLM helpers. */
export const actAgentAgentCoreRuntime = {
...
/** Agent-core class preconfigured with ACTAgent runtime dependencies. */
export class Agent extends CoreAgent {
  constructor(options: CoreAgentOptions = {}) {
    super({ runtime: actAgentAgentCoreRuntime, ...options });
  }
}

// ACTAgent-owned reusable agent core
