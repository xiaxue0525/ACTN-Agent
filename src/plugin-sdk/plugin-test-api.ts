...
import {
  ...
  type ACTAgentPluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { ACTAgentPluginApi } from "./plugin-runtime.js";

/** Partial plugin API overrides accepted by the SDK test helper. */
export type TestPluginApiInput = Partial<ACTAgentPluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): ACTAgentPluginApi {
  ...
  const mergedApi = {
    ...
    on() {},
    ...flatApi,
  } as ACTAgentPluginApiWithoutFacades;
