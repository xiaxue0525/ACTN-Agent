...
const FACADE_LOADER_GLOBAL = "__actagentTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    const pluginId = nextTrustedPluginId("actagent-facade-loader-override-");
    const overrideA = createBundledPluginFixture({
      pluginId,
      kind: "dist",
      prefix: "actagent-facade-loader-a-",
      marker: "override-a",
    });
    const overrideB = createBundledPluginFixture({
      pluginId,
      kind: "dist-runtime",
      prefix: "actagent-facade-loader-b-",
      marker: "override-b",
    });

    process.env.ACTAGENT_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.ACTAGENT_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    const fixture = createPackageSourcePluginFixture({
      prefix: "actagent-facade-loader-source-fallback-",
      marker: "source-fallback",
    });
    process.env.ACTAGENT_BUNDLED_PLUGINS_DIR = createTempDirSync("actagent-facade-loader-empty-");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const fixture = createBundledPluginFixture({
      prefix: "actagent-facade-loader-ids-",
      marker: "identity-check",
    });
    process.env.ACTAGENT_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("uses native require for Windows dist facade loads", () => {
    const fixture = createBundledPluginFixture({
      prefix: "actagent-facade-loader-windows-",
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const fixture = createCircularPluginFixture("actagent-facade-loader-circular-");
    process.env.ACTAGENT_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const fixture = createThrowingPluginFixture("actagent-facade-loader-throw-");
    process.env.ACTAGENT_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
