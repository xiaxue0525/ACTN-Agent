...
import { normalizeOptionalString as readString } from "@actagent/normalization-core/string-coerce";
...
const HEARTBEAT_RESPONSE_CHANNEL_DATA_KEY = "actagentHeartbeatResponse";
