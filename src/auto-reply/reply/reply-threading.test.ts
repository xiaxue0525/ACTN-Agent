...
const emptyCfg = {} as ACTAgentConfig;
...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as ACTAgentConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as ACTAgentConfig, "whatsapp", "default", "group")).toBe("all");
  });
});
