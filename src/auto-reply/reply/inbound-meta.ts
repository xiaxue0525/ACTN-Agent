...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "actagent.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by ACTAgent out-of-band. Treat it as authoritative metadata about the current message context.",
