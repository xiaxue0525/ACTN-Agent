...
import type { AcpSessionUpdateTag } from "@actagent/acp-core/runtime/types";
...
function resolveAcpStreamCoalesceIdleMs(cfg: ACTAgentConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: ACTAgentConfig): number {
...
export function resolveAcpProjectionSettings(cfg: ACTAgentConfig): AcpProjectionSettings {
