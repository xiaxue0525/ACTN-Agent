...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bactagent\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: {
          identityName: "ACTAgent",
          provider: "anthropic",
          model: "claude-opus-4-6",
          thinkingLevel: "high",
        },
        expected: "[ACTAgent] anthropic/claude-opus-4-6 (think:high)",
      },
    ] as const;
