...
import {
  buildCurrentACTAgentCliArgv,
  buildCurrentACTAgentCliCommand,
} from "./commands-actagent-cli.js";
import {
...
const EXPORT_TRAJECTORY_DOCS_URL = "https://docs.actagent.ai/tools/trajectory";
...
function buildTrajectoryExportExecRequest(
  ...
  return {
    argv: buildCurrentACTAgentCliArgv(args),
    command: buildCurrentACTAgentCliCommand(args),
    displayCommand: ["actagent", ...args].join(" "),
    encodedRequest,
    request,
  };
}
