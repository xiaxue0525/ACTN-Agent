...
const resolveEnvApiKeyMock = vi.hoisted(() =>
  vi.fn(
    (
      ...
      _options?: { config?: ACTAgentConfig; workspaceDir?: string },
...
vi.mock("../../agents/model-auth.js", () => ({
  ...
  resolveEnvApiKey: (
    ...
    options?: { config?: ACTAgentConfig; workspaceDir?: string },
...
describe("resolveAuthLabel ref-aware labels", () => {
  ...
  it("passes workspace scope to env auth labels", async () => {
    const cfg = { plugins: { allow: ["workspace-auth-label"] } } as ACTAgentConfig;
