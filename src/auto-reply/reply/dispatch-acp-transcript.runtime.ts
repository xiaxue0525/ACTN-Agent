// Bridges ACP transcript events into persisted ACTAgent session transcripts.
import { resolveAcpSessionCwd } from "@actagent/acp-core/runtime/session-identifiers";
