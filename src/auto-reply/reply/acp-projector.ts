// Projects ACP runtime events into ACTAgent-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@actagent/acp-core/runtime/types";
import {
