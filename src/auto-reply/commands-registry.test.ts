...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@actagent", { botUsername: "actagent" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@actagent args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "actagent" })).toBe(
      "/help@otherbot",
    );
  });
