...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("actagent.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("actagent.contextEngineRegistryState");
