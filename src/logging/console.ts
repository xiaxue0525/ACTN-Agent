...
type ConsoleConfigLoader = () => ACTAgentConfig["logging"] | undefined;
...
function normalizeConsoleLevel(level?: string): LogLevel {
  ...
  if (!level && process.env.VITEST === "true" && process.env.ACTAGENT_TEST_CONSOLE !== "1") {
    return "silent";
  }
...
function resolveConsoleSettings(): ConsoleSettings {
  ...
  if (
    ...
    process.env.ACTAGENT_TEST_CONSOLE !== "1" &&
    !isVerbose() &&
    !envLevel &&
  ...
  let cfg: ACTAgentConfig["logging"] | undefined =
