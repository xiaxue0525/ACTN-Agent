...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __actagentDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore["__actagentDiagnosticStabilityState"] ??= createState();
  return globalStore["__actagentDiagnosticStabilityState"];
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore["__actagentDiagnosticStabilityState"] = next;
}
