...
/** @deprecated Use `channelRouteTargetsMatchExact` from `actagent/plugin-sdk/channel-route`. */
...
/** @deprecated Use `channelRouteTargetsShareConversation` from `actagent/plugin-sdk/channel-route`. */
