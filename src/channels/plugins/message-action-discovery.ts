 ...
 */
export function listChannelMessageActions(cfg: ACTAgentConfig): ChannelMessageActionName[] {
 ...
 */
export function listChannelMessageCapabilities(cfg: ACTAgentConfig): ChannelMessageCapability[] {
