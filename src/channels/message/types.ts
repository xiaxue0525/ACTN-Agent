...
export type ChannelMessageSendTextContext<TConfig = ACTAgentConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = ACTAgentConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = ACTAgentConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = ACTAgentConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = ACTAgentConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = ACTAgentConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = ACTAgentConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
