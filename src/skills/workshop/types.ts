...
export const SKILL_WORKSHOP_SCHEMA = "actagent.skill-workshop.proposal.v1" as const;
export const SKILL_WORKSHOP_MANIFEST_SCHEMA =
  "actagent.skill-workshop.proposals-manifest.v1" as const;
export const SKILL_WORKSHOP_ROLLBACK_SCHEMA = "actagent.skill-workshop.rollback.v1" as const;
