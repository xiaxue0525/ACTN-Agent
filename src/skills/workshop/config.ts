// Workshop config helpers resolve skill workshop settings from ACTAgent config.
...
export function resolveSkillWorkshopConfig(config?: ACTAgentConfig): SkillWorkshopConfig {
