...
import {
  readACTAgentHubSkillsLockfileStatusSync,
  resolveACTAgentHubSkillStatusLinkSync,
  resolveLocalSkillCardStatusSync,
  type ACTAgentHubSkillStatusLink,
  type ACTAgentHubSkillsLockfileStatusRead,
  type LocalSkillCardStatus,
} from "../lifecycle/actagenthub.js";
...
export type SkillStatusEntry = {
  ...
  actagenthub?: ACTAgentHubSkillStatusLink;
...
type BuildSkillStatusContext = {
  ...
  agentSkillFilter?: string[];
  workspaceDir: string;
  actagenthubLockRead: ACTAgentHubSkillsLockfileStatusRead;
};
  ...
  const actagenthub =
    workspaceDir && !bundled
      ? resolveACTAgentHubSkillStatusLinkSync({
          ...
          skillKey,
          lockRead: context.actagenthubLockRead,
        })
      : undefined;
...
export function buildWorkspaceSkillStatus(
  ...
  const actagenthubLockRead = readACTAgentHubSkillsLockfileStatusSync(workspaceDir);
