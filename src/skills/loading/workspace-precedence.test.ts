...
import type { ACTAgentSkillMetadata, SkillEntry } from "../types.js";
...
const fixtureSuite = createFixtureSuite("actagent-skills-prompt-suite-");
...
function createSkillEntry(params: {
  name: string;
  description?: string;
  metadata?: ACTAgentSkillMetadata;
}): SkillEntry {
