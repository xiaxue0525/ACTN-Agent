...
function hasConfiguredSkillApiKeyRef(config?: ACTAgentConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: ACTAgentConfig): ACTAgentConfig | undefined {
