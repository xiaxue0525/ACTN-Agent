...
/** Accepted root marker names for ACTAgentHub skill archive uploads. */
export const ACTAGENTHUB_SKILL_ARCHIVE_ROOT_MARKERS = [
  "SKILL.md",
  "skill.md",
  "skills.md",
  "SKILL.MD",
...
export async function installSkillArchiveFromPath(params: {
  ...
  const result = await withExtractedArchiveRoot({
    ...
    tempDirPrefix: "actagent-skill-archive-",
    timeoutMs: params.timeoutMs ?? 120_000,
    logger: params.logger,
