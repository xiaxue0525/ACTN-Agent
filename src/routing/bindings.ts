...
export function listBindings(cfg: ACTAgentConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: ACTAgentConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ACTAgentConfig) {
