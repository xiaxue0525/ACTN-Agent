...
function listConfiguredChannelIds(cfg: ACTAgentConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: ACTAgentConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: ACTAgentConfig): ChannelRouteTarget[] {
