...
function resolveRealtimeVoiceProviderEntries(cfg?: ACTAgentConfig): RealtimeVoiceProviderPlugin[] {
 ...
 */
export function listRealtimeVoiceProviders(cfg?: ACTAgentConfig): RealtimeVoiceProviderPlugin[] {
