...
export function resolveCommitmentsConfig(cfg?: ACTAgentConfig): ResolvedCommitmentsConfig {
...
export function resolveCommitmentTimezone(cfg?: ACTAgentConfig): string {
