...
export type PromptDefaultModelResult = { model?: string; config?: ACTAgentConfig };
...
function resolveConfiguredModelRaw(cfg: ACTAgentConfig): string {
  return resolveAgentModelPrimaryValue(cfg.agents?.defaults?.model) ?? "";
}

function resolveConfiguredModelKeys(cfg: ACTAgentConfig): string[] {
