...
import { asOptionalObjectRecord as readRecord } from "@actagent/normalization-core/record-coerce";
...
export function registerBundledHealthChecks(params: { cfg: ACTAgentConfig; cwd?: string }): void {
...
function shouldRegisterPolicyHealth(params: { cfg: ACTAgentConfig; cwd?: string }): boolean {
