...
function resolveTranscriptsSourceProviderEntries(cfg?: ACTAgentConfig): TranscriptSourceProvider[] {
...
function buildProviderMaps(cfg?: ACTAgentConfig): {
...
export function listTranscriptSourceProviders(cfg?: ACTAgentConfig): TranscriptSourceProvider[] {
