        ...
        wss.handleUpgrade(req, socket, head, (ws) => {
          (
            ws as unknown as import("ws").WebSocket & {
              __actagentPreauthBudgetClaimed?: boolean;
              __actagentPreauthBudgetKey?: string;
            }
          )["__actagentPreauthBudgetKey"] = preauthBudgetKey;
          ...
          const budgetClaimed = Boolean(
            ...
            )["__actagentPreauthBudgetClaimed"],
          );
          if (budgetClaimed) {
            budgetTransferred = true;
