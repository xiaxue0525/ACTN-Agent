...
describe("gateway auth", () => {
  ...
  it("resolves token/password from ACTAGENT gateway env vars", () => {
    const auth = resolveGatewayAuth({
      authConfig: {},
      env: {
        ACTAGENT_GATEWAY_TOKEN: "env-token",
        ACTAGENT_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides ACTAGENT_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        ACTAGENT_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
