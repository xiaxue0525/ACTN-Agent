...
export function didSharedGatewayAuthChange(prev: ACTAgentConfig, next: ACTAgentConfig): boolean {
...
}): Promise<{ path: string; config: ACTAgentConfig; queueFollowUp: () => void }> {
