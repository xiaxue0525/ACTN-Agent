...
function listConfiguredAnnounceChannelIds(cfg: ACTAgentConfig): string[] {
...
function assertValidCronAnnounceDelivery(params: { cfg: ACTAgentConfig; delivery?: CronDelivery }) {
...
function assertValidCronCreateDelivery(cfg: ACTAgentConfig, jobCreate: CronJobCreate) {
