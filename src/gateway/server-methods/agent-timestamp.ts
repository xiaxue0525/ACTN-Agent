 ...
 *
 * @see https://github.com/actagent/actagent/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an ACTAgentConfig.
 */
export function timestampOptsFromConfig(cfg: ACTAgentConfig): TimestampInjectionOptions {
  return {
