...
describe("resolvePinnedClientMetadata", () => {
  ...
  it.each([
    ["actagent-ios", "iOS 26.5.0", "iOS 26.4.2", "iPhone"],
    ["actagent-ios", "iPadOS 26.5.0", "iPadOS 26.4.2", "iPad"],
    ["actagent-ios", "iPadOS 26.5.0", "iOS 26.4.2", "iPad"],
    ["actagent-android", "Android 16", "Android 15", "Android"],
  ])(
