...
// Removes ACTAgent-only envelopes before messages are shown in UI/RPC results.
...
/** Strips ACTAgent envelope metadata from one display message without mutating it. */
