...
describe("resolveHostName", () => {
  it.each([
    { input: "localhost:19199", expected: "localhost" },
    { input: "127.0.0.1:19199", expected: "127.0.0.1" },
    { input: "[::1]:19199", expected: "::1" },
    { input: "::1", expected: "::1" },
...
describe("isLocalishHost", () => {
  ...
  it("rejects non-local hosts", () => {
    const rejected = ["example.com", "192.168.1.10", "203.0.113.5:19199"];
...
describe("isContainerEnvironment", () => {
  ...
  it("returns true on Fly Machines without Docker sentinel files", () => {
    ...
    process.env.FLY_APP_NAME = "actagent-test";
    expect(isContainerEnvironment()).toBe(true);
  });
...
describe("isSecureWebSocketUrl", () => {
  it.each([
    // wss:// always accepted
    { input: "wss://127.0.0.1:19199", expected: true },
    { input: "wss://localhost:19199", expected: true },
    { input: "wss://remote.example.com:19199", expected: true },
    { input: "wss://192.168.1.100:19199", expected: true },
    // ws:// loopback accepted
    { input: "ws://127.0.0.1:19199", expected: true },
    { input: "ws://localhost:19199", expected: true },
    { input: "ws://[::1]:19199", expected: true },
    { input: "ws://127.0.0.42:19199", expected: true },
    // ws:// trusted LAN/Tailnet endpoints accepted
    { input: "ws://10.0.0.5:19199", expected: true },
    { input: "ws://10.42.1.100:19199", expected: true },
    { input: "ws://172.16.0.1:19199", expected: true },
    { input: "ws://172.31.255.254:19199", expected: true },
    { input: "ws://192.168.1.100:19199", expected: true },
    { input: "ws://169.254.10.20:19199", expected: true },
    { input: "ws://100.64.0.1:19199", expected: true },
    { input: "ws://[fc00::1]:19199", expected: true },
    { input: "ws://[fd12:3456:789a::1]:19199", expected: true },
    { input: "ws://[fe80::1]:19199", expected: true },
    { input: "ws://gateway.local:19199", expected: true },
    { input: "ws://machine.tail123.ts.net:19199", expected: true },
    { input: "ws://[::]:19199", expected: false },
    { input: "ws://[ff02::1]:19199", expected: false },
    // ws:// public addresses rejected
    { input: "ws://remote.example.com:19199", expected: false },
    { input: "ws://1.1.1.1:19199", expected: false },
    { input: "ws://8.8.8.8:19199", expected: false },
    { input: "ws://203.0.113.10:19199", expected: false },
    // invalid URLs
    { input: "not-a-url", expected: false },
    { input: "", expected: false },
    { input: "http://127.0.0.1:19199", expected: true },
    { input: "https://127.0.0.1:19199", expected: true },
    { input: "https://remote.example.com:19199", expected: true },
    { input: "http://remote.example.com:19199", expected: false },
  ...
  it("allows arbitrary private-dns ws:// hostnames only when opt-in is enabled", () => {
    const allowedWhenOptedIn = ["ws://gateway.private.example:19199"];
  ...
  it("still rejects ws:// public IP literals when opt-in is enabled", () => {
    const publicIpWsUrls = ["ws://1.1.1.1:19199", "ws://8.8.8.8:19199", "ws://203.0.113.10:19199"];
