...
import type {
  ...
  ACTAgentPluginNodeInvokeTransportResult,
...
function createApprovalRuntime(params: {
  ...
  pluginId: string;
}): ACTAgentPluginNodeInvokePolicyContext["approvals"] | undefined {
...
export async function applyPluginNodeInvokePolicy(params: {
  ...
  const invokeNode: ACTAgentPluginNodeInvokePolicyContext["invokeNode"] = async (
    override = {},
