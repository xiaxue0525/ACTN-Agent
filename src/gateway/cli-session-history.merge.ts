...
// Deduplicates external history messages against local ACTAgent transcripts.
...
function resolveImportedExternalIdentity(message: unknown): ImportedExternalIdentity | undefined {
  ...
  const meta =
    "__actagent" in message &&
    (message as { __actagent?: unknown })["__actagent"] &&
    typeof (message as { __actagent?: unknown })["__actagent"] === "object"
      ? ((message as { __actagent?: Record<string, unknown> })["__actagent"] ?? {})
      : undefined;
