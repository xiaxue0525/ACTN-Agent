  ...
  it.each([
    {
      ...
      input: {
        requestHost: "127.0.0.1:19199",
        origin: "http://127.0.0.1:19199",
    ...
    },
    {
      ...
      input: {
        requestHost: "gateway.example.com:19199",
        origin: "https://gateway.example.com:19199",
      },
    ...
    },
    {
      ...
      input: {
        requestHost: "192.168.0.202:19199",
        origin: "http://192.168.0.202:19199",
      },
    ...
    },
    {
      ...
      input: {
        requestHost: "peters-mac-studio-1.example.ts.net:19199",
        origin: "http://peters-mac-studio-1.example.ts.net:19199",
      },
      expected: { ok: true as const, matchedBy: "private-same-origin" as const },
    },
    {
    ...
    },
    {
      ...
      input: {
        requestHost: "attacker.example.com:19199",
        origin: "http://attacker.example.com:19199",
      },
      expected: { ok: false as const, reason: "origin not allowed" },
    },
    {
    ...
    },
    {
      ...
      input: {
        requestHost: "gateway.tailnet.ts.net:19199",
