...
export function hasAmbiguousGatewayAuthModeConfig(cfg: ACTAgentConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: ACTAgentConfig): void {
