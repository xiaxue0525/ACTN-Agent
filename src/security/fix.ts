...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ACTAgentConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ACTAgentConfig; env: NodeJS.ProcessEnv }): {
  cfg: ACTAgentConfig;
  changes: string[];
} {
