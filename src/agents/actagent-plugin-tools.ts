...
import {
  resolveACTAgentPluginToolInputs,
  type ACTAgentPluginToolOptions,
} from "./actagent-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveACTAgentPluginToolsOptions = ACTAgentPluginToolOptions & {
...
export function resolveACTAgentPluginToolsForOptions(params: {
  options?: ResolveACTAgentPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveACTAgentPluginToolInputs({
