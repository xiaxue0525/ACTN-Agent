...
export function resolveSubagentToolPolicy(cfg?: ACTAgentConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: ACTAgentConfig["tools"]): string[] | undefined {
...
function detectImplicitProfileGrants(params: {
  globalTools?: ACTAgentConfig["tools"];
