/**
 * Fast ACTAgent tool-bundle mock.
 *
...
const createACTAgentToolsMock = vi.fn(
  (options?: { enableHeartbeatTool?: boolean; recordToolPrepStage?: (name: string) => void }) => {
    options?.recordToolPrepStage?.("actagent-tools:test-helper");
    return coreTools
...
vi.mock("../actagent-tools.js", () => ({
  createACTAgentTools: createACTAgentToolsMock,
  testing: {
    setDepsForTest: () => {},
  },
}));
