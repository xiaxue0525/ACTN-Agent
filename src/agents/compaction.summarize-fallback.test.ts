...
import type { UserMessage } from "actagent/plugin-sdk/llm";
...
vi.mock("actagent/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof import("actagent/plugin-sdk/agent-sessions")>(
    "actagent/plugin-sdk/agent-sessions",
  );
  return {
    ...actual,
