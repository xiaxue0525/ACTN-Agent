...
function requireExecTool(tools: ReturnType<typeof createACTAgentCodingTools>) {
...
describe("Agent-specific exec tool defaults", () => {
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const mainTools = createACTAgentCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const helperTools = createACTAgentCodingTools({
      config: cfg,
