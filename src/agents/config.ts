...
export function getPackageDir(): string {
  ...
  const envDir = process.env.ACTAGENT_PACKAGE_DIR;
  if (envDir) {
    if (envDir === "~") {
      return homedir();
    }
...
// =============================================================================
// App Config (from package.json actagentConfig)
// =============================================================================
...
const actAgentConfigName: string | undefined = pkg.actagentConfig?.name;
export const APP_NAME: string = actAgentConfigName || "actagent";
export const CONFIG_DIR_NAME: string = pkg.actagentConfig?.configDir || ".actagent";
...
// =============================================================================
// User Config Paths (~/.actagent/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.actagent/agent/) */
