...
import { lowercasePreservingWhitespace } from "@actagent/normalization-core/string-coerce";
      ...
      switch (params.provider) {
        ...
        case "vllm":
          return (
            ...
            'Set VLLM_API_KEY (any value works) or run "actagent configure". ' +
            "See: https://docs.actagent.ai/providers/vllm"
          );
        default:
          return undefined;
      }
