...
export const resolveAgentHarnessPolicyMock = vi.fn(() => ({ runtime: "actagent" }));
...
export const createACTAgentCodingToolsMock = vi.fn(() => []);
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureACTAgentModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../../context-engine/registry.js", () => ({
    ...
    resolveContextEngineOwnerPluginId: vi.fn(() => "lossless-actagent"),
  }));
  ...
  vi.doMock("../agent-tools.js", () => ({
    createACTAgentCodingTools: createACTAgentCodingToolsMock,
