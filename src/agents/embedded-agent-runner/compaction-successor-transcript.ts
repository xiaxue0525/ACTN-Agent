...
import { resolveTimestampMsToIsoString } from "@actagent/normalization-core/number-coercion";
...
export function shouldRotateCompactionTranscript(config?: ACTAgentConfig): boolean {
