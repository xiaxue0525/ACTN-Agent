...
import {
  ...
  ACTAGENT_RUNTIME_CONTEXT_CUSTOM_TYPE,
  ACTAGENT_RUNTIME_CONTEXT_NOTICE,
  ACTAGENT_RUNTIME_EVENT_HEADER,
} from "../../internal-runtime-context.js";
import type { CurrentInboundPromptContext } from "./params.js";
export { ACTAGENT_RUNTIME_CONTEXT_CUSTOM_TYPE };

const ACTAGENT_RUNTIME_EVENT_USER_PROMPT = "Continue the ACTAgent runtime event.";
...
export function resolveRuntimeContextPromptParts(params: {
  ...
  if (!prompt.trim()) {
    return runtimeContext
      ? {
          prompt: ACTAGENT_RUNTIME_EVENT_USER_PROMPT,
          ...(modelPromptText.trim() && modelPromptText !== ACTAGENT_RUNTIME_EVENT_USER_PROMPT
            ? { modelPrompt: modelPromptText }
            : {}),
          runtimeContext,
          runtimeOnly: true,
...
export function buildRuntimeContextCustomMessage(
  ...
  return {
    role: "custom",
    customType: ACTAGENT_RUNTIME_CONTEXT_CUSTOM_TYPE,
