...
describe("resolveActiveErrorContext", () => {
  ...
  it("ignores the embedded ACTAgent harness provider when the model provider is known", () => {
    // The ACTAgent harness id is a transport wrapper, not the provider users
