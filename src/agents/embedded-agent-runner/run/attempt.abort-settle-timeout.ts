...
type AbortSettleTimeoutEnv = Partial<
  Pick<NodeJS.ProcessEnv, "ACTAGENT_EMBEDDED_ABORT_SETTLE_TIMEOUT_MS" | "ACTAGENT_TEST_FAST">
>;
...
export function resolveEmbeddedAbortSettleTimeoutMs(
  ...
  const override = parseStrictPositiveInteger(env.ACTAGENT_EMBEDDED_ABORT_SETTLE_TIMEOUT_MS);
  if (override !== undefined) {
    return override;
  }
  return env.ACTAGENT_TEST_FAST === "1" ? 250 : 2_000;
}
