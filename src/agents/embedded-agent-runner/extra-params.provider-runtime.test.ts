...
describe("extra-params: provider runtime handoff", () => {
  it("keeps unsupported upstream transport values out of ACTAgent runtime hooks", () => {
    // Upstream transports can name modes ACTAgent does not own; unresolved values
