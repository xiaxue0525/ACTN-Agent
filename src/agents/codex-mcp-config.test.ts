// Covers conversion from ACTAgent bundle-MCP config into Codex app-server
...
describe("buildCodexMcpServersConfig", () => {
  it("normalizes ACTAgent MCP servers into Codex app-server mcp_servers shape", () => {
    ...
    expect(
      ...
      actagent: {
        ...
        bearer_token_env_var: "ACTAGENT_MCP_TOKEN",
        http_headers: {
          "x-static": "static-value",
        },
        env_http_headers: {
