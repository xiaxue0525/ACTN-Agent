...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.actagent/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "actagent doctor" and "actagent approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
