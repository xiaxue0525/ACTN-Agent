...
export const DEFAULT_SANDBOX_IMAGE = "actagent-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "actagent-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "actagent-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "actagent-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "actagent-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "actagent-sandbox-browser";
