...
function findMutableAgentEntry(cfg: ACTAgentConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: ACTAgentConfig, agentId: string): string | undefined {
