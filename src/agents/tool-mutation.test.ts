...
describe("tool mutation helpers", () => {
  ...
  it.each([
    ...
    ["exec", "gh search prs --repo actagent/actagent tool-mutation --json number,title,state"],
    ["bash", "gh pr view 123 --repo actagent/actagent --json title,state"],
  ...
  it.each([
    ...
    ["exec", "gh api --method POST repos/actagent/actagent/issues"],
