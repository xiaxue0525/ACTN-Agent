...
export function listAgentEntries(cfg: ACTAgentConfig): AgentEntry[] {
...
export function listAgentIds(cfg: ACTAgentConfig): string[] {
...
export function resolveDefaultAgentId(cfg: ACTAgentConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: ACTAgentConfig, agentId: string): AgentEntry | undefined {
