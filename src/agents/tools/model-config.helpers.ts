...
/** Resolves the configured default model ref, falling back to ACTAgent defaults. */
export function resolveDefaultModelRef(cfg?: ACTAgentConfig): { provider: string; model: string } {
  if (cfg) {
