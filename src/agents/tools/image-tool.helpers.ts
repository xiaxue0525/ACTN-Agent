...
export function coerceImageModelConfig(cfg?: ACTAgentConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: ACTAgentConfig; ref: string }): string[] {
