...
type CreateACTAgentTools = typeof import("../actagent-tools.js").createACTAgentTools;
...
let createACTAgentTools: CreateACTAgentTools;
...
const actAgentToolsFactoryMocks = vi.hoisted(() => {
...
vi.mock("./agents-list-tool.js", () => ({
  createAgentsListTool: () => actAgentToolsFactoryMocks.tool("agents"),
}));
vi.mock("./cron-tool.js", () => ({
  createCronTool: () => actAgentToolsFactoryMocks.tool("cron"),
}));
vi.mock("./gateway-tool.js", () => ({
  createGatewayTool: () => actAgentToolsFactoryMocks.tool("gateway"),
}));
vi.mock("./heartbeat-response-tool.js", () => ({
  createHeartbeatResponseTool: () => actAgentToolsFactoryMocks.tool("heartbeat_response"),
}));
...
vi.mock("./nodes-tool.js", () => ({
  createNodesTool: () => actAgentToolsFactoryMocks.tool("nodes"),
}));
vi.mock("./pdf-tool.js", () => ({
  createPdfTool: () => null,
}));
vi.mock("./session-status-tool.js", () => ({
  createSessionStatusTool: () => actAgentToolsFactoryMocks.tool("session_status"),
}));
vi.mock("./sessions-history-tool.js", () => ({
  createSessionsHistoryTool: () => actAgentToolsFactoryMocks.tool("sessions_history"),
}));
vi.mock("./sessions-list-tool.js", () => ({
  createSessionsListTool: () => actAgentToolsFactoryMocks.tool("sessions_list"),
}));
vi.mock("./sessions-send-tool.js", () => ({
  createSessionsSendTool: () => actAgentToolsFactoryMocks.tool("sessions_send"),
}));
vi.mock("./sessions-spawn-tool.js", () => ({
  createSessionsSpawnTool: () => actAgentToolsFactoryMocks.tool("sessions_spawn"),
}));
vi.mock("./sessions-yield-tool.js", () => ({
  createSessionsYieldTool: () => actAgentToolsFactoryMocks.tool("sessions_yield"),
}));
vi.mock("./subagents-tool.js", () => ({
  createSubagentsTool: () => actAgentToolsFactoryMocks.tool("subagents"),
}));
vi.mock("./tts-tool.js", () => ({
  createTtsTool: () => actAgentToolsFactoryMocks.tool("tts"),
}));
vi.mock("./update-plan-tool.js", () => ({
  createUpdatePlanTool: () => actAgentToolsFactoryMocks.tool("update_plan"),
}));
vi.mock("./video-generate-tool.js", () => ({
  createVideoGenerateTool: () => null,
}));
vi.mock("./web-tools.js", () => ({
  createWebFetchTool: () => actAgentToolsFactoryMocks.tool("web_fetch"),
  createWebSearchTool: () => actAgentToolsFactoryMocks.tool("web_search"),
}));
...
beforeAll(async () => {
  ...
  ({ createACTAgentTools } = await import("../actagent-tools.js"));
});
...
describe("message tool secret scoping", () => {
  ...
  it("forwards source reply delivery mode through createACTAgentTools", () => {
    const tool = createACTAgentTools({
      config: {} as never,
      sourceReplyDeliveryMode: "message_tool_only",
...
describe("message tool agent routing", () => {
  ...
  it("forwards agentThreadId through createACTAgentTools to the message tool", async () => {
    mockSendResult({ channel: "slack", to: "channel:C123" });
    const plugin = createChannelPlugin({
      id: "slack",
      label: "Slack",
...
describe("message tool boot-echo guard", () => {
  ...
  it("suppresses text-only sends that echo a substantial chunk of the registered boot prompt without preserving the wrapper markers (#53732)", async () => {
    ...
    // sentence verbatim — exactly the leak vector actagentsweeper called out
