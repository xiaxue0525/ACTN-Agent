...
const TEST_AGENT_DIR = "/tmp/actagent-pdf-model-config";
...
vi.mock("./model-config.helpers.js", () => ({
  ...
  hasProviderAuthForTool: ({ provider, cfg }: { provider: string; cfg?: ACTAgentConfig }) => {
  ...
  resolveDefaultModelRef: (cfg?: ACTAgentConfig) => {
