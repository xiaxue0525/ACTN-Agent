...
// Keep the schema local to avoid a circular import through acp-spawn/actagent-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: ACTAgentConfig }) {
