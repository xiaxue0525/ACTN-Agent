...
function hasExplicitDefaultPrimaryModel(cfg?: ACTAgentConfig): boolean {
...
function pickMaxBytes(cfg?: ACTAgentConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const providerCfg: ACTAgentConfig = effectiveCfg ?? {};
