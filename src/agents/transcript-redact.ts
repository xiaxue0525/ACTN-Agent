...
function redactTranscriptOptions(cfg?: ACTAgentConfig) {
...
function redactTranscriptText(value: string, cfg?: ACTAgentConfig): string {
...
export function redactTranscriptMessage(message: AgentMessage, cfg?: ACTAgentConfig): AgentMessage {
  if (cfg?.logging?.redactSensitive === "off") {
    return message;
  }
