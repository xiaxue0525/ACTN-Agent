...
async function resolveContext(config: ACTAgentConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): ACTAgentConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
