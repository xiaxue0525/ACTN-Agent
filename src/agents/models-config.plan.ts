...
export async function planACTAgentModelsJsonWithDeps(
  params: {
    cfg: ACTAgentConfig;
...
export async function planACTAgentModelsJson(
  params: Parameters<typeof planACTAgentModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planACTAgentModelsJsonWithDeps(params);
}
