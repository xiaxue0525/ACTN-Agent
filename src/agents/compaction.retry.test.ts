...
import * as agentSessions from "actagent/plugin-sdk/agent-sessions";
import type { AssistantMessage, UserMessage } from "actagent/plugin-sdk/llm";
import { afterEach, beforeEach, describe, expect, it, vi } from "vitest";
import { retryAsync } from "../infra/retry.js";

vi.mock("actagent/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof agentSessions>("actagent/plugin-sdk/agent-sessions");
  return {
    ...actual,
