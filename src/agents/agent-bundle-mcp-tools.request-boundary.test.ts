...
// outbound provider request body that contained only built-in ACTAgent tools
...
// have their own focused tests, but ACTAgentSweeper noted that the full request-
