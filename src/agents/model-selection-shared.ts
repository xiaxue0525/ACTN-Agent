...
function listModelAliasCandidates(cfg: ACTAgentConfig): ModelAliasCandidate[] {
...
export function hasConfiguredProviderModelRows(cfg: ACTAgentConfig): boolean {
...
export function parseConfiguredModelVisibilityEntries(params: { cfg?: ACTAgentConfig }): {
