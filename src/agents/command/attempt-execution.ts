 ...
 */
import type { AcpRuntimeEvent } from "@actagent/acp-core/runtime/types";
...
export function runAgentAttempt(params: {
  ...
  const requestedAgentHarnessId = isRawModelRun ? "actagent" : undefined;
  ...
  const agentHarnessPolicy = isRawModelRun
    ? ({ runtime: "actagent", runtimeSource: "model" } as const)
  ...
  const embeddedAgentHarnessOverride =
    ...
    (agentHarnessPolicy.runtime === "actagent" && agentHarnessPolicy.runtimeSource !== "implicit"
      ? "actagent"
      : undefined);
