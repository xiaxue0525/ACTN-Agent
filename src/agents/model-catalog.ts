...
let manifestModelCatalogCache = new WeakMap<ACTAgentConfig, ManifestModelCatalogCacheEntry>();
...
function shouldLogModelCatalogTiming(): boolean {
  return process.env.ACTAGENT_DEBUG_INGRESS_TIMING === "1";
}
...
function hasConfiguredProviderRowsNeedingManifestLookup(cfg: ACTAgentConfig): boolean {
