...
import type { ACTAgentAgentDatabase } from "../../state/actagent-agent-db.js";
...
): { allowKeychainPrompt?: boolean; database?: ACTAgentAgentDatabase } {
  return {
...
function loadAuthProfileStoreForAgent(
  ...
  const forceReadOnly = process.env.ACTAGENT_AUTH_STORE_READONLY === "1";
