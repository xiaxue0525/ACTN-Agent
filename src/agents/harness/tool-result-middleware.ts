...
type MiddlewareContentBlock = ACTAgentAgentToolResult["content"][number];
...
function isValidMiddlewareToolResult(value: unknown): value is ACTAgentAgentToolResult {
...
function coerceMiddlewareToolResult(
...
): ACTAgentAgentToolResult | undefined {
  ...
  const content: ACTAgentAgentToolResult["content"] = [];
 ...
 */
function sanitizeToolResultForMiddleware(result: ACTAgentAgentToolResult): ACTAgentAgentToolResult {
...
function buildMiddlewareFailureResult(): ACTAgentAgentToolResult {
  return {
    content: [
      {
        type: "text",
...
export function createAgentToolResultMiddlewareRunner(
  ...
  return {
    ...
    ): Promise<ACTAgentAgentToolResult> {
