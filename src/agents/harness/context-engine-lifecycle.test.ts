...
import { ACTAGENT_RUNTIME_CONTEXT_CUSTOM_TYPE } from "../internal-runtime-context.js";
import {
...
describe("harness context engine lifecycle", () => {
  ...
  describe("assembleHarnessContextEngine result validation", () => {
    ...
    it("rejects an assemble result missing the messages array (lossless-actagent shape)", async () => {
