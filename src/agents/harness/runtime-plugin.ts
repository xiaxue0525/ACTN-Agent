...
import { isDefaultAgentRuntimeId, ACTAGENT_AGENT_RUNTIME_ID } from "../agent-runtime-id.js";
 ...
 *
 * Only cold-loadable runtimes live here; always-loaded core/actagent runtimes should not trigger
...
function restrictiveAllowlistOmitsPlugin(config: ACTAgentConfig | undefined, pluginId: string) {
...
export async function ensureSelectedAgentHarnessPlugin(params: {
  ...
  if (
    ...
    runtime === ACTAGENT_AGENT_RUNTIME_ID ||
