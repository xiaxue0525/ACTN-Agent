...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("actagent.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: ACTAgentConfig): number {
