      ...
      return {
        buildReplayPolicy: (context?: {
          ...
          switch (provider) {
            case "env-sensitive":
              return {
                sanitizeToolCallIds: context?.env?.ACTAGENT_TEST_TRANSCRIPT_POLICY === "strict",
                ...(context?.env?.ACTAGENT_TEST_TRANSCRIPT_POLICY === "strict"
...
describe("resolveTranscriptPolicy", () => {
  ...
  it("does not reuse cached replay policies across custom env objects", () => {
    ...
    const strictEnv = {
      ...process.env,
      ACTAGENT_TEST_TRANSCRIPT_POLICY: "strict",
    };
    const looseEnv = {
      ...process.env,
      ACTAGENT_TEST_TRANSCRIPT_POLICY: "loose",
    };
