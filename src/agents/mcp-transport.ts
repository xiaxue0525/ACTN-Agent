 ...
 * streamable-HTTP SDK transports with ACTAgent auth, redirect, and logging rules.
 */
import {
  SSEClientTransport,
...
function attachStderrLogging(serverName: string, transport: ACTAgentStdioClientTransport) {
