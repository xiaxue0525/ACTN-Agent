 ...
 * Encodes cwd into a safe directory name under ~/.actagent/agent/sessions/.
 */
...
export class SessionManager {
   ...
   * @param sessionDir Optional session directory. If omitted, uses default (~/.actagent/agent/sessions/<encoded-cwd>/).
   */
