 ...
 */
import { parseStrictNonNegativeInteger } from "@actagent/normalization-core/number-coercion";
...
export function buildProviderReauthCommand(
  ...
  return formatCliCommand(
    `actagent models auth login --provider ${quotePosixShellArg(trimmed)} --force`,
    env,
  );
}
