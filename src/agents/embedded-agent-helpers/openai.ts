 ...
 * pairs directly into the provider payload, so ACTAgent must normalize here.
 */
 ...
 *
 * ACTAgent persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
