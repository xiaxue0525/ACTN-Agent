// Verifies createACTAgentTools wires shared config and context into the TTS tool.
import { beforeEach, describe, expect, it, vi } from "vitest";
import type { ACTAgentConfig } from "../config/types.actagent.js";
import { testing, createACTAgentTools } from "./actagent-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/actagent/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./actagent-plugin-tools.js", () => ({
  resolveACTAgentPluginToolsForOptions: () => [],
}));

vi.mock("./actagent-tools.nodes-workspace-guard.js", () => ({
...
describe("createACTAgentTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createACTAgentTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createACTAgentTools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createACTAgentTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
