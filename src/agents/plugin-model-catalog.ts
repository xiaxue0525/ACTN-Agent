...
export const PLUGIN_MODEL_CATALOG_GENERATED_BY = "actagent-plugin-model-catalog-v1";
...
/** Detects model catalogs generated by ACTAgent rather than user-authored JSON. */
