...
import { resolveACTAgentPluginToolInputs } from "./actagent-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("actagent plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveACTAgentPluginToolInputs({
      options: {
        config: {} as never,
