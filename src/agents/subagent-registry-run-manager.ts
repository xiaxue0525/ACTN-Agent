...
const RECOVERABLE_WAIT_RETRY_DELAY_MS = process.env.ACTAGENT_TEST_FAST === "1" ? 25 : 5_000;
...
export function createSubagentRunManager(params: {
  ...
  resolveSubagentWaitTimeoutMs(cfg: ACTAgentConfig, runTimeoutSeconds?: number): number;
