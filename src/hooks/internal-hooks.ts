/**
 * Hook system for ACTAgent agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("actagent.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("actagent.internalHooksEnabled");
