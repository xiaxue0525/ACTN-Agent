...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in ACTAgent config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `actagent doctor` next.",
    ...
    plugins: {
      ...
      downloadFromACTAgentHub: "Download from ACTAgentHub ({spec})",
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  actagent config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: ACTAGENT_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in ACTAgent config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in ACTAgent config",
    ...
    security: {
      ...
      beta: "ACTAgent is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run ACTAgent.",
      learnMore: "Learn more",
      notMultitenant: "ACTAgent is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, ACTAgent is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.actagent.ai/skills",
      enterEnv: "Enter {env}",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "ACTAgent" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so ACTAgent can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for ACTAgent",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: actagent channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL ACTAgent uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "ACTAgent"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var ACTAGENT_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: ACTAGENT_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to ACTAgent with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with actagent configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.actagent.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control ACTAgent.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control ACTAgent.",
      ...
      gatewayTokenStored:
        "Stored in: $ACTAGENT_CONFIG_PATH (default: ~/.actagent/actagent.json) under gateway.auth.token, or in ACTAGENT_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control ACTAgent.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control ACTAgent.",
      outroSeeded:
      ...
      restart: "Restart",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.actagent.ai/security",
      ...
      webDocs: "Docs: https://docs.actagent.ai/tools/web",
      ...
      whatNow: 'What now: https://actagent.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.actagent.ai/concepts/agent-workspace",
