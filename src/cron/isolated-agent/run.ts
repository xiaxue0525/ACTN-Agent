...
function hasConfiguredAuthProfiles(cfg: ACTAgentConfig): boolean {
  return (
...
function resolveCronActiveRuntimeConfig(cfg: ACTAgentConfig): ACTAgentConfig {
...
async function prepareCronRunContext(params: {
  ...
  const cfgWithAgentDefaults: ACTAgentConfig = {
    ...runtimeCfg,
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.ACTAGENT_TEST_FAST === "1";
