...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    ...
    process.env.ACTAGENT_GATEWAY_PORT = "";
  });
  ...
  it("normalizes bare publicUrl host ports for setup code payloads", async () => {
    await expectResolvedSetupSuccessCase({
      ...
      expected: {
        authLabel: "token",
        url: "wss://gateway.example.test:19199",
  ...
  it.each([
    ...
    {
      name: "uses ACTAGENT_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          ACTAGENT_GATEWAY_TOKEN: "new-token",
        },
  ...
  it.each([
    ...
    },
    {
      ...
      expected: {
        authLabel: "password",
        url: "wss://actagent.tailnet.ts.net",
        urlSource: "gateway.tailscale.mode=serve",
      },
    },
    {
