...
import ai.actagent.app.gateway.GatewayClientInfo
import ai.actagent.app.gateway.GatewayConnectOptions
import ai.actagent.app.gateway.GatewayEndpoint
import ai.actagent.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "ACTAgentAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "actagent-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "actagent-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
