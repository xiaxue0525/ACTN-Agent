...
import ai.actagent.app.ui.mobileAccentBorderStrong
...
import ai.actagent.app.ui.mobileHeadline
import ai.actagent.app.ui.mobileSurface
import ai.actagent.app.ui.mobileText
import ai.actagent.app.ui.mobileTextSecondary
import ai.actagent.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.actagent.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.actagent.app.ui.mobileFontFamily,
