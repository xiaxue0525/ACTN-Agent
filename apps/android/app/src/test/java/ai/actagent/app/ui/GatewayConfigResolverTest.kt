...
class GatewayConfigResolverTest {
  ...
  fun parseGatewayEndpointRejectsTailnetCleartextWsUrls() {
    val parsed = parseGatewayEndpoint("ws://100.64.0.9:19199")
  ...
  fun parseGatewayEndpointAllowsLoopbackCleartextWsUrls() {
    ...
    assertEquals(
      GatewayEndpointConfig(
        ...
        port = 19199,
        tls = false,
        displayUrl = "http://127.0.0.1:19199",
      ),
      parsed,
    )
  }
  ...
  fun parseGatewayEndpointAllowsLocalhostCleartextWsUrls() {
    val parsed = parseGatewayEndpoint("ws://localhost:19199")
    ...
    assertEquals(
      GatewayEndpointConfig(
        ...
        port = 19199,
        tls = false,
        displayUrl = "http://localhost:19199",
      ),
      parsed,
    )
  }
  ...
  fun parseGatewayEndpointAllowsAndroidEmulatorCleartextWsUrls() {
    val parsed = parseGatewayEndpoint("ws://10.0.2.2:19199")
    ...
    assertEquals(
      GatewayEndpointConfig(
        ...
        port = 19199,
        tls = false,
        displayUrl = "http://10.0.2.2:19199",
      ),
      parsed,
    )
  }
  ...
  fun parseGatewayEndpointAllowsPrivateLanCleartextWsUrls() {
    val parsed = parseGatewayEndpoint("ws://192.168.1.20:19199")
    ...
    assertEquals(
      GatewayEndpointConfig(
        ...
        port = 19199,
        tls = false,
        displayUrl = "http://192.168.1.20:19199",
      ),
      parsed,
    )
  }
  ...
  fun parseGatewayEndpointRejectsMdnsCleartextWsUrls() {
    val parsed = parseGatewayEndpoint("ws://gateway.local:19199")
  ...
  fun parseGatewayEndpointAllowsIpv6LoopbackCleartextWsUrls() {
    ...
    assertEquals(19199, parsed?.port)
    assertEquals(false, parsed?.tls)
    assertEquals("http://[::1]:19199", parsed?.displayUrl)
  }
  ...
  fun parseGatewayEndpointAllowsIpv4MappedIpv6LoopbackCleartextWsUrls() {
    ...
    assertEquals(19199, parsed?.port)
    assertEquals(false, parsed?.tls)
    assertEquals("http://[::ffff:127.0.0.1]:19199", parsed?.displayUrl)
  }
  ...
  fun parseGatewayEndpointAllowsLinkLocalIpv6ZoneCleartextWsUrls() {
    ...
    assertEquals(19199, parsed?.port)
    assertEquals(false, parsed?.tls)
    assertEquals("http://[fe80::1%25eth0]:19199", parsed?.displayUrl)
  }
  ...
  fun resolveScannedSetupCodeAcceptsRawSetupCode() {
    val setupCode =
      encodeSetupCode("""{"url":"wss://gateway.example:19199","bootstrapToken":"bootstrap-1"}""")
  ...
  fun resolveScannedSetupCodeAcceptsQrJsonPayload() {
    ...
    val qrJson =
      ...
      {
        "setupCode": "$setupCode",
        "gatewayUrl": "wss://gateway.example:19199",
        "auth": "password",
  ...
  fun resolveScannedSetupCodeRejectsNonLoopbackCleartextGateway() {
    val setupCode =
      encodeSetupCode("""{"url":"ws://attacker.example:19199","bootstrapToken":"bootstrap-1"}""")
  ...
  fun resolveScannedSetupCodeAcceptsPrivateLanCleartextGateway() {
    val setupCode =
      encodeSetupCode("""{"url":"ws://192.168.31.100:19199","bootstrapToken":"bootstrap-1"}""")
  ...
  fun parseGatewayEndpointResultFlagsInsecureRemoteGateway() {
    val parsed = parseGatewayEndpointResult("ws://gateway.example:19199")
  ...
  fun parseGatewayEndpointResultAllowsPrivateLanCleartextGateway() {
    val parsed = parseGatewayEndpointResult("ws://192.168.1.20:19199")
  ...
  fun decodeGatewaySetupCodeParsesBootstrapToken() {
    ...
    assertEquals("wss://gateway.example:19199", decoded?.url)
  ...
  fun resolveGatewayConnectConfigPrefersBootstrapTokenFromSetupCode() {
    ...
    assertEquals(19199, resolved?.port)
