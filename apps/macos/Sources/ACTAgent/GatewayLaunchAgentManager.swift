...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.actagent", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".actagent/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.actagentCommand(
            subcommand: "gateway",
