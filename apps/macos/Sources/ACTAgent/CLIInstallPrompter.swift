...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.actagent", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install ACTAgent CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .actagentSelectSettingsTab, object: tab)
        }
    }
