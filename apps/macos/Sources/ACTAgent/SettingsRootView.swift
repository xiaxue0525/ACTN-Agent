...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .actagentSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ACTAgentPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ACTAgentPaths.stateDirURL.path
...
private struct SettingsTabGroup: Identifiable {
    ...
    static func defaultGroups(showDebug: Bool) -> [SettingsTabGroup] {
        var groups = [
            ...
            SettingsTabGroup(title: "ACTAgent", tabs: [.about]),
        ]
...
extension Notification.Name {
    static let actagentSelectSettingsTab = Notification.Name("actagentSelectSettingsTab")
}
