...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.actagent", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        ACTAgentPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        ACTAgentPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
