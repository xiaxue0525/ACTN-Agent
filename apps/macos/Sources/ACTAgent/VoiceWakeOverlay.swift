...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.actagent", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other ACTAgent windows, but below the system’s pop-up menus.
