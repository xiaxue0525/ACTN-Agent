...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case ACTAgentBrowserCommand.proxy.rawValue:
            ...
            case ACTAgentLocationCommand.get.rawValue:
            ...
            case ACTAgentSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case ACTAgentSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case ACTAgentSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case ACTAgentSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case ACTAgentSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case ACTAgentCanvasA2UICommand.push.rawValue,
             ACTAgentCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleBrowserProxyInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        guard ACTAgentConfigFile.browserControlEnabled() else {
            return BridgeInvokeResponse(
                id: req.id,
                ok: false,
                error: ACTAgentNodeError(
    ...
    private func handleScreenSnapshotInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        let res: (data: Data, format: ACTAgentScreenSnapshotFormat, width: Int, height: Int)
        do {
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return baseUrl.appendingPathComponent("__actagent__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(ACTAgentSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(ACTAgentSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: ACTAgentSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> ACTAgentLocationMode {
    ...
    private static func errorResponse(
        ...
        code: ACTAgentNodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: ACTAgentNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: ACTAgentCanvasSnapshotFormat,
        maxWidth: Int?,
