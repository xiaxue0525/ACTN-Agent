...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.actagent", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ACTAgentConfigFile.defaultWorkspaceURL() }
