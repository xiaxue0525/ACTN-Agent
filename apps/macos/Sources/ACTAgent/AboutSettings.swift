...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/actagent/actagent") {
            ...
            VStack(alignment: .center, spacing: 6) {
                ...
                AboutLinkRow(icon: "globe", title: "Website", url: "https://actagent.ai")
                AboutLinkRow(icon: "bird", title: "Twitter", url: "https://twitter.com/steipete")
                AboutLinkRow(icon: "envelope", title: "Email", url: "mailto:peter@admin1douyin.me")
            }
            ...
            Text("© 2026 Turing Data Union (Shenzhen) Digital Industry Co., Ltd — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "ACTAgentBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ACTAgentBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ACTAgentGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ACTAgentGitCommit") as? String) ??
            "unknown"
    }
