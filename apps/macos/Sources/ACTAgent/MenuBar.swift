...
struct ACTAgentApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.actagent", category: "app")
    ...
    var body: some Scene {
        ...
        Window("ACTAgent Settings", id: SettingsWindowOpener.windowID) {
    ...
    private func applyStatusItemAppearance(paused _: Bool, sleeping _: Bool) {
        ...
        self.statusItem?.button?.toolTip = self.state.voiceWakeMeterActive
            ? "ACTAgent - Voice Wake live meter active"
            : "ACTAgent"
    }
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.actagent", category: "Chat")
