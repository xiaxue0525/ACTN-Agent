...
enum UIStrings {
    static let welcomeTitle = "Welcome to ACTAgent"
}
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: ACTAgentChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g actagent@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ACTAgentChatViewModel(
