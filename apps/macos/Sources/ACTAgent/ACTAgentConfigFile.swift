...
enum ACTAgentConfigFile {
    private static let logger = Logger(subsystem: "ai.actagent", category: "config")
    ...
    static func url() -> URL {
        ACTAgentPaths.configURL
    }

    static func stateDirURL() -> URL {
        ACTAgentPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ACTAgentPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-actagent-config-file",
            "event": "config.write",
