...
final class DashboardWindowController: NSWindowController, WKNavigationDelegate, NSWindowDelegate {
    ...
    private static func installNativeChromeScript(into userContentController: WKUserContentController) {
        let css = """
        html.actagent-native-macos {
          --actagent-native-titlebar-height: 50px;
        }
        @media (min-width: 700px) {
          html.actagent-native-macos .sidebar-shell {
            padding-top: max(14px, var(--actagent-native-titlebar-height)) !important;
          }
          html.actagent-native-macos .sidebar-shell__header {
        ...
        (() => {
          try {
            if (document.getElementById("actagent-native-macos-chrome")) return;
            const style = document.createElement("style");
            style.id = "actagent-native-macos-chrome";
            style.textContent = \(Self.jsStringLiteral(css));
            document.documentElement.classList.add("actagent-native-macos");
        ...
        auth: DashboardWindowAuth)
    {
        ...
        (() => {
          try {
            ...
            Object.defineProperty(window, "__ACTAGENT_NATIVE_CONTROL_AUTH__", {
              value: \(json),
              configurable: true,
            });
          } catch {}
