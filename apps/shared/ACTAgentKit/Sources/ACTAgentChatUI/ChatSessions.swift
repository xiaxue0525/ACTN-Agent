...
public struct ACTAgentChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public struct ACTAgentChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct ACTAgentChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
    public let contextTokens: Int?
    public let thinkingLevels: [ACTAgentChatThinkingLevelOption]?
    ...
    public init(
        ...
        model: String?,
        contextTokens: Int?,
        thinkingLevels: [ACTAgentChatThinkingLevelOption]? = nil,
...
public struct ACTAgentChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct ACTAgentChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: ACTAgentChatSessionsDefaults?
    public let sessions: [ACTAgentChatSessionEntry]
    ...
    public init(
        ...
        sessions: [ACTAgentChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
