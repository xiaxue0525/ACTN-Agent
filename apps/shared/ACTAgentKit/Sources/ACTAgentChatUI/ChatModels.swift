...
public typealias ACTAgentPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ACTAgentPlatformImage = UIImage
#endif

public struct ACTAgentChatUsageCost: Codable, Hashable, Sendable {
...
public struct ACTAgentChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ACTAgentChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ACTAgentChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ACTAgentChatMessageContent: Codable, Hashable, Sendable {
...
public struct ACTAgentChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ACTAgentChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ACTAgentChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ACTAgentChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ACTAgentChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedUsage = try container.decodeIfPresent(ACTAgentChatUsage.self, forKey: .usage)
        ...
        if let decoded = try? container.decode([ACTAgentChatMessageContent].self, forKey: .content) {
...
public struct ACTAgentChatHistoryPayload: Codable, Sendable {
...
public struct ACTAgentSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ACTAgentSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ACTAgentSessionPreviewItem]
}

public struct ACTAgentSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ACTAgentSessionPreviewEntry]

    public init(ts: Int, previews: [ACTAgentSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ACTAgentChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ACTAgentChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct ACTAgentChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ACTAgentSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: ACTAgentChatMessage?
...
public struct ACTAgentAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ACTAgentChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct ACTAgentGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ACTAgentPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ACTAgentPlatformImage?
...
public struct ACTAgentChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
