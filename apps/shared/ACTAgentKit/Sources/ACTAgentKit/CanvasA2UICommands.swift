...
public enum ACTAgentCanvasA2UICommand: String, Codable, Sendable {
...
public struct ACTAgentCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ACTAgentCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
