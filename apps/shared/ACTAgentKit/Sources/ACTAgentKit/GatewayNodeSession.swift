...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.actagent", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "ai.actagent", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: ACTAgentProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
