...
public enum ACTAgentTalkCommand: String, Codable, Sendable {
...
public struct ACTAgentTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct ACTAgentTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
