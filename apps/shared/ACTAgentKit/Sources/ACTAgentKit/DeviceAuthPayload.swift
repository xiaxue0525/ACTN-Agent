...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: ACTAgentProtocol.AnyCodable]?
    {
        ...
        return [
            "id": ACTAgentProtocol.AnyCodable(identity.deviceId),
            "publicKey": ACTAgentProtocol.AnyCodable(publicKey),
            "signature": ACTAgentProtocol.AnyCodable(signature),
            "signedAt": ACTAgentProtocol.AnyCodable(signedAtMs),
            "nonce": ACTAgentProtocol.AnyCodable(nonce),
        ]
    }
}
