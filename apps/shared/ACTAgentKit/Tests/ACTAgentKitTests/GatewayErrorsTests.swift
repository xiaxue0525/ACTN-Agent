...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "actagent devices approve req-123",
            docsURLString: "https://docs.actagent.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "actagent devices approve req-123")
        #expect(error.docsURLString == "https://docs.actagent.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "actagent devices approve req-123")
    }
