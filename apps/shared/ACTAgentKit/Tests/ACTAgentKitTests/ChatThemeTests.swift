...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = ACTAgentChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = ACTAgentChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
