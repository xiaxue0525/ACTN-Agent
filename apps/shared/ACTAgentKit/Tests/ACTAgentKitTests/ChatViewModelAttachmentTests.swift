...
private struct AttachmentProcessingTransport: ACTAgentChatTransport {
    func requestHistory(sessionKey _: String) async throws -> ACTAgentChatHistoryPayload {
...
final class ChatViewModelAttachmentTests: XCTestCase {
    func testImageAttachmentsAreProcessedBeforeStaging() async throws {
        ...
        let viewModel = await MainActor.run {
            ACTAgentChatViewModel(sessionKey: "main", transport: AttachmentProcessingTransport())
        }
