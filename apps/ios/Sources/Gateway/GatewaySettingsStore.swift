...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.actagent.gateway"
    private static let nodeService = "ai.actagent.node"
    private static let talkService = "ai.actagent.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.actagent.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.actagent.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("actagent-gateway.log")
    }
