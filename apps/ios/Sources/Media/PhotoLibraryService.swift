...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: ACTAgentPhotosLatestParams) async throws -> ACTAgentPhotosLatestPayload {
        ...
        var results: [ACTAgentPhotoPayload] = []
        ...
        return ACTAgentPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> ACTAgentPhotoPayload
    {
