...
struct AgentProTab: View {
    ...
    @State var actAgentHubQuery: String = ""
    @State var actAgentHubResults: [ACTAgentHubSearchResultLite] = []
    @State var actAgentHubLoading: Bool = false
    @State var actAgentHubErrorText: String?
    @State var actAgentHubInstallSlug: String?
    ...
    enum AgentRosterState: Equatable {
        ...
        var color: Color {
            switch self {
            case .online: ACTAgentBrand.ok
            case .busy: ACTAgentBrand.warn
