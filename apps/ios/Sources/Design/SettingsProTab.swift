...
struct SettingsProTab: View {
    ...
    @AppStorage("location.enabledMode") var locationModeRaw: String = ACTAgentLocationMode.off.rawValue
    ...
    @AppStorage("gateway.manual.port") var manualGatewayPort: Int = 19199
    ...
    @State var previousLocationModeRaw: String = ACTAgentLocationMode.off.rawValue
