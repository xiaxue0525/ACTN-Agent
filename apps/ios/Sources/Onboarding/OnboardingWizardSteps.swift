...
struct OnboardingIntroStep: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("Turn this device into a secure ACTAgent node for chat, voice, camera, and device tools.")
                .font(.subheadline)
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                Label("Use ACTAgent from your phone", systemImage: "message.fill")
            }
            ...
            HStack(alignment: .top, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    Text("Security notice")
                        .font(.headline)
                    Text(
                        "The connected ACTAgent agent can use device capabilities you enable, "
...
struct OnboardingWelcomeStep: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("Scan a QR code from your ACTAgent gateway or continue with manual setup.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
                .padding(.horizontal, 32)
            ...
            VStack(alignment: .leading, spacing: 8) {
                Text("How to pair")
                    .font(.headline)
                Text("In your ACTAgent chat, run")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
                Text("/pair qr")
