# ACTAgent iOS Changelog

## 2026.6.2 - 2026-06-02

Maintenance update for the current ACTAgent release.
...
Maintenance update for the current ACTAgent beta release.
...
Maintenance update for the current ACTAgent development release.
...
First App Store release of ACTAgent for iPhone. Pair with your ACTAgent Gateway to use chat, voice, sharing, and device actions from iOS.
