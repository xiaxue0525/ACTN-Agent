...
private let gatewayService = "ai.actagent.gateway"
private let nodeService = "ai.actagent.node"
private let talkService = "ai.actagent.talk"
    ...
    @Test func lastGateway_discoveredOverwritesManual() {
        withLastGatewaySnapshot {
            GatewaySettingsStore.saveLastGatewayConnectionManual(
                ...
                port: 19199,
                useTLS: true,
                stableID: "manual|10.0.0.99|19199")
    ...
    @Test func lastGateway_migratesFromUserDefaults() {
        withLastGatewaySnapshot {
            ...
            applyDefaults([
                ...
                "gateway.last.port": 19199,
                "gateway.last.tls": false,
                "gateway.last.stableID": "manual|example.org|19199",
            ])

            let loaded = GatewaySettingsStore.loadLastGatewayConnection()
            #expect(loaded == .manual(host: "example.org", port: 19199, useTLS: false, stableID: "manual|example.org|19199"))
