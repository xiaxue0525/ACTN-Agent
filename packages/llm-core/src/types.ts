...
/** Provider API families with first-class request/stream adapters in ACTAgent. */
...
/** Image-generation API families with first-class adapters in ACTAgent. */
...
/** Image provider ids with first-class adapters in ACTAgent. */
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps ACTAgent thinking levels to provider/model-specific values.
