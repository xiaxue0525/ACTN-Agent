...
export const AgentSummarySchema = Type.Object(
  {
    ...
    agentRuntime: Type.Optional(
      Type.Object(
        {
          id: NonEmptyString,
          fallback: Type.Optional(Type.Union([Type.Literal("actagent"), Type.Literal("none")])),
          source: Type.Union([
            Type.Literal("env"),
            Type.Literal("agent"),
...
/** Installs a skill from legacy install id, ACTAgentHub, or uploaded archive. */
export const SkillsInstallParamsSchema = Type.Union([
  ...
  Type.Object(
    {
      source: Type.Literal("actagenthub"),
      slug: NonEmptyString,
...
/** Updates installed skill settings or refreshes ACTAgentHub-installed skills. */
...
export const SkillsSecurityVerdictsResultSchema = Type.Object(
  {
    schema: Type.Literal("actagent.skills.security-verdicts.v1"),
    items: Type.Array(
      Type.Object(
        {
...
export const SkillsSkillCardResultSchema = Type.Object(
  {
    schema: Type.Literal("actagent.skills.skill-card.v1"),
    skillKey: NonEmptyString,
    path: NonEmptyString,
...
const SkillProposalRecordSchema = Type.Object(
  {
    schema: Type.Literal("actagent.skill-workshop.proposal.v1"),
    id: NonEmptyString,
...
export const SkillsProposalsListResultSchema = Type.Object(
  {
    schema: Type.Literal("actagent.skill-workshop.proposals-manifest.v1"),
    updatedAt: NonEmptyString,
