// ACTAgent SDK helper module supports normalize behavior.
import type { GatewayEvent, JsonObject, ACTAgentEvent, ACTAgentEventType } from "./types.js";
...
function normalizeLifecycleEndEventType(data: JsonObject): ACTAgentEventType {
...
function normalizeAgentEventType(payload: JsonObject): ACTAgentEventType {
...
function normalizeNamedEventType(event: GatewayEvent): ACTAgentEventType {
...
export function normalizeGatewayEvent(event: GatewayEvent): ACTAgentEvent {
  const payload = asRecord(event.payload);
