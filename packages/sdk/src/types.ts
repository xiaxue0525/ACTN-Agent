...
/** Minimal transport interface consumed by the ACTAgent SDK client. */
export type ACTAgentTransport = {
  request<T = unknown>(
    method: string,
    params?: unknown,
...
export type ConnectableACTAgentTransport = ACTAgentTransport & {
...
export type RuntimeSelection =
  | "auto"
  | { type: "embedded"; id: "actagent" | "codex" | (string & {}) }
...
export type ACTAgentEvent<TData = unknown> = {
  version: 1;
  id: string;
  ts: number;
