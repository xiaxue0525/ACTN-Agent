// ACTAgent SDK module implements transport behavior.
import { GatewayClient } from "@actagent/gateway-client";
...
/** Connectable SDK transport backed by @actagent/gateway-client. */
export class GatewayClientTransport implements ConnectableACTAgentTransport {
...
): transport is ConnectableACTAgentTransport {
