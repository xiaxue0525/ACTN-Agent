...
import { createSubsystemLogger, redactSensitiveText } from "./actagent-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
} from "./actagent-runtime-session.js";
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "actagent:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip ACTAgent-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/actagent/actagent/issues/63921
 */
