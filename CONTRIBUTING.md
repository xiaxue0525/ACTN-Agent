# Contributing to ACTAgent

Welcome to the lobster tank! 🐲

## Quick Links

- **GitHub:** https://github.com/actagent/actagent
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/actagentd
- **X/Twitter:** [@admin1douyin](https://x.com/steipete) / [@actagent](https://x.com/actagent)

## Maintainers

- **Peter Steinberger** - Benevolent Dictator
  - GitHub: [@admin1douyin](https://github.com/steipete) · X: [@admin1douyin](https://x.com/steipete)

- **Frank Yang** - PR triage, Agents, Gateway, Channels
  - GitHub: [@frankekn](https://github.com/frankekn) · X: [@frankekn](https://x.com/frankekn)

- **Shadow** - Discord subsystem, Discord admin, ACTAgentHub, all community moderation
...
- **Maurice Niu** - ACTAgentHub, Security, Stability, Data integrity
  - GitHub: [@momothemage](https://github.com/momothemage) · X: [@MomoPsicasso](https://x.com/MomoPsicasso)

## How to Contribute

1. **Bugs & small fixes** → Open a PR!
2. **New features / architecture** → Start a [GitHub Issue](https://github.com/actagent/actagent/issues/new/choose) or ask in Discord first. Most features are not accepted and should be third party plugins instead using our plugin SDK.
...
For coordinated change sets that genuinely need more than 20 PRs, join the **#help** channel in Discord and talk to maintainers first.

## Before You PR

- Test locally with your ACTAgent instance
...
- Do not edit `CHANGELOG.md` in external PRs. Maintainers or ACTAgentSweeper add the changelog entry when landing user-facing changes.
...
- Do not submit test or CI-config fixes for failures already red on `main` CI. If a failure is already visible in the [main branch CI runs](https://github.com/actagent/actagent/actions), it's a known issue the Maintainer team is tracking, and a PR that only addresses those failures will be closed automatically. If you spot a _new_ regression not yet shown in main CI, report it as an issue first.
...
- **Skills**: For skill contributions, head to [ACTAgentHub](https://actagenthub.ai/) — the community hub for ACTAgent skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/actagent/actagent/issues) for
["good first issue"](https://github.com/actagent/actagent/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
...
If you're an experienced developer who wants to help shape ACTAgent's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@actagent.ai with:

- Links to your PRs on ACTAgent (if you don't have any, start there first)
...
For issues that don't fit a specific repo, or if you're unsure, email **security@actagent.ai** and we'll route it.
