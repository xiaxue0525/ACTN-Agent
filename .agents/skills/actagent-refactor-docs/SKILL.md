---
name: actagent-refactor-docs
description: Refactor an existing ACTAgent docs page with source-audited preservation, restructuring, and verification.
---

# ACTAgent Refactor Docs

## Overview

Use this skill when the user gives a target ACTAgent docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `actagent-docs`: use that skill for style, page types,
...
Read `../actagent-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `actagent-docs`.
