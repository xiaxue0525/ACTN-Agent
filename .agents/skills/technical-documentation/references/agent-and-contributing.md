...
This reference consolidates the core rules for agent-policy and developer-governance docs.
...
4. Keep developer and agent rules aligned with actual repository workflows.
...
Source: https://github.com/actagent/actagent/blob/main/CONTRIBUTING.md
...
4. Move any large content into docs if avalible (for example Mintlify/Fern/Sphinx workflows) to avoid large developer guide.
5. Optimize for agent/machine readability as well as humans.

## Example repos to emulate

Source: https://github.com/actagent/actagent/blob/main/AGENTS.md
Source: https://github.com/actagent/actagent/blob/main/CONTRIBUTING.md
Source: https://github.com/actagent/actagent/blob/main/VISION.md
Source: https://github.com/openai/codex/blob/main/AGENTS.md
...
1. ACTAgent: strong real-world alias policy and AGENTS/CONTRIBUTING/VISION cohesion.
...
5. Rails/Kubernetes/Atom/GitHub Docs/React: developer guidance patterns at different project scales.

## Practical merge policy

When these rules conflict:

1. Preserve developer and reader task success first.
