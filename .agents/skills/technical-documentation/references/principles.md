...
For agent-instructions and developer-governance specifics (AGENTS/aliases/CONTRIBUTING), use `references/agent-and-contributing.md` as the detailed additional source of truth.

When the target repo or request is ACTAgent-specific, layer `references/actagent.md` on top of these general rules. Otherwise ignore that repo-specific overlay.
