# ACTAgent Documentation Overlay

Use this reference only for ACTAgent docs work. It layers ACTAgent-specific page
...
- Topic page: explain a major ACTAgent entity or surface end to end.
...
- Governance file: keep agent/developer policy concrete, scoped, and aligned
  with current ACTAgent repo behavior.
