...
- For ACTAgent docs work, choose a page type from `references/actagent.md` before drafting.
- Keep task-critical ACTAgent configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For ACTAgent docs work, apply the validation checklist in `references/actagent.md`.
