...
Produce and review technical documentation that is clear, actionable, and maintainable for both humans and agents, including developer-governance files and agent instruction files.
...
- Updating or reviewing AGENTS.md and/or CONTRIBUTING.md to keep agent and developer workflows aligned with current repo practices.
...
- Applying repository-specific documentation overlays, including ACTAgent page-type, docs IA, preservation, and validation rules when present.
...
6. For ACTAgent docs work, read `references/actagent.md` before the build/review playbook.
