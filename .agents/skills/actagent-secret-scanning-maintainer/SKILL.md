---
name: actagent-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve ACTAgent GitHub Secret Scanning alerts in issues or PRs.
---

# ACTAgent Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/actagent/actagent/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/actagent-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/actagent/actagent/issues/63101#issuecomment-xxx",
