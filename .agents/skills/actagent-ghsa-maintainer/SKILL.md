---
name: actagent-ghsa-maintainer
description: "Inspect, patch, validate, publish, or confirm ACTAgent GHSA security advisories and private-fork state."
---

# ACTAgent GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `release-actagent-maintainer`.
...
```bash
fork=$(gh api /repos/actagent/actagent/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/actagent/actagent/security-advisories/<GHSA> \
