...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/actagent");
      expect(html).toBe(
        '<p>Visit <a href="http://github.com/actagent" rel="noreferrer noopener" target="_blank">http://github.com/actagent</a></p>\n',
      );
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[ACTAgent中文](https://docs.actagent.ai)");
      expect(html).toBe(
        '<p><a href="https://docs.actagent.ai" rel="noreferrer noopener" target="_blank">ACTAgent中文</a></p>\n',
      );
    });
...
`;
  ...
  describe("security", () => {
    ...
    it("strips href from host-local absolute file paths", () => {
      const html = toSanitizedMarkdownHtml(
        "[report.docx](/Users/test/.actagent/data/skills/output/report.docx)",
      );
