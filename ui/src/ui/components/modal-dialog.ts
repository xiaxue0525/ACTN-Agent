...
export class ACTAgentModalDialog extends LitElement {
  @property() label = "";
  ...
  override render() {
    const labelId = this.label ? "actagent-modal-dialog-label" : "";
    const descriptionId = this.description ? "actagent-modal-dialog-description" : "";
    return html`
      <dialog
        role="dialog"
        aria-modal="true"
...
if (!customElements.get("actagent-modal-dialog")) {
  customElements.define("actagent-modal-dialog", ACTAgentModalDialog);
}

declare global {
  interface HTMLElementTagNameMap {
    "actagent-modal-dialog": ACTAgentModalDialog;
  }
}
