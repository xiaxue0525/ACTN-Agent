...
export class ACTAgentFilePreviewModal extends LitElement {
...
if (!customElements.get("actagent-file-preview-modal")) {
  customElements.define("actagent-file-preview-modal", ACTAgentFilePreviewModal);
}
...
declare global {
  interface HTMLElementTagNameMap {
    "actagent-file-preview-modal": ACTAgentFilePreviewModal;
  }
}
