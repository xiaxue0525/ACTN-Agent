...
function buildFeedback(params: {
  ...
  const docsHref = params.docsHref ?? "https://docs.actagent.ai/web/dashboard";
  return {
    kind: params.kind,
...
export function resolveLoginFailureFeedback(
  ...
  if (pairing) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.actagent.ai/web/control-ui#device-pairing-first-connection",
      titleKey:
  ...
  if (shouldShowInsecureContextHint(false, rawError, lastErrorCode)) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.actagent.ai/web/control-ui#insecure-http",
    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="ACTAgent" />
          <div class="login-gate__title">ACTAgent</div>
        ...
        <div class="login-gate__form">
          <label class="field">
            ...
            <input
              ...
              placeholder="ws://127.0.0.1:19199"
            />
          </label>
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="ACTAGENT_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>
              ${t("overview.connection.step1")}${renderConnectCommand("actagent gateway run")}
            </li>
            <li>${t("overview.connection.step2")} ${renderConnectCommand("actagent dashboard")}</li>
