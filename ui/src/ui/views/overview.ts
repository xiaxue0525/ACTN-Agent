...
export function renderOverview(props: OverviewProps) {
      ...
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          ${pairingState.requestId
            ? html`<span class="mono">actagent devices approve ${pairingState.requestId}</span
                ><br />`
            : nothing}
          <span class="mono">actagent devices list</span>
        </div>
        <div style="margin-top: 6px; font-size: 12px;">${t("overview.pairing.mobileHint")}</div>
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.actagent.ai/web/control-ui#device-pairing-first-connection"
  ...
  const authHint = (() => {
    ...
    if (authHintKind === "required") {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">actagent dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">actagent doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
              href="https://docs.actagent.ai/web/dashboard"
              target=${EXTERNAL_LINK_TARGET}
              rel=${buildExternalLinkRel()}
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "actagent dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.actagent.ai/web/dashboard"
  ...
  const insecureContextHint = (() => {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.insecure.hint", { url: "http://127.0.0.1:19199" })}
        <div style="margin-top: 6px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.actagent.ai/gateway/tailscale"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
          ...
          <a
            class="session-link"
            href="https://docs.actagent.ai/web/control-ui#insecure-http"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
        ...
        <div class="ov-access-grid" style="margin-top: 16px;">
          <label class="field ov-access-grid__full">
            ...
            <input
              ...
              placeholder="ws://100.x.y.z:19199"
            />
          </label>
          ${isTrustedProxy
            ? ""
                ...
                <label class="field">
                  ...
                  <div style="display: flex; align-items: center; gap: 8px; min-width: 0;">
                    <input
                      ...
                      placeholder="ACTAGENT_GATEWAY_TOKEN"
                    />
                    <button
                      type="button"
              ...
              <div class="login-gate__help" style="margin-top: 16px;">
                ...
                <ol class="login-gate__steps">
                  <li>
                    ...
                    ${renderConnectCommand("actagent gateway run")}
                  </li>
                  <li>
                    ${t("overview.connection.step2")} ${renderConnectCommand("actagent dashboard")}
                  </li>
                  <li>${t("overview.connection.step3")}</li>
                  <li>
                    ${t("overview.connection.step4")}<code
                      >actagent doctor --generate-gateway-token</code
                    >
                  </li>
                </ol>
