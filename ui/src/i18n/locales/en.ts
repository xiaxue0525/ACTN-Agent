...
export const en: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from actagent dashboard --no-open on your desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — re-authenticate with actagent models auth",
  ...
  login: {
    ...
    failure: {
      ...
      pairing: {
        ...
        stepList: "Run actagent devices list on the Gateway host.",
        stepApproveId: "Approve this request: actagent devices approve {requestId}.",
      ...
      insecure: {
        ...
        stepHttps: "Use HTTPS/Tailscale Serve, or open http://127.0.0.1:19199 on the Gateway host.",
        stepLocalCompat:
      ...
      network: {
        ...
        stepGateway: "Confirm the Gateway is running with actagent status or actagent gateway run.",
        stepUrl:
