...
export const it: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Su mobile? Copia l'URL completo (incluso #token=...) da actagent dashboard --no-open sul desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — riautenticati con actagent models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Incolla il token da actagent dashboard --no-open oppure inserisci la password configurata.",
        stepGenerate:
          "Se non è configurato alcun token, esegui actagent doctor --generate-gateway-token sull’host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Esegui actagent dashboard --no-open e apri il nuovo URL oppure incolla il suo token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Esegui actagent devices list sull’host Gateway.",
        stepApproveId: "Approva questa richiesta: actagent devices approve {requestId}.",
      ...
      insecure: {
        ...
        stepHttps:
          "Usa HTTPS/Tailscale Serve, oppure apri http://127.0.0.1:19199 sull’host Gateway.",
        stepLocalCompat:
      ...
      protocol: {
        ...
        stepDashboard:
          "Riapri il dashboard servito con actagent dashboard in modo che UI e Gateway provengano dalla stessa installazione.",
        stepDevUi:
          "Se usi pnpm ui:dev, ricompila o riavvia la UI di sviluppo contro il checkout corrente.",
        stepRestart:
          "Riavvia il Gateway dopo aver aggiornato ACTAgent affinché serva il protocollo corrente.",
      },
      network: {
        ...
        stepGateway:
          "Conferma che il Gateway sia in esecuzione con actagent status o actagent gateway run.",
        stepUrl:
          "Controlla l’URL WebSocket e usa wss:// quando il Gateway è dietro HTTPS/Tailscale Serve.",
        stepDashboard:
          "Riapri il dashboard con actagent dashboard --no-open per ricopiare l’URL corrente e i dettagli auth.",
      },
    },
  },
  chat: {
