...
coverage:
  primary:
    - tools.web-fetch
objective: Verify web_fetch preserves arguments and result shape across ACTAgent and Codex.
successCriteria:
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: web_fetch is an ACTAgent integration tool and must stay visible and callable under ACTAgent and Codex direct runtime parity.
