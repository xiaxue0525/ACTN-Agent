...
successCriteria:
  - ACTAgent may expose ACTAgent read while Codex app-server mode may omit duplicate ACTAgent dynamic read.
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: Codex app-server intentionally owns read natively; current ACTAgent coding surface has no separate list tool.
    knownHarnessGap:
      issue: "#80312"
