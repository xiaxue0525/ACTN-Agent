...
objective: Verify sessions_spawn preserves arguments and result shape across ACTAgent and Codex.
successCriteria:
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: sessions_spawn is an ACTAgent integration tool and must stay visible and callable under ACTAgent and Codex direct runtime parity.
