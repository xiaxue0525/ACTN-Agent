...
coverage:
  primary:
    - tools.web-search
objective: Verify web_search preserves arguments and result shape across ACTAgent and Codex.
successCriteria:
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: web_search is an ACTAgent integration tool and must stay visible and callable under ACTAgent and Codex direct runtime parity.
