...
objective: Verify image_generate preserves arguments and result shape across ACTAgent and Codex.
successCriteria:
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: image_generate is an ACTAgent integration tool and must stay visible and callable under ACTAgent and Codex direct runtime parity.
