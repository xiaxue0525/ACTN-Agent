...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as ACTAGENT_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                ACTAGENT_OAUTH_DIR: path.join(stateDir, "credentials"),
                ACTAGENT_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
