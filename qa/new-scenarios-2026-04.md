...
- Code: `.agents/skills/actagent-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Flow:
  - Install a ACTAgentHub or gateway-managed skill.
...
- Code: `src/agents/actagent-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
