...
Zalo ships as a bundled plugin in current ACTAgent releases, so normal packaged
...
- Install via CLI: `actagent plugins install @actagent/zalo`
- Pinned version: `actagent plugins install @actagent/zalo@2026.5.2`
- Or from a source checkout: `actagent plugins install ./path/to/local/zalo-plugin`
...
This page reflects current ACTAgent behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `actagent pairing list zalo`
  - `actagent pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in ACTAgent.
...
- Example: `actagent message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `actagent channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `actagent logs --follow`
