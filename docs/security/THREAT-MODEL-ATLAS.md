---
summary: "ACTAgent threat model mapped to the MITRE ATLAS framework"
...
This is a living document maintained by the ACTAgent community. See [CONTRIBUTING-THREAT-MODEL.md](/security/CONTRIBUTING-THREAT-MODEL) for guidelines on contributing:
...
This threat model documents adversarial threats to the ACTAgent AI agent platform and ACTAgentHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component              | Included | Notes                                            |
| ---------------------- | -------- | ------------------------------------------------ |
| ACTAgent Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
| Gateway                | Yes      | Authentication, routing, channel integration     |
| Channel Integrations   | Yes      | WhatsApp, Telegram, Discord, Signal, Slack, etc. |
| ACTAgentHub Marketplace    | Yes      | Skill publishing, moderation, distribution       |
...
| F5   | ACTAgentHub | Agent       | Skill code         | Moderation, scanning |
...
| **Description**         | Attacker scans for exposed ACTAgent gateway endpoints                |
...
| **Affected Components** | ~/.actagent/credentials/, config storage                    |
...
| **Description**         | Attacker publishes malicious skill to ACTAgentHub                            |
| **Attack Vector**       | Create account, publish skill with hidden malicious code                 |
| **Affected Components** | ACTAgentHub, skill loading, agent execution                                  |
...
| **Affected Components** | ACTAgentHub versioning, auto-update flows                          |
...
| **Affected Components** | ACTAgentHub moderation.ts                                                  |
...
## 4. ACTAgentHub Supply Chain Analysis
...
/(keepcold131\/actagentdAuthenticatorTool|actagentdAuthenticatorTool)/i
...
| ATLAS ID      | Technique Name                 | ACTAgent Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ACTAgentHub**          | ACTAgent's skill marketplace                              |
| **Gateway**          | ACTAgent's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for ACTAgent agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@actagent.ai_
