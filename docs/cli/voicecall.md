---
summary: "CLI reference for `actagent voicecall` (voice-call plugin command surface)"
read_when:
...
actagent voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
actagent voicecall call     -m <text> [-t <phone>] [--mode <m>]
actagent voicecall start    --to <phone> [--message <text>] [--mode <m>]
actagent voicecall continue --call-id <id> --message <text>
actagent voicecall speak    --call-id <id> --message <text>
actagent voicecall dtmf     --call-id <id> --digits <digits>
actagent voicecall end      --call-id <id>
actagent voicecall status   [--call-id <id>] [--json]
actagent voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
actagent voicecall latency  [--file <path>] [--last <n>]
actagent voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `ACTAgent voice call smoke test.` | Message to speak during the smoke call. |
...
actagent voicecall smoke --to "+15555550123"        # dry run
actagent voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
actagent voicecall call --to "+15555550123" --message "Hello"
actagent voicecall call -m "Heads up" --mode notify
```
...
```bash
actagent voicecall status
actagent voicecall status --json
...
```bash
actagent voicecall expose --mode serve
actagent voicecall expose --mode funnel
actagent voicecall expose --mode off
```
