---
summary: "CLI reference for `actagent system` (system events, heartbeat, presence)"
read_when:
...
actagent system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:19199 --token "$ACTAGENT_GATEWAY_TOKEN"
actagent system heartbeat enable
actagent system heartbeat last
actagent system presence
```
