...
- The **canvas host** is served by the Gateway HTTP server under:
  - `/__actagent__/canvas/` (agent-editable HTML/CSS/JS)
  - `/__actagent__/a2ui/` (A2UI host)
    It uses the same port as the Gateway (default `19199`).
...
- Start: `actagent gateway` (foreground, logs to stdout).
