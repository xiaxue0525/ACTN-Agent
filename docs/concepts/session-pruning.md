...
ACTAgent also builds a separate idempotent replay view for sessions that
...
ACTAgent auto-enables pruning for Anthropic profiles:
...
If you set explicit values, ACTAgent does not override them.
