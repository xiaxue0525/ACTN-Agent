...
ACTAgent treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.actagent/settings/voicewake.json`

Shape:

```json
{ "triggers": ["actagent", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
