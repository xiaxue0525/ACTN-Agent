...
read_when:
  - Planning a broad ACTAgent application modernization pass
...
modernization task. If adopting this guidance as a repo-local ACTAgent skill,
create `.agents/skills/actagent-frontend/SKILL.md` first, keep the frontmatter
