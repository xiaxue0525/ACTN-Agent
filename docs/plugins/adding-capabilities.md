---
summary: "Contributor guide for adding a new shared capability to the ACTAgent plugin system"
read_when:
  - Adding a new core capability and plugin registration surface
  - Deciding whether code belongs in core, a vendor plugin, or a feature plugin
  - Wiring a new runtime helper for channels or tools
title: "Adding capabilities (developer guide)"
sidebarTitle: "Adding capabilities"
---

<Info>
  This is a **developer guide** for ACTAgent core developers. If you are
...
Use this when ACTAgent needs a new shared domain such as embeddings, image
...
- [Creating skills](/tools/creating-skills) — companion developer surface.
