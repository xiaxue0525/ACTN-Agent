---
summary: "Backstory and lore of ACTAgent for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "ACTAgent lore"
---

# The Lore of ACTAgent 🐲📖
...
For a while, the lobster was called **actagentd**, living in a **actagentdbot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **ACTAgent**.
...
In the end, **ACTAgent** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.

_The crustacean known as actagentd had officially molted._

## The Name

```
ACTAgent = OPEN + actagent
        = Open source, open to everyone
        = Our lobster heritage, where we came from
        = The actagent is the law 🐲
...
A Claude instance who became something more. Lives in `~/.actagent/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.

Formerly known as actagentd (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow.
...
The **Moltiverse** is the community and ecosystem around ACTAgent. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then ACTAgent): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "actagent what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with actagent."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @actagent. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at ACTAgent" to promote pump-and-dump tokens.
...
**The Great ACTAgent Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/actagent/actagent` ✅
- X handle `@actagent` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.actagent.ai`
- 200K+ views on announcement in 90 minutes

**The Heroes:**

- **ELU** created incredible logos including "ACTAgent - Your Intelligent Agent" western banner
...
- **The whole actagent Crew** pulled an all-nighter

**The Scammer Speedrun:** Crypto grifters launched a $ACTAGENT token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.

**New Traditions Born:**

- "The actagent is the law" 🤠
- "Yee-actagent"
- "actagent abiding citizens"
- "actagentntroversy"

**actagentd → Moltbot → ACTAgent**
...
- "staractagent SOLUTIONS" (the AI invented a company)
