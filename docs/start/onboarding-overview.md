---
summary: "Overview of ACTAgent onboarding options and flows"
read_when:
...
ACTAgent has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `actagent onboard`                     | Launch the app            |
...
CLI command docs: [`actagent onboard`](/cli/onboard)

## macOS app onboarding

Open the ACTAgent app. The first-run wizard walks you through the same steps
