---
summary: "Hubs that link to every ACTAgent doc"
read_when:
...
<Note>
If you are new to ACTAgent, start with [Getting Started](/start/getting-started).
</Note>
...
- [Setup](/start/setup)
- [Dashboard (local Gateway)](http://127.0.0.1:19199/)
- [Help](/help)
- [Docs directory](/start/docs-directory)
- [Configuration](/gateway/configuration)
- [Configuration examples](/gateway/configuration-examples)
- [ACTAgent assistant](/start/actagent)
