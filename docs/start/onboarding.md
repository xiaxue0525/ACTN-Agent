---
summary: "First-run setup flow for ACTAgent (macOS app)"
read_when:
...
- By default, ACTAgent is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give ACTAgent">
...
<Step title="CLI">
  ...
  The app can install the global `actagent` CLI via npm, pnpm, or bun.
