...
- with `gateway.tls.enabled: true`: `https://<host>:19199/`
...
{
  gateway: {
    controlUi: { enabled: true, basePath: "/actagent" }, // basePath optional
  },
}
```
...
```json5
{
  gateway: {
    ...
    auth: { mode: "password" }, // or ACTAGENT_GATEWAY_PASSWORD
  },
}
```
