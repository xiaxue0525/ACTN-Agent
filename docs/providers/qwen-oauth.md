---
summary: "Use the Qwen Portal provider id with ACTAgent"
read_when:
...
ACTAgent has two Qwen-facing provider ids:
...
actagent models set qwen/qwen3-coder-plus
```
