---
summary: "Inworld streaming text-to-speech for ACTAgent replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In ACTAgent it
...
ACTAgent posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. ACTAgent synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    ACTAgent asks Inworld for `OGG_OPUS` so the audio plays as a native
