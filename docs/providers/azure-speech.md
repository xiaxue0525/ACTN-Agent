---
summary: "Azure AI Speech text-to-speech for ACTAgent replies"
read_when:
...
Azure Speech is an Azure AI Speech text-to-speech provider. In ACTAgent it
...
ACTAgent uses the Azure Speech REST API directly with SSML and sends the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. ACTAgent synthesizes the audio
...
<AccordionGroup>
  <Accordion title="Authentication">
    ...
    is sent as `Ocp-Apim-Subscription-Key`; ACTAgent derives
  ...
  <Accordion title="Audio outputs">
    ...
    `ogg-24khz-16bit-mono-opus`, and `riff-24khz-16bit-mono-pcm`. ACTAgent
...
<CardGroup cols={2}>
  ...
  <Card title="Providers" href="/providers" icon="grid">
    All bundled ACTAgent providers.
  </Card>
