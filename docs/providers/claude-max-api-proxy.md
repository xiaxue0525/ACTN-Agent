...
<Steps>
  ...
  <Step title="Configure ACTAgent">
    Point ACTAgent at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ACTAgent
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native ACTAgent integration with Claude CLI or API keys.
  </Card>
