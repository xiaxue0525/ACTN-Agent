...
title: "Together AI"
read_when:
  - You want to use Together AI with ACTAgent
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    actagent onboard --auth-choice together-api-key
    ```
  </Step>
...
ACTAgent ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.actagent/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `actagent models list --provider together`
