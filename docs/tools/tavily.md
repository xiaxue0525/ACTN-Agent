...
[Tavily](https://tavily.com) is a search API designed for AI applications. ACTAgent exposes it in two ways:
...
<Tip>
Choosing Tavily in onboarding or `actagent configure --section web` enables the bundled Tavily plugin automatically.
</Tip>
