...
```json
{
  ...
  "simulatedHeartbeatWorkspaceFile": "/tmp/actagent-happy-path/workspace/HEARTBEAT.md",
  "simulatedWorkspaceBootstrapFiles": ["/tmp/actagent-happy-path/workspace/MEMORY.md"],
  "simulatedWorkspaceDeveloperInstructionFiles": ["/tmp/actagent-happy-path/workspace/TOOLS.md"],
  "simulatedWorkspaceTurnScopedDeveloperInstructionFiles": [
    "/tmp/actagent-happy-path/workspace/IDENTITY.md",
    "/tmp/actagent-happy-path/workspace/SOUL.md",
    "/tmp/actagent-happy-path/workspace/USER.md"
  ],
...
```json
{
  ...
  "cwd": "/tmp/actagent-happy-path/workspace",
...
```json
{
  ...
  "actAgentRuntime": {
    ...
    "workspaceBootstrapContextFrom": "extensions/codex app-server turn/start input ACTAgent runtime context"
  }
}
```
...
Deferred searchable ACTAgent dynamic tools available: agents_list, cron, gateway, heartbeat_respond, nodes, session_status, sessions_history, sessions_list, sessions_send, sessions_spawn, subagents, tts, web_fetch, web_search. Use `tool_search` to load exact callable specs before use.
...
### /tmp/actagent-happy-path/workspace/TOOLS.md
...
## /tmp/actagent-happy-path/workspace/MEMORY.md
