...
const openAiCodexTokenRefreshTestHook = "__ACTAGENT_TEST_REFRESH_OPENAI_CODEX_TOKEN__";
...
// arbitrary ACTAGENT_BUNDLED_PLUGINS_DIR overrides unless this Vitest-only opt-in is present.
