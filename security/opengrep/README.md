...
`precise.yml` is ACTAgent's shipped precise OpenGrep rulepack. Each rule is tied
...
Some ACTAgent paths are excluded by `.gitignore` for build reasons even though
